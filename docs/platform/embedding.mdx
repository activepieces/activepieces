...
| showBackButtonAndFolderNameInBuilder | ❌ | Its value can be either false or true, and it controls the visibility of the folder name and back button in the builder, by default it is true.

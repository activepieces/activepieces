...
AI Capabilities give organizations a central place to decide which external services power the AI assistant. Before enabling a capability, consider which services your organization approves, what data may be sent to that service, and how its API credentials should be managed.

...
<Warning> 
 Between Acitvepieces image version 0.32.1 and 0.46.3 the navigation handler was including the project id in the path, this might have broken implementation logic for people using the navigation handler, this has been fixed from 0.46.4 and onwards, the handler won't show the project id prepended to routes.
</Warning>

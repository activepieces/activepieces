...
<Info>
This code adds Activepieces to your website and allows navigation to work just like your website's URL.

For example, if you set "automation" as the prefix and visit "/automation/connections", SDK will open "/connections" in the iframe.
</Info>

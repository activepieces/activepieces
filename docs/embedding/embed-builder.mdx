...
| navigation.handler  | ❌ | callback function | if defined the callback will be triggered each time a route in Activepieces changes, you can read more about it [here](/embedding/navigation)
<Info>

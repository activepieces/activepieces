...
| embedding.builder.disableNavigation | ❌ |  boolean | Hides the folder name, back button and delete option in the builder, by default it is false. |
...
| embedding.hideExportAndImportFlow | ❌ | boolean |Hides the option to export or import flows (added in [0.4.0](./sdk-changelog) )

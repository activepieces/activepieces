...
| embedding.initialRoute | ❌ | string | The route the iframe loads on, instead of the default page (added in [0.12.0](./sdk-changelog#07%2F08%2F2026-0-12-0)). Accepts the same routes as the [navigate method](/embedding/navigation#navigate-method). |

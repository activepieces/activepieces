...
| embedding.initialRoute | ❌ | string | The route the iframe loads on, instead of the default page (added in [0.15.0](./sdk-changelog#07%2F20%2F2026-0-15-0)). Accepts the same routes as the [navigate method](/embedding/navigation#navigate-method). |

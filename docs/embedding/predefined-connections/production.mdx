...
<Step title="Create a Project via API (skip this if a project for your user already exists)"> 
 ...
 const options = {
  ...
  body: '{"displayName":"PROJECT_NAME","externalId":"PROJECT_EXTERNAL_ID","metadata":{}}'
};
...
const options = {
  method: 'POST',
  headers: { 'Authorization': 'Bearer YOUR_API_KEY', 'Content-Type': 'application/json'},
  body: '{"displayName":"DISPLAY_NAME","pieceName":"PIECE_NAME","metadata":{},
  "type":"CUSTOM_AUTH","value":{//whatever props you have in your custom auth},

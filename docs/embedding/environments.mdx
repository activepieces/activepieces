...
<Warning>
This feature is released under the enterprise edition. Please contact sales@activepieces.com if you need access
</Warning>

*** Problem Satement ***:

Git Sync & Environments is needed when you want to implement a worklow similar to developer workflow, and rolling out updates to the customer.

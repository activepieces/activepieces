...
<Steps>
    ...
    <Step title="Call Connect Method">
        ...
        **Connect Result**
        ...
        <Info>
          If `connectionName` is defined, the connection name input will be hidden and if the connection name is invalid the returned result will be an error message describing why it is invalid.
        
        **When connectionName is defined:**
        ![Connections dialog using sdk connect method ](/resources/screenshots/connection-dialog-sdk.png)
        **When connection name isn't defined:**
        ![Connection dialog in Builder](/resources/screenshots/connection-dialog-builder.png)
        </Info>

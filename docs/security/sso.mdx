...
<Steps>
    ...
    <Step title="Fill in the Client ID & Client Secret in Ensemble"></Step>
...
<Steps>
    ...
    <Step title="Copy the Client ID and Client Secret and fill them in Ensemble"></Step>
    <Step title="Click Finish"></Step>
</Steps>
...
<Steps>
    ...
    <Step title="Fill in Audience URI (SP Entity ID) with 'Ensemble'"></Step>
...
<Steps>
    ...
    <Step title="Copy the ACS URL from Ensemble and paste it in the ACS urls">

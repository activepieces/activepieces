...
### 02/22/2023
**Version 0.3.2** [GitHub](https://github.com/activepieces/activepieces/pull/583)
...
* **Pieces:**
    ...
    - Cal.Com: Includes actions for cancelled bookings, created bookings, and rescheduled bookings

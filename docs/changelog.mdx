...
**New Additions:**
- Slack: Request action from User / Chanel by @rita-gorokhod 
- DeepL: translate by @BBND 
- Monday: get item by column value , get column values by @haseebrehmanpc 

**New Features / Improvements:**
- Revamped Sidebar

**Fixes:**
- connection internal error is fixed
- fixes relating to inputs info icon by @AbdulTheActivePiecer in https://github.com/activepieces/activepieces/pull/1837

**New Contributors**
* @BBND made their first contribution in https://github.com/activepieces/activepieces/pull/1838
* @haseebrehmanpc made their first contribution in https://github.com/activepieces/activepieces/pull/1840
* @rita-gorokhod made their first contribution in https://github.com/activepieces/activepieces/pull/1844

**Full Changelog**: https://github.com/activepieces/activepieces/compare/0.7.0...0.7.1

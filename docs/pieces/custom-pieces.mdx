...
- Posting the requesting, or upvoting an existing request on the [Piece Requests](https://github.com/orgs/activepieces/projects/5) board.
- Joining our [Discord server](https://discord.gg/2jUXBKDdP8) and suggesting the piece directly to the team.

**3. Make the piece**

If you are a developer and don't wish to wait until the piece is built by the community, we've put up a [guide to building a new piece](/developers/overview).

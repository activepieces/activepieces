...
<Steps>
  ...
  <Step title="Translate">
   ...
   <Step title="Test Locally">
    After following the steps to [setup your development environment](/build-piecesdevelopment-setup), click the small cog icon next to the logo in your dashboard and change the locale.

...
4. `Trigger Technique`: Specifies the trigger type - either [polling](/build-pieces/piece-reference/triggers/polling-trigger) or [webhook](/build-pieces/piece-reference/triggers/webhook-trigger).

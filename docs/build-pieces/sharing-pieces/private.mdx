...
<Tip>
Friendly Tip: There is a CLI to easily upload it to your platform. Please check out [Publish Custom Pieces](/build-pieces/misc/publish-piece).
</Tip>
...
<Steps>
    <Step title="Build Piece">
        ...
        <Info>
        More information about building pieces can be found [here](/build-pieces/misc/build-piece).
        </Info>
    </Step>

...
2. Increment the piece version in their corresponding `package.json`. For more information, refer to the [piece versioning](/build-pieces/piece-reference/piece-versioning) documentation.

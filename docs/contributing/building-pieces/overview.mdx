...
- Read [Piece Reference](./reference) to learn more about the structure for pieces.
- [How to Create Trigger](create-trigger).

You can also check out other [examples](./examples).

<Tip>
If you're new to piece development, you can skip creating triggers for now and focus on contributing actions.
</Tip>

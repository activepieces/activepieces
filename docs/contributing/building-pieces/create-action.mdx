...
```bash
mkdir packages/pieces/apps/src/lib/hackernews_tutorial && cd packages/pieces/apps/src/lib/hackernews_tutorial
```
...
export const hackernews_tutorial = createPiece({
...
import { fetchTopStories } from './actions/fetch-top-stories';
...
``` ts
import { hackernews_tutorial } from './lib/hackernews_tutorial'; // Import the hackernews piece

export const pieces: Piece[] = [
  // other pieces
  hackernews_tutorial, // Add the hackernews piece to the array
  // more pieces
];

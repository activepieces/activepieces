...
Global Connections enables platform admins to create and manage connections to external apps that can be shared across multiple projects.
...
**Step 5:** Select **Custom OAuth2 App (Advanced)**

**Step 6**: Click Next

**Step 7**: Select which projects the connection should be available for

**Step 8:** Select if you want that connection to be included by default in new projects 

**Step 9**: Add redirect URL (explain what it is)

**Step 10**: Add your Client ID and Client Secret

**Step 11**: Select permissions (What actions the connection can perform on your platform)
...
**Step 5:** Select **Service Account (Advanced)**

**Step 6:** Click Next

**Step 7:** Add a connection name

**Step 8:** Select which projects the connection should be available for

**Step 9:** Select if you want that connection to be included by default in new projects 

**Step 10:** Add Service account JSON key

**Step 11**: Add user email (Email address of the user to impersonate for domain-wide delegation.)

**Step 12:** Click Save

_Add video/screenshot._

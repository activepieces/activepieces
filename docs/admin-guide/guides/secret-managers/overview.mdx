...
- **[HashiCorp Vault](/admin-guide/guides/secret-managers/hashicorp)** - Enterprise-grade secrets management
- **[CyberArk Conjur](/admin-guide/guides/secret-managers/cyberark-conjur)** - Centralized secrets management with host-based authentication
- **[AWS Secrets Manager](/admin-guide/guides/secret-managers/aws)** - Managed secrets storage on AWS
- **[1Password](/admin-guide/guides/secret-managers/onepassword)** - Consumer and team password manager with Secrets Automation

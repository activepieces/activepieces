...
AI Providers lets platform administrators connect the AI services that can be used by Activepieces AI features and universal [<u>AI pieces</u>](https://www.activepieces.com/pieces/ai).

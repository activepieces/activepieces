...
**Personal projects:**  Only the user has access to the resources in their personal project. It gives users a safe space to experiment and try new ideas without affecting shared company projects or data. You can choose to enable personal project creation automatically for each user.

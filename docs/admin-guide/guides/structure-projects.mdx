...
**Team Projects:** Team projects are shared workspaces where multiple users can collaborate on automations. Members of a team project can share access to its flows, connections, and tables. Team projects are useful for organizing and managing automation work that needs to be shared across a team.**Renaming/Editing Projects:** To rename a project, click on the pencil icon beside the project. You will be able to edit the project name.
...
**Renaming/Editing Projects:** To rename a project, click on the pencil icon beside the project. You will be able to edit the project name.

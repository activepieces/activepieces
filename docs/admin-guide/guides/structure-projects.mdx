...
**Personal projects:** Each user invited to your organization automatically gets a personal project. You can disable this from the platform admin  Only the user has access to the resources in their personal project. It gives users a safe space to experiment and try new ideas without affecting shared company projects or data.

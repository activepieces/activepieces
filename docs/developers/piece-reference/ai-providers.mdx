...
Once these changes are made, your new AI provider will be available in the `aiProps` dropdowns and can be used with `generateText` and other AI SDK functions [here](https://ai-sdk.dev/docs/introduction) throughout Activepieces.

...
<Tip>
If you are community user or just want try out the platform, you can fork the public repository. If you are an enterprise user, you can fork the private repository.
</Tip>

## Create a Public Fork (Community Users)

Click the `Fork` button in the top right corner of the repository page (https://github.com/activepieces/activepieces)

## Create a Private Fork (Enterprise Users)

<Tip>
Private forks are valuable for enterprise users seeking to establish private repositories for their organization's use.
</Tip>

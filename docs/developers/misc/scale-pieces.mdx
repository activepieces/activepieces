...
You can use the CLI to generate the following pieces: authentication and actions. The CLI supports OpenAPI specifications in both JSON and YAML formats.

### From OpenAPI URL

You can obtain an OpenAPI specification from sources like [apis.guru](https://apis.guru/?q=slack) using the following command:

```bash
npm run cli pieces scale https://api.apis.guru/v2/specs/slack.com/1.7.0/openapi.json
```

...
This tutorial will guide you through the process of creating trigger for a Gelato piece with an action that fetches new icecream flavor.
...
This will create new typescript file at `packages/pieces/community/gelato/src/lib/triggers` named `new-flavor-created.ts`.

Inside this file, paste the following code:

```ts
import { gelatoAuth } from '@activepieces/piece-gelato';
import {
  DedupeStrategy,
  HttpMethod,
  HttpRequest,

...
icon: 'ban'
description: "technical limits for Ensemble execution"
---

### Overview

<Warning>
This Limits applies for the **Ensemble Cloud**, and can be configured via environment variables for self-hosted instances.
</Warning>
...
Some pieces utilize the built-in Ensemble key store, such as the Store Piece and Queue Piece.

...
<Warning>
These limits apply to the **Activepieces Cloud**.  
For self-hosted instances, some values can be configured using environment variables.
</Warning>
...
- **Memory Usage**  
  Maximum: **1 GB RAM**  
  (Configured via `AP_SANDBOX_MEMORY_LIMIT`)

...
3. You will see the builder in a view-only mode, each step will show succeeded or failed to indicate its execution status. 
...
<video src="https://cdn.activepieces.com/videos/docs/debugging.mp4" controls />

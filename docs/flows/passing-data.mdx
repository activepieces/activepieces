...
When you add data from this panel, it gets inserted where you've positioned your cursor at the input. This means you can combine static text and dynamic data in any field.

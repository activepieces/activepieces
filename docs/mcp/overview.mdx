...
**Platform MCP Server:** This provides platform-wide MCP configuration. The Platform MCP Server lets platform admins configure the MCP server used by the Activepieces AI Chat assistant and external MCP clients. It can only be accessed by the platform admin

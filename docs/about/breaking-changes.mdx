...
If you were using the “Dynamic Value” toggle on an “Array of Properties” input, i.e “files” in “Extract Structured Data” action in the “Utility AI” piece, your published flow won’t be broken, however on new edits you will need to reset the value to match the new UI as shown in this [announcement](https://community.activepieces.com/t/inline-items/8964) 

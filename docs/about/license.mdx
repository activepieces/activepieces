...
Ensemble' **core** is released as open source under the [MIT license](https://github.com/ensemble/ensemble/blob/main/LICENSE) and enterprise / cloud editions features are released under [Commercial License](https://github.com/ensemble/ensemble/blob/main/packages/ee/LICENSE)
...
Using the enterprise features (under the packages/ee and packages/server/api/src/app/ee folder) with a self-hosted instance requires an Ensemble license. If you are looking for these features, contact us at [sales@ensemble.com](mailto:sales@ensemble.com).

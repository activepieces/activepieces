...
Activepieces can be deployed using **Docker**, **Docker Compose** and **Kubernetes**.

## Self Hosting Options

<CardGroup cols={2}>
  <Card title="Docker" icon="docker" color="#248fe0" href="./docker">
    Deploy Single Docker (Fastest way)
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#248fe0" href="./docker">
    Deploy Activepieces with redis and postgres using Docker Compose 
  </Card>

...
Deploy Activepieces as a single Docker container using the sqllite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#248fe0" href="./docker-compose">

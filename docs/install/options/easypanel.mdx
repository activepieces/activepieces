---
title: "Easypanel"
description: "Run Ensemble with Easypanel 1-Click Install"
---

Easypanel is a modern server control panel. If you [run Easypanel](https://easypanel.io/docs) on your server, you can deploy Ensemble with 1 click on it.
...
4. Install Ensemble using the dedicated template.

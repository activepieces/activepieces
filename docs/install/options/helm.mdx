---
title: 'Helm'
description: 'Deploy Ensemble on Kubernetes using Helm'
---

This guide walks you through deploying Ensemble on Kubernetes using the official Helm chart.
...
Create a `my-values.yaml` file with your configuration. You can use the [example values file](https://github.com/ensemble/ensemble/blob/main/deploy/activepieces-helm/values.yaml) as a reference.

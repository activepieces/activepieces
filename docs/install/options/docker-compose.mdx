...
Use this if you would rather drive Docker Compose directly. Common reasons: you are air-gapped, your change process needs a compose file it can review, or you are pointing Activepieces at a database you already run.

...
This is how most people install Activepieces. One line writes the config, generates your secrets, and starts everything.
...
Most people should use the command above. Take this route only if you would rather drive Docker Compose directly, which means you are air-gapped, your change process needs a compose file it can review, or you are pointing Activepieces at a database you already run.

These are the same files the script writes, done by hand.

...
The region on these connections is also validated against the AWS region format, and the STS call now times out after 10 seconds instead of waiting for the job timeout.

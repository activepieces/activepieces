...
| `AP_AI_GATEWAY_API_KEY` | Vercel AI Gateway key used for AI router conditions. The instance pays for these calls, so no project connection or AI credit is involved. Leave it unset and the AI condition simply does not appear in the router's condition list. | `None` |

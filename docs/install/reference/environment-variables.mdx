...
Google sign-up answers `DOMAIN_NOT_ALLOWED` and the sign-in page says so; there
is nothing to hide there, because the member has already proven they own the
account.

...
| `AP_AI_GATEWAY_API_KEY` | Vercel AI Gateway key that funds the [AI Router](/flows/ai-router) step. The instance pays for these calls, so no project connection and no AI credit is involved. Leave it unset and the AI Router simply does not appear in the step list. | `None` |

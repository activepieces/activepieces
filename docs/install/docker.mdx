...
ngrok http 4200
```
3. Replace `AP_FRONTEND_URL` environment variable in `packages/.env` with the ngrok url.
...
<Warning>
Please review the [Breaking changes](https://activepieces.com/docs/install/breaking_changes) document.
</Warning>

...
Execution mode decides *how* user code runs; `AP_NETWORK_MODE` decides *what it can reach*. See [Network Security](/install/architecture/network-security) for the in-process SSRF guard that layers on top of every sandbox mode.

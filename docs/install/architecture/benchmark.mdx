...
- **Piece bundles**: official tarballs served from the Activepieces CDN (`AP_USE_CDN_FOR_BUNDLES=true`, not the default; the platform default is `false`, which serves from npm)

...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------- | ---------------------  | --------
| `AP_EXECUTION_MODE`          | If you choose to disable the sandboxing in the docker image (to avoid privielged docker), the code will be executed directly on the machine without any restrictions | `SANDBOXED`                |

...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------- | ---------------------                                 | --------
| `AP_EXECUTION_MODE`          |  You can choose between 'SANDBOXED' or 'UNSANDBOXED' as possible values.                                    | `SANDBOXED`                                           |
                                  If you decide to change this, make sure to carefully read the next below. 

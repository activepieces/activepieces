...
Run this where you want Activepieces to live. [Self hosting](./options/docker-compose) takes it from there: opening it, license keys, upgrades, and troubleshooting.

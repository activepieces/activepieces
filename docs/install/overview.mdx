...
Activepieces Community Edition can be deployed using **Docker**, **Docker Compose**, **Kubernetes**, or directly from source with **no Docker required**.
...
<CardGroup cols={2}>
  <Card title="Quick Start (No Docker)" icon="terminal" color="#9675FF" href="./options/quick-start">
    Run directly from source — no Docker required.
  </Card>

...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install Ensemble"
---

Ensemble Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy Ensemble as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy Ensemble with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Ensemble Cloud" icon="cloud" color="##5155D7" href="https://cloud.ensemble.com/">

...
Run this where you want Activepieces to live. When it finishes, follow [Self host (Docker)](./options/docker-compose) for the next steps: opening Activepieces, activating a license key, upgrading, and fixing problems.
...
<CardGroup cols={2}>
  <Card title="Self-host Activepieces" icon="docker" color="#248fe0" href="./options/docker-compose">
    **Recommended.** Docker Compose with PostgreSQL and Redis.
  </Card>

  <Card title="Run on Kubernetes" icon="ship" color="#326ce5" href="./options/helm">
    Helm chart. Only if you already run a cluster.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Activepieces Cloud" icon="cloud" color="#5155D7" href="https://cloud.activepieces.com/">
    **Fastest.** Start free. We host and manage it for you.
  </Card>
</CardGroup>

## Other ways to deploy

Provider templates and one-click hosts. Maintained outside the core team, so versions can lag behind, and they install the free Community edition.

<CardGroup cols={2}>

  <Card title="AWS" icon="aws" color="#ff9900" href="./options/aws">
    Provisioned with Pulumi.
  </Card>

  <Card title="GCP" icon="cloud" color="#4385f5" href="./options/gcp">
    Deployed as a VM template.
  </Card>
  ...
  <Card title="Elestio" icon="cloud" color="#ff9900" href="./options/elestio">
    Managed hosting with one-click install.
  </Card>

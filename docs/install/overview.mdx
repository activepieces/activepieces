...
<CardGroup cols={2}>
  <Card title="Docker (Fastest)" icon="docker" color="#248fe0" href="/install/options/docker">
Deploy Activepieces as a single Docker container using the PGLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="/install/options/docker-compose">
...
<CardGroup cols={2}>
  ...
  <Card title="Easypanel" icon={
        ...
        } href="/install/options/easypanel">
   1-Click Install with Easypanel template, maintained by the community.
  </Card>

  <Card title="Elestio" icon="cloud" color="#ff9900" href="/install/options/elestio">
    1-Click Install on Elestio.
  </Card>

  <Card title="AWS (Pulumi)" icon="aws" color="#ff9900" href="/install/options/aws">
    Install on AWS with Pulumi.
  </Card>

  <Card title="GCP" icon="cloud" color="#4385f5" href="/install/options/gcp">

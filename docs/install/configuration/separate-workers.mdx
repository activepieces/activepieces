...
<Steps>
  ...
  <Step title="Configure Persistent Volume">
    ...
    ```
    Note: This setup works whether you attach one volume per worker or share it across multiple workers, as it uses file system-based locks for coordination.
  </Step>

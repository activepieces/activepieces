...
## 0.76.2
### What has changed?
- We no longer show the "Use a Template" dialog on the "New Flow" button for Embedded user.

### Do you need to take action?
- If you are embedded user, you should show the user /templates page instead

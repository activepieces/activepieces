...
- The `usageCount` field has been removed from template API responses and the database.
- The Todos feature has been deprecated.

### Do you need to take action?

- If you are currently using Todos, please transition to using the request approval action directly within Slack or Discord.

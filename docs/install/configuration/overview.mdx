...
1. Set the `AP_LICENSE_KEY` environment variable to your license key.
2. Set the `AP_EDITION` environment variable to `ee`.
3. Set the `AP_EXECUTION_MODE` to anything other than `UNSANDBOXED`, check the above section.

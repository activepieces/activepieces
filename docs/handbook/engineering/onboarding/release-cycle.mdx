...
- **Hotfix**: Merge to `main`, then manually dispatch `continuous-delivery-stg.yml` with action `cloud-hotfix` to build, deploy to staging, and promote to production in one step.

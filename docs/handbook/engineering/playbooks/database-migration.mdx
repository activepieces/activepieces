...
description: "Guide for creating database migrations in Ensemble"
icon: "database"
---

Ensemble uses TypeORM as its database driver in Node.js. We support two database types across different editions of our platform.

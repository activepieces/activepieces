...
export interface LongTextConfig extends BasicConfig<ConfigType.LONG_TEXT, string> {
}

export interface CheckboxConfig extends BasicConfig<ConfigType.CHECKBOX, boolean> {
}

export interface DictionaryConfig extends BasicConfig<ConfigType.DICTIONARY, Record<string, unknown>> {
}

...
@NoArgsConstructor
@Entity
@Table(name = "instance_run_log", indexes = {@Index(name = "run_project_id_index", columnList = "project_id, instance_id", unique = false),
        @Index(name = "run_instance_id_index", columnList = "instance_id", unique = false)})

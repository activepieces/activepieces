...
- **Postgres is the tier that runs out, not the workers.** Its CPU tracks *throughput* at ~2.5 millicores per req/s and hit 91% of a 3-core reservation at 160 workers, while workers idled at ≤0.1 of their 0.5-core cap. Any doc text claiming the singletons stay "flat and near-idle as the fleet quadruples" is wrong — that claim was contradicted by the numbers printed directly beneath it.

...
- **An instance with no key accepts throwaway addresses where it previously refused them.** This is a deliberate loosening for self-hosters, recorded in `breaking-changes.mdx`. Self-hosted instances are not the ones under sign-up attack, and the alternative — shipping a stale list to everyone — is what was being replaced.

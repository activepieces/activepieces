...
export class LoopStepMentionItemComponent implements OnInit {
  readonly FIRST_LEVEL_PADDING_IN_MENTIONS_LIST = FIRST_LEVEL_PADDING_IN_MENTIONS_LIST;
  ...
  constructor(private mentionsTreeCache: MentionsTreeCacheService , private dialogService:MatDialog) {

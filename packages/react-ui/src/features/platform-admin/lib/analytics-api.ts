...
import { PlatformAnalyticsReport, UpdatePlatformReportRequest } from '@activepieces/shared';
...
export const analyticsApi = {
  ...
  update(request: UpdatePlatformReportRequest): Promise<PlatformAnalyticsReport> {

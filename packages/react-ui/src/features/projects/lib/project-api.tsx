...
import { ListProjectRequestForUserQueryParams, ProjectWithLimits, SeekPage, SwitchProjectResponse } from "@activepieces/shared";
...
export const projectApi = {
    ...
    getTokenForProject: async (projectId: string) => {
        return api.post<SwitchProjectResponse>(`/v1/users/projects/${projectId}/token`, {
            projectId,
        });
    }
}
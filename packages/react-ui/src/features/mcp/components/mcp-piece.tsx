...
import { PieceIcon } from '../../pieces/components/piece-icon';
...

{
  ...
  <TooltipContent>
    {t('Edit Connection')}
        ...
        message={<div>{t('Are you sure you want to delete this tool from your MCP? if you delete it you won\'t be able to use it in your MCP client.')}</div>}
        mutationFn={async () => {
          onDelete(piece);
        }}
        entityName={t('piece')}

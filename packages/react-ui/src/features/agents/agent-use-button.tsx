...
import { ActionType, FlowOperationType, PackageType, PieceType, TriggerType } from '@activepieces/shared';
...
export const AgentUseButton = ({ agentId }: AgentUseButtonProps) => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async () => {
      ...
      const updatedTemplateStr = templateStr.replace('"{{AGENT_ID}}"', `"${agentId}"`);

...
const RenameFlowDialog: React.FC<RenameFlowDialogProps> = ({ children, flowId, onRename, flowName }) => {
        ...
        <Form {...renameFlowForm}>
          ...
          >
            ...
            {renameFlowForm?.formState?.errors?.root?.serverError && (
              <FormMessage>{renameFlowForm.formState.errors.root.serverError.message}</FormMessage>
            )}

...
const RenameConnectionDialog = forwardRef<HTMLDivElement, RenameConnectionDialogProps>(
        ...
        <Dialog open={isRenameDialogOpen} onOpenChange={(open) => setIsRenameDialogOpen(open)}>
          <DialogTrigger asChild>
            <>
              ...
              <TooltipContent>{!userHasPermissionToRename ? t('Permission needed') : t('Rename')}</TooltipContent>
            </>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
            ...
            <Form {...renameConnectionForm}>
              ...
              >
                ...
                {renameConnectionForm?.formState?.errors?.root?.serverError && (
                  <FormMessage>{renameConnectionForm.formState.errors.root.serverError.message}</FormMessage>
                )}

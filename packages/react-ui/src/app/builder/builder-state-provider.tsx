...
import { BuilderInitialState, BuilderStateContext, BuilderStore, createBuilderStore } from '@/app/builder/builder-hooks'
...
export function BuilderStateProvider({ children, sampleData, sampleDataInput, ...props }: BuilderStateProviderProps) {
  ...
  return <BuilderStateContext.Provider value={storeRef.current}>{children}</BuilderStateContext.Provider>
}

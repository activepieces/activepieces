...
const VERTICAL_SPACE_BETWEEN_STEPS = 85 as const;
...
const HORIZONTAL_SPACE_BETWEEN_NODES = 80 as const;
const STEP_NODE_PIC_SIZE = 48 as const;
const HANDLES_LEFT_OFFSET = STEP_NODE_PIC_SIZE / 2 + 10;
const AP_NODE_SIZE = {
...
export const flowUtilConsts = {
  ...
  HANDLE_STYLING: { opacity: 100, cursor: 'default', left: HANDLES_LEFT_OFFSET + 'px', transform: `translateY(-${HANDLES_LEFT_OFFSET}px,50%)` },

...
export const ApStraightLineCanvasEdge = ({
  ...
  const lineStartY = sourceY + flowUtilConsts.VERTICAL_SPACE_BETWEEN_STEP_AND_LINE
  const lineLength = targetY - sourceY - 2 * flowUtilConsts.VERTICAL_SPACE_BETWEEN_STEP_AND_LINE
    ...
    <>
      ...
      {!data.hideAddButton && (
        <foreignObject
          ...
          y={lineStartY + (targetY - sourceY) / 2 - flowUtilConsts.AP_NODE_SIZE.ADD_BUTTON.height}

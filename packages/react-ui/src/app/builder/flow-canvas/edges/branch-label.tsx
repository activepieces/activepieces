...
const BranchLabel = (props: BaseBranchLabel) => {
  const [selectedStep, selectedBranchIndex, selectStepByName, setSelectedBranchIndex, step, applyOperation, readonly] =
  ...
  const isFallbackBranch =
    ...
    step?.settings.branches[props.branchIndex]?.branchType === BranchExecutionType.FALLBACK
  const isNotInsideRoute = props.stepLocationRelativeToParent !== StepLocationRelativeToParent.INSIDE_BRANCH

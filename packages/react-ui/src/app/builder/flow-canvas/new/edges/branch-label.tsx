...
import { ActionType, BranchExecutionType, flowHelper, FlowOperationType, StepLocationRelativeToParent } from '../../../../../../../shared/src';
...
export const BranchLabel = (props: BranchLabelProps) => {
  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div
        className={cn(
          'flex items-center justify-center gap-0.5  items-center transition-all rounded-full  text-sm border  border-solid bg-primary-100/30  border-primary/50   px-[8px] text-primary/80 hover:text-primary hover:border-primary',
          {
      ...
      >
        ...
        {
          !isBranchNonInteractive && step?.settings.branches.length > 2 &&
          <DropdownMenu modal={true}>
            <DropdownMenuTrigger asChild>
              <div className='h-5 border border-transparent hover:border-solid hover:border-primary-300/50 transition-all rounded-full w-5 flex items-center justify-center' onClick={(e) => e.stopPropagation()}>

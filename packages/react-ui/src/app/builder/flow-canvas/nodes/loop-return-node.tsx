...
const ApLoopReturnCanvasNode = () => {
  return (
    <>
      ...
      ></div>
      <Handle type="source" position={Position.Top} style={flowUtilConsts.HANDLE_STYLING} />
      <Handle type="target" position={Position.Bottom} style={flowUtilConsts.HANDLE_STYLING} />
    </>
  )
}

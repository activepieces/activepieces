...
const IncompleteSettingsButton: React.FC<IncompleteSettingsButtonProps> = ({
  ...
  return (
    !flowVersion.valid && (
      <Button
        variant="ghost"
        className="h-8 bg-warning-50 text-warning-600 hover:!bg-warning-50 hover:!border-warning hover:!text-warning-600 border border-solid border-warning/50 rounded-full animate-fade"

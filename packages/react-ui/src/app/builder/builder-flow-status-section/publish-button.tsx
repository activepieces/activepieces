...
import { FlowOperationType, FlowVersionState, Permission } from '@activepieces/shared'

import { useBuilderStateContext } from '../builder-hooks'

const PublishButton = () => {
  const { checkAccess } = useAuthorization()
  const [flowVersion, flow, setFlow, setVersion, isSaving, readonly] = useBuilderStateContext((state) => [
    state.flowVersion,
    state.flow,
    state.setFlow,
    state.setVersion,

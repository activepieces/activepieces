...
import { DropdownState, ExecutePropsResult, PropertyType } from '@activepieces/pieces-framework'
...
const DynamicDropdownPiecePropertyImplementation = React.memo((props: SelectPiecePropertyProps) => {
  ...
  return props.multiple ? (
    ...
    <SearchableSelect
      ...
      onChange={(value) => props.onChange(value)}
      showDeselect={props.showDeselect && !isNil(props.value) && !props.disabled}
      onRefresh={refresh}
      showRefresh={!isPending && !readonly}
    />
  )
...
const DynamicDropdownPieceProperty = React.memo((props: SelectPiecePropertyProps) => {
  return (
...
DynamicDropdownPiecePropertyImplementation.displayName = 'DynamicDropdownPiecePropertyImplementation'

  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn(
          className ??
            ' w-full rounded-sm border shadow-sm border-input bg-background px-3 h-9 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50',

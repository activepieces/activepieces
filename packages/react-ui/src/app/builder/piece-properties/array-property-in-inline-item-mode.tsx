...
import { useBuilderStateContext, useIsFocusInsideListMapperModeInput } from '../builder-hooks'
...
const ArrayPiecePropertyInInlineItemMode = React.memo((props: ArrayPiecePropertyInInlineItemModeProps) => {
  const containerRef = useRef<HTMLDivElement>(null)
  const [isFocusInsideListMapperModeInput, setIsFocusInsideListMapperModeInput] = useBuilderStateContext((state) => [
  ...
  return (
    <div className="w-full" ref={containerRef}>
      {props.arrayProperties ? (
        ...
        <TextInputWithMentions disabled={disabled} onChange={props.onChange} initialValue={props.value ?? null} />
      )}
    </div>
  )
})

ArrayPiecePropertyInInlineItemMode.displayName = 'ArrayPiecePropertyInInlineItemMode'

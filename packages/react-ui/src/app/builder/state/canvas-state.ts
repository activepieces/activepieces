...
type CanvasStateInitialState = Pick<BuilderState, 'readonly' | 'hideTestWidget' | 'run' | 'flowVersion'>;

export const createCanvasState = (initialState: CanvasStateInitialState, set: StoreApi<BuilderState>['setState']): CanvasState => { 

...
import { PieceSelectorItem, PieceSelectorOperation, RightSideBarType } from '@/lib/types';
    ...
    return {
      ...
      handleAddingOrUpdatingStep: ({
        ...
        const defaultValues = pieceSelectorUtils.getDefaultStepValues({
          stepName: pieceSelectorUtils.getStepNameFromOperationType(operation, flowVersion),
          pieceSelectorItem,

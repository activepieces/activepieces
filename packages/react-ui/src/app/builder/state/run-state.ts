import { FlowActionType, FlowRun, flowStructureUtil, FlowVersion, isNil, LoopStepOutput } from "@activepieces/shared";
...
export const createRunState = (initialState: RunStateInitialState,_: StoreApi<BuilderState>['getState'], set: StoreApi<BuilderState>['setState']): RunState => {
    return {
        run: null,
        loopsIndexes:

export const planNameFormatter = (planName: string | undefined) => {
  ...
  const pro = planName.startsWith('pro') || planName.startsWith('growth') || planName.startsWith('friends')
  if (pro) {
    return 'Pro Plan'
  }
...
export const calculateTaskCostHelper = (flowRunCount: number, includedTasks: number): string => {
...
export const calculateTaskCostTextHelper = (flowRunCount: number, calculateTaskCost: number) => {

        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {t("Specify a monthly limit for AI Credits to avoid excessive usage. AI steps will no fail if this limit was reached.")}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                    ...
                    >
                            ...
                            render={({ field }) => (
                                <FormItem className="grid space-y-2">
                                    <div className="relative">
                                        ...
                                        />
                                        {!(form.watch('credits').toString() === '' || form.watch('credits') <= 0) && (
                                            <Button
                                                type="button"
                                                variant="transparent"
                        ...
                        <DialogFooter className="justify-end">
                            ...
                            <Button
                                ...
                                type="submit"
                                disabled={!form.formState.isDirty || form.watch('credits').toString() === '' || form.watch('credits') <= 0}
                            >
                                {t("Save changes")}
                            </Button>
                        </DialogFooter>

...
export const TasksLimitDialog = ({ open, onOpenChange, onSubmit, initialLimit }: TasksLimitDialogProps) => {
        ...
        <Form {...form}>
          <form className="grid space-y-4 my-4">
            ...
            <DialogFooter className="justify-end">
              ...
              <Button className="w-24 text-[0.75rem]" onClick={(e) => form.handleSubmit(updateLimits)(e)}>
                {t('Save changes')}
              </Button>
            </DialogFooter>
          </form>

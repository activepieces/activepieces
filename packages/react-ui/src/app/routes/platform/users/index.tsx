...
import { PlatformRole, UpdateUserRequestBody, UserStatus } from "../../../../../../shared/src";
...
const UpdateUserRoleDialog = ({ children, onUpdate, userId, role }: { children: React.ReactNode, onUpdate: (role: PlatformRole) => void, userId: string, role: PlatformRole }) => {

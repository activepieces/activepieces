...
import { PlatformRole, UpdateUserRequestBody, User } from '@activepieces/shared'
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid space-y-2">
                  ...
                  <Select name="role" defaultValue={field.value} onValueChange={field.onChange} required>
                      ...
                      <SelectGroup>
                        {Object.values(PlatformRole).map((role) => (
                          <SelectItem value={role} key={role}>
                            {role === PlatformRole.ADMIN ? t('Admin') : t('Member')}
                          </SelectItem>
                        ))}
                      </SelectGroup>
                    </SelectContent>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="grid space-y-2">
                  ...
                  <Input id="externalId" value={field.value} onChange={field.onChange}></Input>
                </FormItem>
              )}
            />

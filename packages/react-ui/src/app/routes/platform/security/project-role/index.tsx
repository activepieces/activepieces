    ...
    >
      <div className="flex-col w-full">
        <div className="flex items-center justify-between mb-4">
          <TableTitle description={t('Define custom roles and permissions that can be assigned to your team members')}>
          ...
          {!platform.customRolesEnabled && (
            <Tooltip>
              ...
              <TooltipContent side="bottom">{t('Contact sales to unlock custom roles')}</TooltipContent>
            </Tooltip>
          )}
          {platform.customRolesEnabled && (
            <ProjectRoleDialog mode="create" onSave={() => refetch()} platformId={platform.id}>
        ...
        <ProjectRolesTable projectRoles={data} isLoading={isLoading} refetch={refetch} />
      </div>
    </LockedFeatureGuard>
  )
}

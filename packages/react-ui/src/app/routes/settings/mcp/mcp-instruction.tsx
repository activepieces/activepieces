    ...
    <div>
      <div className="space-y-4 w-full max-w-[700px]">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Follow the instructions below for your specific MCP client</p>
        </div>
        ...
        <Tabs>
          ...
          <TabsContent value="claude" className="text-muted-foreground mt-3 pl-1 max-w-[700px]">
            <Alert variant="warning" className="mt-4 mb-2">
              <AlertDescription className="text-xs">
                <p>Note: MCPs currently only work with Claude Desktop, not the web version.</p>
                <p>You can download it from: https://claude.ai/download</p>
              </AlertDescription>
            </Alert>
            <ol className="list-decimal list-inside space-y-2 text-sm text-foreground">
              <li>
                <span className="font-semibold">Open</span> <strong>Settings</strong> from the menu in the Claude
                Desktop App
              </li>
              <li>
              ...
              <li>
                <span className="font-semibold">Copy and paste</span> the server config to your claude_desktop_config,
                then save
              </li>
              <li>
            ...
            <Alert variant="default" className="mt-4 mb-2">
              <AlertDescription className="text-xs">
                <p>
                  <code>mcp-remote</code> connects the Claude Desktop App to our remote server since Claude only
                  supports local connections.
                </p>
                <p className="mt-1">
                  Note: This requires <code>npx</code> to be installed on your system.
                </p>
              </AlertDescription>
            </Alert>
          ...
          <TabsContent value="cursor" className="mt-4 pl-2 max-w-[700px]">
            <ol className="list-decimal list-inside space-y-2 text-sm text-foreground">
              <li>
                <span className="font-semibold">Navigate to</span> <strong>Settings</strong>, then{' '}
          ...
          <TabsContent value="windsurf" className="text-muted-foreground mt-3 pl-1 max-w-[700px]">
            <ol className="list-decimal list-inside space-y-2 text-sm text-foreground">
              <li>
                <span className="font-semibold">Open settings by either:</span>
                <ul className="list-disc list-inside ml-6 mt-1">
                  <li>
                    Navigating to <strong>Windsurf - Settings</strong>, then <strong>Advanced Settings</strong>
                  </li>
                  <li>
                    Opening the <strong>Command Palette</strong> and selecting <strong>Windsurf Settings Page</strong>
                  </li>
                </ul>
              </li>
              <li>
            ...
            <Alert variant="default" className="mt-4 mb-2">
              <AlertDescription className="text-xs">
                <p>
                  <code>mcp-remote</code> connects Claude Desktop to our remote server since Claude only supports local
                  connections.
                </p>
                <p className="mt-1">
                  Note: This requires <code>npx</code> to be installed on your system.

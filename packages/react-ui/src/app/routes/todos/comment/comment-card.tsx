...
function CommentCard({ firstName, lastName, content, createdAt }: CommentCardProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <span className="w-full text-sm bg-muted p-3 rounded-md border b ">
        <ApMarkdown markdown={content} variant={MarkdownVariant.BORDERLESS} className="bg-muted" />
      </span>

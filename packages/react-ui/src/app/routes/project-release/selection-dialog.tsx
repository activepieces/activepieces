...
export function SelectionButton({ ReleaseType, children, onSuccess, defaultName, ...props }: SelectionButtonProps) {
  ...
  return (
    <>
      ...
      {ReleaseType === ProjectReleaseType.PROJECT && (
        <ProjectSelectionDialog open={open} setOpen={setOpen} projectId={project.id} onSuccess={onSuccess} />
      )}
    </>
  )
}

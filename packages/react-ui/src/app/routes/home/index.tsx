...
const StartFromScratchSection = () => {
   ...
   return <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-7xl mx-auto">
        <div className="text-center" >
            ...
            <Table2 className="text-green-500 w-10 h-10"></Table2>
            </div>
             ...
             <p>
                {
                    t("Invite an AI agent to work right on your data, it can help you research data and take actions based on your data. It's like a human working with you in a sheet, but an AI.")
                }
             </p>
        ...
        <div className="text-center" >
            <div className="flex items-center justify-center mb-5">
            <Workflow className="text-blue-500 w-10 h-10"></Workflow>
            </div>
             <h3 className="text-xl font-semibold mb-4">
                {t('Agent in a Flow')}
             </h3>
             <p>
                {
                    t("Build multi-step workflows where AI agents make smart decisions and connect different apps together. Perfect for complex automations.")
                }
             </p>

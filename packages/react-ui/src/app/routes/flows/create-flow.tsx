...
import { FLOW_TEMPLATE_JSON_QUERY_PARAM, NEW_FLOW_FOLDER_NAME_QUERY_PARAM, NEW_FLOW_QUERY_PARAM } from "@/lib/utils";
...
const CreateFlowPage = () => {
    ...
    const uriEncodedFlowTemplateJson = queryParams.get(FLOW_TEMPLATE_JSON_QUERY_PARAM);

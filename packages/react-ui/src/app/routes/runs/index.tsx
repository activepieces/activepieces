  ...
  return (
    <div className="flex flex-col gap-4 grow">
      ...
      <div className="flex-col w-full">
        <TableTitle description={t('Track the automation run history and status and troubleshoot issues.')}>
          {t('Flow Runs')}
        </TableTitle>
          ...
          <TabsList variant="outline">
            ...
            <TabsTrigger value="issues" variant="outline">
              <span className="flex items-center gap-2">
                ...
                {t('Issues')}
                {showIssuesNotification && <span className="ml-1 inline-block w-2 h-2 bg-red-500 rounded-full"></span>}
              </span>
            </TabsTrigger>
          </TabsList>

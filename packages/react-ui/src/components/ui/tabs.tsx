...
const tabsTriggerVariants = cva('inline-flex items-center justify-center', {
  variants: {
    variant: {
      ...
      outline:
        'px-3 py-1.5 text-sm font-medium ring-offset-background transition-all border-b-2 border-transparent data-[state=active]:border-secondary-foreground data-[state=active]:text-foreground text-muted-foreground',
    },
  },
  defaultVariants: {
    variant: 'default',

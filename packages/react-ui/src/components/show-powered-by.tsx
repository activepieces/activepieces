...
const ShowPoweredBy = ({ show, position = 'sticky' }: ShowPoweredByProps) => {
  ...
  return (
    ...
    >
      <div className="justify-end p-1 items-center flex gap-1.5 transition group ">
        <div className="text-muted-foreground text-sm transition">
          Built with
        </div>
        <div className="justify-center flex items-center gap-1">
          <svg
            ...
            viewBox="0 0 24 24"
            className="transition fill-muted-foreground"
          >
          ...
          <div className="text-muted-foreground text-sm transition flex items-center">
            activepieces
          </div>
        </div>
      </div>

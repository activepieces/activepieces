...
const ShowPoweredBy = (props: ShowPoweredByProps) => {
  ...
  return (
    <div
      className="justify-center p-2 items-center flex gap-1.5 transition group absolute bottom-5 right-5"
      onMouseEnter={() => setHover(true)}
      onMouseLeave={() => setHover(false)}
    >
      <div className="text-muted-foreground text-sm transition">Built with</div>

...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--primary', colorsUtils.hexToHslString(branding.colors.primary.default))
    document.documentElement.style.setProperty('--ring', colorsUtils.hexToHslString(branding.colors.primary.default))

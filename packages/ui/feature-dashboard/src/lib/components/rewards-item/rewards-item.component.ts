...
import { Observable } from 'rxjs';
  ...
  @Component({
    ...
    template: `
        <div class="ap-flex ap-items-center ap-gap-2.5">
            <svg-icon  [src]="rewardItem.icon"  [applyClass]="true" class="ap-w-[20px] ap-h-[20px] ap-fill-body">
  </svg-icon>
  ...
  <div class="ap-text-description ap-typography-body-2 "> +{{rewardItem.tasksPerMonth}} tasks / month </div>
  <div class="ap-w-[90px] ap-flex ap-justify-center">
  <ap-button btnColor="primary" btnStyle="basic" btnSize="medium" (buttonClicked)="rewardItem.ctaEffect()"> {{rewardItem.cta}} </ap-button>

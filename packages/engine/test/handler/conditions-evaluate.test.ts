...
describe('Branch evaluateConditions', () => {
  describe('DATE_IS_AFTER', () => {
    test.each([null, undefined, 'not a date'])(
      'should return false when one of the values is not a date %p',
      (value) => {
    ...
    test.each(['2021-01-01', '2021-01-02'])(
      'should return false when first date is before or equal to second date',
      (firstDate) => {
        const condition: BranchCondition = {
  ...
  describe('DATE_IS_BEFORE', () => {
    ...
    test.each(['2021-01-01', '2021-01-02'])(
      'should return false when first date is after or equal to second date',
      (firstDate) => {
        const condition: BranchCondition = {
          firstValue: firstDate,
          secondValue: '2021-01-01',
  ...
  describe('DATE_IS_EQUAL', () => {
    ...
    test.each(['2021-01-01', '2021-01-03'])(
      'should return false when first date is after or before the second date',
      (firstDate) => {
        const condition: BranchCondition = {
          firstValue: firstDate,
          secondValue: '2021-01-02',
  ...
  describe('LIST_IS_EMPTY', () => {
    ...
    test.each([null, undefined, 'not a list', {}])(
      'should return false when the value is not a list %p',
      (input: any) => {
        const condition: BranchCondition = {
          firstValue: input,
          operator: BranchOperator.LIST_IS_EMPTY,
  ...
  describe('LIST_CONTAINS', () => {
    test.each([
      ...
      ({ expected, list, value, caseSensitive }) => {
        const condition: BranchCondition = {

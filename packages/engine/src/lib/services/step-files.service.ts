...
import { FileLocation, StepFileUpsertResponse, isNil } from '@activepieces/shared'
...
function createFormData({
  ...
  stepName,
  flowId,
}: { fileName: string; data: Buffer; stepName: string; flowId: string }): FormData {
...
async function uploadFileMetadata({
  ...
  engineToken,
  apiUrl,
}: { formData: FormData; engineToken: string; apiUrl: string }): Promise<StepFileUpsertResponse> {

...
export const pieceHelper = {
  ...
  async executeValidateAuth({
    params,
    piecesSource,
  }: { params: ExecuteValidateAuthOperation; piecesSource: string }): Promise<ExecuteValidateAuthResponse> {
  ...
  async extractPieceMetadata({
    piecesSource,
    params,
  }: { piecesSource: string; params: ExecuteExtractPieceMetadata }): Promise<PieceMetadata> {

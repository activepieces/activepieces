...
export const STATIC_PAGES: StaticPage[] = [
  ...
  },
  {
    ...
    href: '/platform/setup/ai/capabilities',
    icon: BotIcon,
    requiresPlatformAdmin: true,
  },
  {
  ...
  },
  {
    ...
    href: '/platform/setup/mcp/tools',
    icon: ConnectIcon,
    requiresPlatformAdmin: true,
  },
  {
    id: 'page-platform-mcp-activity',
    label: 'Platform Admin — MCP Activity',
    href: '/platform/setup/mcp/activity',
    icon: ConnectIcon,
    requiresPlatformAdmin: true,
  },
  {
  ...
  },
  {
    ...
    href: '/platform/setup/pieces/piece-sets',
    icon: PuzzleIcon,
    requiresPlatformAdmin: true,
  },
  {
  ...
  },
  {
    ...
    href: '/platform/infrastructure/workers/groups',
    icon: ServerIcon,
    requiresPlatformAdmin: true,
  },
  {
  ...
  {
    id: 'page-platform-health-runs',
    label: 'Platform Admin — Runs Health',
    href: '/platform/infrastructure/health/runs',
    icon: FileHeartIcon,
    requiresPlatformAdmin: true,
  },
  {
    id: 'page-platform-health-queue',
    label: 'Platform Admin — Queue Health',
    href: '/platform/infrastructure/health/queue',
    icon: FileHeartIcon,
    requiresPlatformAdmin: true,
  },
  {

import { ConnectSecretManagerRequest, SecretManagerConnectionScope, SecretManagerConnectionWithStatus, SecretManagerProviderConfig, SecretManagerProviderId } from "@activepieces/shared";

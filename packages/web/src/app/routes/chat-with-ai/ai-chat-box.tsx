...
const keyframes = `
  ...
  .model-menu { position: absolute; bottom: 100%; left: 0; margin-bottom: 6px; background: var(--popover); border: 1px solid var(--border); border-radius: 10px; padding: 4px; min-width: 200px; box-shadow: 0 4px 16px rgba(0,0,0,0.1); z-index: 20; animation: fadeSlideUp 0.12s ease; }
  .model-option { display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 7px 12px; border-radius: 7px; border: none; background: transparent; cursor: pointer; font-family: inherit; font-size: 14px; color: var(--foreground); transition: background 0.12s; outline: none; text-align: left; }
  .model-option:hover { background: var(--muted); }
  .dark .model-option:hover { background: var(--accent); }
  .model-option.active { font-weight: 400; }

...
import { dateRangeUtils, getAuthPropertyForValue, InputPropertyMap, PieceAuthProperty, PieceProperty, PiecePropertyMap, PropertyType, StaticPropsValue } from '@activepieces/pieces-framework'
...
const validateProperty = (property: PieceProperty, value: unknown, originalValue: unknown): string[] => {
    ...
    switch (property.type) {
        ...
        case PropertyType.DATE_RANGE:
            return dateRangeUtils.isDateRangeValue(value) ? [] : [`Expected date range, received: ${originalValue}`]

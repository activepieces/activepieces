    ...
    backup: async (updateParams: BackUpLogsParams): Promise<void> => {
        ...
        await lock.runExclusive(async () => {
            ...
            const request: UploadRunLogsRequest = {
                ...
                failedStep: (flowExecutorContext.verdict.status === FlowRunStatus.FAILED || flowExecutorContext.verdict.status === FlowRunStatus.LOG_SIZE_EXCEEDED) ? flowExecutorContext.verdict.failedStep : undefined,

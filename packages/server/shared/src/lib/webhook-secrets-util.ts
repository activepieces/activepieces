import { FlowVersion, assertNotNullOrUndefined, isNil, parseToJsonIfPossible } from '@activepieces/shared'

let webhookSecrets: Record<string, { webhookSecret: string | Record<string, string> }> | undefined = undefined

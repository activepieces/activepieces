...
// sandbox. The serverless BundledTgzInstall strategy (engine self-install from pre-built .tgz
// bundles in parallel) is the engine-side counterpart and ships separately — see

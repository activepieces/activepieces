...
import { ExtractStructuredDataJobData, ResolveAiProviderResponse } from '@activepieces/shared'
...
function buildMessages({ data, files }: { data: ExtractStructuredDataJobData, files: ResolvedAiFile[] }): ModelMessage[] {

...
const GROUPS: AgentToolGroups = {
    ...
    agentSurface: toolSet('ap_list_agents', 'ap_create_agent', 'ap_update_agent', 'ap_publish_agent'),
...
describe('what may reach the tools that build saved agents', () => {
    const AGENT_SURFACE_TOOLS = ['ap_list_agents', 'ap_create_agent', 'ap_update_agent', 'ap_publish_agent']

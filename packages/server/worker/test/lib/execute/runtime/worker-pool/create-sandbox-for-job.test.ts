...
vi.mock('../../../../../src/lib/execute/runtime/worker-pool/sandbox/sandbox', () => ({
    createSandbox: createSandboxMock,
}))

vi.mock('../../../../../src/lib/execute/runtime/worker-pool/sandbox/isolate', () => ({
    isolateProcess: isolateProcessMock,
}))

vi.mock('../../../../../src/lib/execute/runtime/worker-pool/sandbox/fork', () => ({
...
import { createSandboxForJob } from '../../../../../src/lib/execute/runtime/worker-pool/create-sandbox-for-job'

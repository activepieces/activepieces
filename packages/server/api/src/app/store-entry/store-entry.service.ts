import { ProjectId, PutStoreEntryRequest, StoreEntry, apId, sanitizeObjectForPostgresql } from '@activepieces/shared'
...
export const storeEntryService = {
  async upsert({
    projectId,
    request,
  }: { projectId: ProjectId; request: PutStoreEntryRequest }): Promise<StoreEntry | null> {

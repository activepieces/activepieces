...
export async function selectIcon(requirement: string, conversationHistory: Message[] = []): Promise<string> {
    try {
        ...
        console.debug('Analyzing requirement for icon selection:', requirement)
        ...
        5. If no suitable icon is found, return "code" as the default
        ...
        console.debug('Icon selection response:', {
            requirement,
        ...
        return llmResponse?.object?.icon ?? 'code'
    }
    catch (error) {

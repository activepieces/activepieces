...
import { ApEdition, ApEnvironment, AppConnectionWithoutSensitiveData, Flow, FlowRun, FlowTemplate, Folder, isNil, McpActionWithConnection, McpPieceWithConnection, McpWithActions, ProjectRelease, ProjectWithLimits, spreadIfDefined, UserInvitation } from '@activepieces/shared'
        ...
        openapi: {
            ...
            components: {
                ...
                schemas: {
                    ...
                    'mcp': McpWithActions,
                    'mcp-action': McpActionWithConnection,

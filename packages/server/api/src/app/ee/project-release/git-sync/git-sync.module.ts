import { ConfigureRepoRequest, GitRepoWithoutSensitiveData, PushGitRepoRequest } from '@activepieces/ee-shared'
...
export const gitRepoModule: FastifyPluginAsync = async (app) => {
  ...
  app.addHook(
    'preHandler',
    platformMustHaveFeatureEnabled((platform) => platform.environmentsEnabled),
  )

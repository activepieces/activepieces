import { ApiKeyResponseWithValue, ApiKeyResponseWithoutValue, CreateApiKeyRequest } from '@activepieces/ee-shared'
...
export const apiKeyModule: FastifyPluginAsyncTypebox = async (app) => {
  app.addHook(
    'preHandler',
    platformMustHaveFeatureEnabled((platform) => platform.apiKeysEnabled),
  )

...
export const secretManagerCache = {
    ...
    async getSecretValue({
        ...
        const result = await distributedStore.get<EncryptedObject>(
            buildSecretValueKey({ platformId, connectionId, path }),
        )
    ...
    async invalidateConnectionEntries({
        platformId,
        connectionId,
    }: {
        platformId: string

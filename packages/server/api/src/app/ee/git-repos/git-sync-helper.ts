...
async function fetchFlowsForProject(
    projectId: string,
...
async function parseFlowsFromDirectory(
    flowPath: string,
): Promise<PopulatedFlow[]> {
...
async function applyFlowOperations({
    projectId,
    flowFolderPath,
    operations,
}: {
...
async function upsertFlowToProject(
    flow: PopulatedFlow,
    projectId: string,
): Promise<void> {
...
async function upsertFlowToGit(
    flow: Flow,
    flowFolderPath: string,
): Promise<void> {
...
async function deleteFlowFromGit(
    flowId: string,
    flowFolderPath: string,
): Promise<void> {
...
async function deleteFlowFromProject(
    flowId: string,
    projectId: string,
): Promise<void> {

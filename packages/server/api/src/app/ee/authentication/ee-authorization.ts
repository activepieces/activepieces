import { ActivepiecesError, ErrorCode, Platform, PlatformRole, PrincipalType, isNil } from '@activepieces/shared'
...
export const platformMustHaveFeatureEnabled =
  (handler: (platform: Platform) => boolean): onRequestAsyncHookHandler =>
  async (request, _res) => {

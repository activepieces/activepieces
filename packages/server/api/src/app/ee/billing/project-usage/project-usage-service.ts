...
export const projectUsageService = {
    async addTasksConsumed(request: {
        ...
        usageAlerts
            ...
            .catch((e) =>
                logger.error(e, '[usageService#addTasksConsumed] handleAlerts'),
            )
...
async function enrichProjectUsage(
    schema: ProjectUsageSchema,
...
async function createNewUsage(
    projectId: string,
    nextReset: string,
): Promise<ProjectUsageSchema> {

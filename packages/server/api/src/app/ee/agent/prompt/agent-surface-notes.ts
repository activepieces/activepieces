...
const ONBOARDING_FIRST_MESSAGE_NOTE = [
    ...
    '',
    '**Then answer with three or four concrete use cases**, each written as the plain first-person instruction they would type themselves, three to six words, naming the app when one is involved. Follow each with one short plain-English line on what it does for them. No prose wall, no bullet-point feature list. One warm sentence before them is plenty.',
    '',

...
import { AddTriggerPayloadFlowRunSQLITE1737844653684 } from './migration/sqlite/1737844653684-AddTriggerPayloadFlowRunSQLITE'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddTriggerPayloadFlowRunSQLITE1737844653684,
    ]

...
import { AddPieceSelectorConfigToPlatformSqlite1796000000000 } from './migration/sqlite/1796000000000-AddPieceSelectorConfigToPlatformSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddPieceSelectorConfigToPlatformSqlite1796000000000,
    ]

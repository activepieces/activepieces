...
import { SeperateTriggerFromFlowsSqlite1754358230010 } from './migration/sqlite/1754358230010-SeperateTriggerFromFlowsSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        SeperateTriggerFromFlowsSqlite1754358230010,
    ]

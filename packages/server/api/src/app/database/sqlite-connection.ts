...
import { RemoveOrderFromFolderSqlite1748268763402 } from './migration/sqlite/1748268763402-RemoveOrderFromFolderSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        RemoveOrderFromFolderSqlite1748268763402,
    ]

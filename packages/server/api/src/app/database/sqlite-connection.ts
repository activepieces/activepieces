...
import { RemoveAgentidFromMcpEntity1760452015042 } from './migration/sqlite/1760452015042-remove-agentid-from-mcp-entity' 
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        RemoveAgentidFromMcpEntity1760452015042
    ]

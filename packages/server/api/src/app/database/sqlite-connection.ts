...
import { AddFailedStepAndDurationToRunSqlite1762877962975 } from './migration/sqlite/1762877962975-AddFailedStepAndDurationToRunSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddFailedStepAndDurationToRunSqlite1762877962975,
    ]

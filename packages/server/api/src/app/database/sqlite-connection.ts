...
import { AddFailedStepIdToFlowRunTableSqlite1749560332604 } from './migration/sqlite/1749560332604-add_failedStepId_to_flow_run_table.sqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddFailedStepIdToFlowRunTableSqlite1749560332604,
    ]

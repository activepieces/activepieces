...
export class AddTodosSquashed1742874382959 implements MigrationInterface {
    name = 'AddTodosSquashed1742874382959'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."idx_todo_platform_id"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."idx_todo_flow_id"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."idx_todo_project_id"
        `);
        await queryRunner.query(`
            DROP TABLE "todo"
        `);

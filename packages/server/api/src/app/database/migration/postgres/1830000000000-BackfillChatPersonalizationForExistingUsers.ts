...
export class BackfillChatPersonalizationForExistingUsers1830000000000 implements Migration {
    name = 'BackfillChatPersonalizationForExistingUsers1830000000000'
    breaking = false
    release = '0.88.2'
    transaction = true

...
export class initializeSchema1676238396411 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const userTableExists =
      userTableExistsQueryResponse && userTableExistsQueryResponse.length > 0 && userTableExistsQueryResponse[0].exists
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP INDEX "idx_app_connection_project_id_and_app_name_and_name"')
    ...
    await queryRunner.query('DROP INDEX "idx_collection_version_collection_id"')

...
export class RemoveLegacyAiCreditsColumnsFromPlatformPlan1821000000000 implements Migration {
    name = 'RemoveLegacyAiCreditsColumnsFromPlatformPlan1821000000000'
    breaking = true
    release = '0.85.4'

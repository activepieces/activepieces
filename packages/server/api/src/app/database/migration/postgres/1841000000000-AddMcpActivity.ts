...
export class AddMcpActivity1841000000000 implements Migration {
    name = 'AddMcpActivity1841000000000'
    breaking = false
    release = '0.88.4'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `)
        await queryRunner.query(`
            CREATE INDEX IF NOT EXISTS "idx_mcp_activity_platform_id_status_created_id"
            ON "mcp_activity" ("platformId", "status", "created", "id")
        `)
        await queryRunner.query(`
            CREATE INDEX IF NOT EXISTS "idx_mcp_activity_platform_id_client_key_created_id"
            ON "mcp_activity" ("platformId", "clientKey", "created", "id")
        `)
        await queryRunner.query(`

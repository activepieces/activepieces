...
export class MigrateTeamProjectsLimitToNumberAndAddUsersLimit1820000000000 implements Migration {
    name = 'MigrateTeamProjectsLimitToNumberAndAddUsersLimit1820000000000'
    breaking = false
    release = '0.85.4'
    transaction = true

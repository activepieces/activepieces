...
export class SwitchToRouter1741578250432 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        log.info({
            name: 'SwitchToRouter1741578250432: up',
            updatedFlows,
        })
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        throw new Error('SwitchToRouter1741578250432: down - no rollback supported')
    }
}

...
export class AddRecordOrderColumn1741695545298 implements MigrationInterface {
    name = 'AddRecordOrderColumn1741695545298'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP INDEX "idx_record_project_id_table_id_order"
        `);
        await queryRunner.query(`
            DROP INDEX "idx_record_project_id_table_id"
        `);

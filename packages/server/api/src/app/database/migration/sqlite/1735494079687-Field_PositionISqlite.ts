...
export class FieldPositionIndexSqlite1735494079687 implements MigrationInterface {
    name = 'FieldPositionIndexSqlite1735494079687'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            DROP INDEX "idx_field_project_id_table_id_position"
        `)
        await queryRunner.query(`
            DROP INDEX "idx_field_project_id_table_id_name_unique"
        `)

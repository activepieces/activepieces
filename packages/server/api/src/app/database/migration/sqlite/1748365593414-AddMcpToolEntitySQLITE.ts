...
import { ApId, apId, AppConnectionWithoutSensitiveData, assertNotNullOrUndefined, BaseModelSchema, Flow, isNil, McpPieceToolData, McpTool, McpToolType, Trigger, TriggerType } from '@activepieces/shared'
...
function isMcpTriggerPiece(trigger: Trigger): boolean {

...
import { AddConnectionIdsGinIndexToFlowVersion1804000000000 } from './migration/postgres/1804000000000-AddConnectionIdsGinIndexToFlowVersion'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddConnectionIdsGinIndexToFlowVersion1804000000000,
    ]
    return migrations
}

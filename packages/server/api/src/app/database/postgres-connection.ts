...
import { AddMaxBarrierSignalsToPlatformConfiguration1842000000000 } from './migration/postgres/1842000000000-AddMaxBarrierSignalsToPlatformConfiguration'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddMaxBarrierSignalsToPlatformConfiguration1842000000000,
    ]
    return migrations
}

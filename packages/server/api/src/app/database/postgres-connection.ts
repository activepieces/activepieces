...
import { AddAgentIdsGinIndexToFlowVersion1840000000000 } from './migration/postgres/1840000000000-AddAgentIdsGinIndexToFlowVersion'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddAgentIdsGinIndexToFlowVersion1840000000000,
    ]
    return migrations
}

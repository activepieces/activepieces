...
import { AddAgentIdsGinIndexToFlowVersion1828000000000 } from './migration/postgres/1828000000000-AddAgentIdsGinIndexToFlowVersion'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddAgentIdsGinIndexToFlowVersion1828000000000,
    ]
    return migrations
}

...
import { CollapseFlowApprovalRequestPendingPerFlow1791000000000 } from './migration/postgres/1791000000000-CollapseFlowApprovalRequestPendingPerFlow'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        CollapseFlowApprovalRequestPendingPerFlow1791000000000,
    ]
    return migrations
}

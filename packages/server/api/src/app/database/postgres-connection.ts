...
import { AddFlowProjectIdExternalIdUniqueIndex1837000000000 } from './migration/postgres/1837000000000-AddFlowProjectIdExternalIdUniqueIndex'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddFlowProjectIdExternalIdUniqueIndex1837000000000,
    ]
    return migrations
}

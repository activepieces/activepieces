...
import { AddDeprecatedToPieceMetadata1810000000000 } from './migration/postgres/1810000000000-AddDeprecatedToPieceMetadata'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddDeprecatedToPieceMetadata1810000000000,
    ]
    return migrations
}

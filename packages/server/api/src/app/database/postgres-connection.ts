...
import { AddFailedStepIdToFlowRunTablePostgres1749560332604 } from './migration/postgres/1749560332604-add_failedStepId_to_flow_run_table.postgres'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const commonMigration = [
        ...
        AddFailedStepIdToFlowRunTablePostgres1749560332604,
    ]

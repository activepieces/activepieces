...
import { RemoveLastFreeAiCreditsRenewalDate1772027510000 } from './migration/postgres/1772027510000-RemoveLastFreeAiCreditsRenewalDate'
...
export const getMigrations = (): (new () => MigrationInterface)[] => {
    const migrations = [
        ...
        RemoveLastFreeAiCreditsRenewalDate1772027510000,
    ]
    return migrations
}

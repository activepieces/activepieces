...
import { AddCreatedIndexToAuditEvent1804000000000 } from './migration/postgres/1804000000000-AddCreatedIndexToAuditEvent'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddCreatedIndexToAuditEvent1804000000000,
    ]
    return migrations
}

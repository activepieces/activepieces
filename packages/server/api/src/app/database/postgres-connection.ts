...
import { AddCanaryIndexToPlatformPlan1774700000000 } from './migration/postgres/1774700000000-AddCanaryIndexToPlatformPlan'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddCanaryIndexToPlatformPlan1774700000000,
    ]
    return migrations
}

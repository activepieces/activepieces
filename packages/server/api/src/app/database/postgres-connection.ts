...
import { AddPieceStepsVersionsBackupsToFlowVersion1774500000000 } from './migration/postgres/1774500000000-AddPieceStepsVersionsBackupsToFlowVersion'
...
export const getMigrations = (): (new () => MigrationInterface)[] => {
    const migrations = [
        ...
        AddPieceStepsVersionsBackupsToFlowVersion1774500000000,
    ]
    return migrations
}

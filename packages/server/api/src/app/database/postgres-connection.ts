...
import { AddChatAutonomyAndConsentPolicy1818000000000 } from './migration/postgres/1818000000000-AddChatAutonomyAndConsentPolicy'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddChatAutonomyAndConsentPolicy1818000000000,
    ]
    return migrations
}

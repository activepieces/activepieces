...
import { AddConnectionIdsGinIndexToFlowVersion1805000000000 } from './migration/postgres/1805000000000-AddConnectionIdsGinIndexToFlowVersion'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddConnectionIdsGinIndexToFlowVersion1805000000000,
    ]
    return migrations
}

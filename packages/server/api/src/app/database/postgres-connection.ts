...
import { AddFlowAiProviderMigrationsTable1775100000000 } from './migration/postgres/1775100000000-AddFlowAiProviderMigrationsTable'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddFlowAiProviderMigrationsTable1775100000000,
    ]
    return migrations
}

...
import { AddMaxBarrierSignalsToPlatformConfiguration1843000000000 } from './migration/postgres/1843000000000-AddMaxBarrierSignalsToPlatformConfiguration'
...
export const getMigrations = (): (new () => Migration)[] => {
    const migrations = [
        ...
        AddMaxBarrierSignalsToPlatformConfiguration1843000000000,
    ]
    return migrations
}

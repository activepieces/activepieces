import { isNil, parseToJsonIfPossible, Permission } from '@activepieces/core-utils'
...
export const apUpdateStepTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        ...
        inputSchema: {
            ...
            input: z.preprocess(parseJsonStringArg, z.record(z.string(), z.unknown()).optional().describe(`Input settings for the step (key-value pairs matching the action schema). ${mcpUtils.STEP_REFERENCE_HINT}`)),

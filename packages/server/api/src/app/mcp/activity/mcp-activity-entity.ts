...
export const McpActivityEntity = new EntitySchema<McpActivityWithSchema>({
    ...
    indices: [
        ...
        {
            name: 'idx_mcp_activity_platform_id_status_created_id',
            columns: ['platformId', 'status', 'created', 'id'],
        },
        {
            name: 'idx_mcp_activity_platform_id_client_key_created_id',
            columns: ['platformId', 'clientKey', 'created', 'id'],
        },
        {

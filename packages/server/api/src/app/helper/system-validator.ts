...
const systemPropValidators: {
    ...
    [AppSystemProp.FUNCTION_ENGINE_TOKEN]: stringValidator,
    [AppSystemProp.FUNCTION_GCP_PROJECT]: stringValidator,
    [AppSystemProp.FUNCTION_GCP_REGION]: stringValidator,
    [AppSystemProp.FUNCTION_GCP_SOURCE]: stringValidator,
    [AppSystemProp.FUNCTION_GCP_RUNTIME]: stringValidator,
    [AppSystemProp.FUNCTION_GCP_KEY_FILE]: stringValidator,

...
export enum AppSystemProp {
    ...
    MAX_BARRIER_SIGNALS = 'MAX_BARRIER_SIGNALS',
    MAX_FIELDS_PER_TABLE = 'MAX_FIELDS_PER_TABLE',
    MAX_FILE_SIZE_MB = 'MAX_FILE_SIZE_MB',
    AI_CREDIT_USD_VALUE = 'AI_CREDIT_USD_VALUE',
    MAX_FLOW_RUN_LOG_SIZE_MB = 'MAX_FLOW_RUN_LOG_SIZE_MB',
    FLOW_RUN_LOG_INPUT_TRUNCATE_THRESHOLD_KB = 'FLOW_RUN_LOG_INPUT_TRUNCATE_THRESHOLD_KB',
    FLOW_RUN_LOG_SLICE_THRESHOLD_KB = 'FLOW_RUN_LOG_SLICE_THRESHOLD_KB',

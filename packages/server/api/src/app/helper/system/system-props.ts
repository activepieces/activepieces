...
export enum AppSystemProp {
    ...
    COPILOT_PER_PLATFORM_MESSAGES_PER_DAY = 'COPILOT_PER_PLATFORM_MESSAGES_PER_DAY',
    COPILOT_PER_PLATFORM_TOKENS_PER_DAY = 'COPILOT_PER_PLATFORM_TOKENS_PER_DAY',
    COPILOT_DAILY_GLOBAL_USD_CAP = 'COPILOT_DAILY_GLOBAL_USD_CAP',
}

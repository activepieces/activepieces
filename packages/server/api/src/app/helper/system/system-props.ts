...
export enum AppSystemProp {
    ...
    FUNCTION_ENGINE_TOKEN = 'FUNCTION_ENGINE_TOKEN',
    FUNCTION_GCP_PROJECT = 'FUNCTION_GCP_PROJECT',
    FUNCTION_GCP_REGION = 'FUNCTION_GCP_REGION',
    FUNCTION_GCP_SOURCE = 'FUNCTION_GCP_SOURCE',
    FUNCTION_GCP_RUNTIME = 'FUNCTION_GCP_RUNTIME',
    FUNCTION_GCP_KEY_FILE = 'FUNCTION_GCP_KEY_FILE',

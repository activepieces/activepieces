      ...
      'workflows/Rssfeedread/0188_Rssfeedread_Telegram_Create_Scheduled.json',
        trigger: createScheduleTrigger({
            ...
            nextAction: createPieceAction({
                ...
                nextAction: createPieceAction({
                    name: 'step_2',
                    displayName: 'Send Telegram Digest',
                    pieceName: '@activepieces/piece-telegram-bot',
                    actionName: 'send_text_message',
                    input: {
                        auth: '{{connections[\'telegram-bot\']}}',
                        chat_id: '{{connections[\'telegram-chat-id\']}}',
                        message: 'RSS digest update: {{step_1}}',
                    },
                }),
            }),
        }),
      ...
      'workflows/Googlecalendar/0783_GoogleCalendar_Schedule_Create_Scheduled.json',
        trigger: createScheduleTrigger({
            ...
            nextAction: createPieceAction({
                ...
                nextAction: createPieceAction({
                    name: 'step_2',
                    displayName: 'Send Slack Agenda',
                    pieceName: '@activepieces/piece-slack',
                    actionName: 'send_channel_message',
                    input: {
                        auth: '{{connections[\'slack\']}}',
                        text: 'Today’s calendar agenda: {{step_1}}',
                    },
                }),
            }),
        }),

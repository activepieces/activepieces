import { RAW_PAYLOAD_HEADER, WebhookUrlParams, WebsocketClientEvent } from '@activepieces/shared'
...
function extractRawPayload(request: FastifyRequest): { payload?: Record<string, unknown> } {
    const isRawPayload =
        request.headers[RAW_PAYLOAD_HEADER] === 'true' &&

...
import { ApId, ScheduleOptions, isNil } from '@activepieces/shared'
...
type RepeatingJobAddParams<JT extends JobType.REPEATING> = Omit<
  BaseAddParams<JT, RepeatingJobData> & {

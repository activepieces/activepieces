...
import { EventDestinationJobData, ExecuteChatAgentJobData, ExecuteFlowJobData, ExecutePersonalizationResearchJobData, getDefaultJobPriority, JOB_PRIORITY, JobData, PollingJobData, RenewWebhookJobData, ScheduleOptions, UserInteractionJobData, WebhookJobData, WorkerJobType } from '@activepieces/shared'
        ...
        switch (type) {
            ...
            case JobType.ONE_TIME: {
                return queue.add(params.id, data, {
                    ...
                    // No retries: a replayed research job would duplicate progress
                    // events and LLM spend; crash recovery is the staleness reset.
                    ...(data.jobType === WorkerJobType.EXECUTE_PERSONALIZATION_RESEARCH ? { attempts: 1 } : {}),
...
type OneTimeJobAddParams = BaseAddParams<ExecuteFlowJobData | WebhookJobData | UserInteractionJobData | EventDestinationJobData | ExecuteChatAgentJobData | ExecutePersonalizationResearchJobData, JobType.ONE_TIME>

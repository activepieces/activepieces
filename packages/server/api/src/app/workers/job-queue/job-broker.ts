...
import { projectInactiveInterceptor } from './interceptors/project-inactive-interceptor'
...
const interceptors: JobInterceptor[] = [projectInactiveInterceptor, rateLimiterInterceptor, zombiePollingInterceptor]

...
import { actionRunPersistQueue } from '../action-run/action-run-persist-queue'
...
export const workerModule: FastifyPluginAsyncZod = async (app) => {
    ...
    await actionRunPersistQueue(app.log).init()
    ...
    app.addHook('onClose', async () => {
        ...
        await actionRunPersistQueue(app.log).close()

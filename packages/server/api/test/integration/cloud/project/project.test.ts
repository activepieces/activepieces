...
describe('Project API', () => {
  ...
  describe('List Projects by user', () => {
    it('it should list owned projects in platform', async () => {
      await mockAndSaveBasicSetup()
      const {
        mockOwner: mockUserTwo,
        mockProject: mockProjectTwo,
        mockPlatform: mockPlatformTwo,
      } = await mockAndSaveBasicSetup()
  ...
  describe('Delete Project endpoint', () => {
    it('Soft deletes project by id', async () => {
      ...
      const mockProjectToDelete = createMockProject({
      ...
      const deletedProject = await databaseConnection()
        .getRepository('project')
        .findOneBy({ id: mockProjectToDelete.id })
    ...
    it('Fails if project has enabled flows', async () => {
      ...
      const enabledFlow = createMockFlow({
        projectId: mockProjectToDelete.id,

...
import { createMockOAuthApp, mockAndSaveBasicSetup, mockBasicUser } from '../../../helpers/mocks'
...
describe('OAuth App API', () => {
  ...
  describe('List OAuth Apps endpoint', () => {
    it('should list OAuth Apps by platform owner', async () => {
      ...
      await databaseConnection().getRepository('oauth_app').save([mockOAuthAppsOne])

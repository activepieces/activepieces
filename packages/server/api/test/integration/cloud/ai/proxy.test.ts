import { CategorizedModelPricing, DALLE3PricingPerImage, FlatLanguageModelPricing, GPTImage1PricingPerImage, TieredLanguageModelPricing } from '@activepieces/common-ai'
        ...
        describe('Google Gemini', () => {
            ...
            it('should record the usage cost of a categorized pricing model (Gemini 2.5 Flash) with text input and web search', async () => {
                ...
                const totalCost = calculateTokensCost(usageMetadata.candidatesTokenCount + (usageMetadata.thoughtsTokenCount ?? 0), outputCost) +
                    calculateTokensCost(usageMetadata.promptTokenCount, inputPricing.text) + webSearchCost

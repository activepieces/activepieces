import { FlowVersion, ProjectId, TriggerHookType, TriggerPayload, TriggerType } from '@activepieces/shared'
import { getPieceTrigger } from './trigger-utils'
import { logger } from '../../../helper/logger'
import { engineHelper } from '../../../helper/engine-helper'
import { webhookService } from '../../../webhooks/webhook-service'

export async function executeTrigger(params: ExecuteTrigger): Promise<unknown[]> {

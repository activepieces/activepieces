import { FlowVersion, ProjectId, TriggerHookType, TriggerPayload, TriggerType, isNil } from '@activepieces/shared'
import { engineHelper } from '../../../helper/engine-helper'
import { webhookService } from '../../../webhooks/webhook-service'
import { WebhookHandshakeStrategy, WebhookResponse } from '@activepieces/pieces-framework'
import { getPieceTrigger } from './trigger-utils'

export async function tryHandshake(params: ExecuteHandshakeParams): Promise<WebhookResponse | null> {

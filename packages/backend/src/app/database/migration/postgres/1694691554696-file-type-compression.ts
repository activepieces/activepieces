...
export class FileTypeCompression1694691554696 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TABLE "file" ADD "type" character varying NOT NULL DEFAULT \'UNKNOWN\'')
        await queryRunner.query('ALTER TABLE "file" ADD "compression" character varying NOT NULL DEFAULT \'NONE\'')

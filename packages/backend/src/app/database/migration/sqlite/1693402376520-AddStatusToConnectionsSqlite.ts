...
export class AddStatusToConnectionsSqlite1693402376520 implements MigrationInterface {
    name = 'AddStatusToConnectionsSqlite1693402376520'

    public async up(queryRunner: QueryRunner): Promise<void> {
        if (await migrationRan('AddStatusToConnectionsSqlite31693402376520', queryRunner)) {
            return
        }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('INSERT INTO "app_connection"("id", "created", "updated", "name", "appName", "projectId", "value", "type") SELECT "id", "created", "updated", "name", "appName", "projectId", "value", "type" FROM "temporary_app_connection"')

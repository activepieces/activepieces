...
export class AddChatBotSqlite31696029443045 implements MigrationInterface {
    name = 'AddChatBotSqlite31696029443045'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('INSERT INTO "temporary_chatbot"("id", "created", "updated", "type", "displayName", "projectId", "connectionId", "visibilityStatus", "dataSources", "prompt") SELECT "id", "created", "updated", "type", "displayName", "projectId", "connectionId", "visibilityStatus", "dataSources", "prompt" FROM "chatbot"')
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE TABLE "chatbot" ("id" varchar(21) PRIMARY KEY NOT NULL, "created" datetime NOT NULL DEFAULT (datetime(\'now\')), "updated" datetime NOT NULL DEFAULT (datetime(\'now\')), "type" varchar NOT NULL, "displayName" varchar NOT NULL, "projectId" varchar NOT NULL, "connectionId" varchar, "visibilityStatus" varchar NOT NULL, "dataSources" text NOT NULL, "prompt" varchar)')
        await queryRunner.query('INSERT INTO "chatbot"("id", "created", "updated", "type", "displayName", "projectId", "connectionId", "visibilityStatus", "dataSources", "prompt") SELECT "id", "created", "updated", "type", "displayName", "projectId", "connectionId", "visibilityStatus", "dataSources", "prompt" FROM "temporary_chatbot"')

...
export class AddPartialUniqueIndexForEmailAndPlatformIdIsNull1701096458822 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        logger.info('AddPartialUniqueIndexForEmailAndPlatformIdIsNull1701096458822 up')
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        logger.info('AddPartialUniqueIndexForEmailAndPlatformIdIsNull1701096458822 down')
    }

export const AP_FUNCTIONS: ApFunction[] = [
    ...
    },
    {
        name: 'to_json',
        category: 'text',
        description: 'Turns any value into its JSON text, so a list or an object can sit inside a sentence.',
    ...
    },
    {
        name: 'to_epoch',
        category: 'date',
        description: 'Turns a date into the number of seconds or milliseconds since 1 January 1970.',
        syntax: 'to_epoch(date; unit)',
        example: 'to_epoch( 2025-01-15T00:00:00Z ; ms )',
        exampleResult: '1736899200000',
        minArgs: 1,
        maxArgs: 2,
        argTypes: [['string', 'date'], 'string'],
        returnType: 'number',
    },
    {
        name: 'add_minutes',

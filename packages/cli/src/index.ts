...
import {
    generateTranslationFileForAllPiecesCommand,
    generateTranslationFileForPieceCommand,
} from './lib/commands/generate-translation-file-for-piece'
...
const pieceCommand = new Command('pieces').description('Manage pieces')
...
const workerCommand = new Command('workers').description('Manage workers')

import { OAuth2PropertyValue, OAuth2Props, StaticPropsValue, TriggerStrategy, createTrigger } from "@activepieces/pieces-framework";
...
const polling: Polling< OAuth2PropertyValue<OAuth2Props> , StaticPropsValue<typeof props>> = {

import { Authentication, AuthenticationType, HttpMessageBody, HttpMethod, QueryParams, httpClient } from "@activepieces/pieces-common"
...
import { Paste, PasteCreateRequest, PasteCreateResponse, PasteEditRequest, PasteListRequest, PasteShareRequest } from "./models/paste"

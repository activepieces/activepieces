...
export const chatGemini = createAction({
    ...
    props: {
        model: Property.StaticDropdown({
            displayName: 'Model',
            required: true,
            description: 'The model to chat with. (For now limited to Gemini Pro, according to Google: "The gemini-pro-vision model (for text-and-image input) is not yet optimized for multi-turn conversations. Make sure to use gemini-pro and text-only input for chat use cases.")',

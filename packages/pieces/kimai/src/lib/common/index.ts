...
export const kimaiCommon = {
    project: Property.Dropdown({
        ...
        options: async ({ auth }) => {
            ...
            const client = await makeClient(auth as PiecePropValueSchema<typeof kimaiAuth>);
...
export async function makeClient(auth: PiecePropValueSchema<typeof kimaiAuth>): Promise<KimaiClient> {

import { Property, createAction, Validators } from '@activepieces/pieces-framework';
import { timeZoneOptions, timeDiff } from '../common/date-helper';
...
export const delayNextDayofYear = createAction({
	...
	async run(context) {
        ...
        return await delayUntil(context, nextOccurrence);
	},
});

...
import {  CheckboxProperty, DateTimeProperty, FileProperty, LongTextProperty, NumberProperty, OAuth2PropertyValue, Property, ShortTextProperty } from "@activepieces/pieces-framework";
...
type DynamicPropsValue = ShortTextProperty<boolean> | LongTextProperty<boolean> | CheckboxProperty<boolean> | DateTimeProperty<boolean> | FileProperty<boolean> | NumberProperty<boolean>
        ...
        options: async ({ auth }) => {
            ...
            if( !connection ){
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'please authenticate your account first before selecting properties',
                }
            }
            try{

import { TriggerStrategy, WebhookHandshakeStrategy, WebhookResponse, createTrigger } from "@activepieces/pieces-framework";
...
export const taskStarted = createTrigger({
    ...
    async onEnable(context) {
        const webhookId = await common.subscribeWebhook(context.auth, context.webhookUrl, OnfleetWebhookTriggers.TASK_STARTED);

...
export const createTask = createAction({
    ...
    async run(context) {
        ...
        if (context.propsValue.useRecipientID) {
            recipients = [
                context.propsValue.recipient['id']
            ]
        }
        else {
            recipients = [
        ...
        const completeAfter = context.propsValue.completeAfter ? dayjs(context.propsValue.completeAfter).valueOf() : undefined;
        const completeBefore = context.propsValue.completeBefore ? dayjs(context.propsValue.completeBefore).valueOf() : undefined;

...
export const triggers = [
  ...
  {
    type: EventTrigger.BOOKING_CREATED, displayName: "Booking Created", sampleData: {
  ...
  {
    type: EventTrigger.BOOKING_RESCHEDULED, displayName: "Booking Rescheduled", sampleData: {
      ...
      "payload": {
        ...
        "videoCallData": {
          ...
          "password": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyIjoiOXRKUkRDUnc5RVNtYjY0U3VFd1UiLCJvIjp0cnVlLCJkIjoiYmJkOThhNzEtMTljOS00YmIxLWE1YzUtY2FmMWVjNWJkMTA1IiwiaWF0IjoxNjc2NzIyMjg2fQ.EomaETTsmNnG3MZt6zQG9URtrHTclZhpk88jU0du5fE",

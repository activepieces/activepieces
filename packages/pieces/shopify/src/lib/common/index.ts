...
import { ShopifyAuth, ShopifyCheckout, ShopifyCollect, ShopifyCustomer, ShopifyDraftOrder, ShopifyFulfillment, ShopifyFulfillmentEvent, ShopifyImage, ShopifyOrder, ShopifyProduct, ShopifyProductVariant, ShopifyTransaction } from "./types"
...
export async function updateCustomer(id: string, customer: Partial<ShopifyCustomer>, auth: ShopifyAuth): Promise<ShopifyCustomer> {
    const response = await sendShopifyRequest({
        auth: auth,
        url: `/customers/${id}.json`,
...
export async function getProducts(auth: ShopifyAuth, search: {
    title?: string,
    createdAtMin?: string,
    updatedAtMin?: string,
...
export async function updateProduct(id: number, product: Partial<ShopifyProduct>, auth: ShopifyAuth): Promise<ShopifyProduct> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function createDraftOrder(draftOrder: Partial<ShopifyDraftOrder>, auth: ShopifyAuth): Promise<ShopifyDraftOrder> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function createTransaction(orderId: number, transaction: Partial<ShopifyTransaction>, auth: ShopifyAuth): Promise<ShopifyTransaction> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function createFulfillmentEvent(id: number, orderId: number, event: Partial<ShopifyFulfillmentEvent>, auth: ShopifyAuth): Promise<ShopifyFulfillmentEvent> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function adjustInventoryLevel(id: number, locationId: number, adjustment: number, auth: ShopifyAuth): Promise<unknown> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function createProductImage(id: number, image: Partial<ShopifyImage>, auth: ShopifyAuth): Promise<ShopifyImage> {
    const response = await sendShopifyRequest({
        auth: auth,
...
export async function getAbandonedCheckouts(auth: ShopifyAuth, search: {
    sinceId: string,

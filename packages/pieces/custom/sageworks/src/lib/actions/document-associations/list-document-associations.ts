...
export const listDocumentAssociations = createAction({
  auth: sageworksAuth,
  name: 'document_association_list',
  displayName: 'Document Association - List',
  description: 'Retrieve a list of document associations',
  props: {

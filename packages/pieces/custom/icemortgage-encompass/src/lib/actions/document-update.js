...
exports.updateDocument = (0, pieces_framework_1.createAction)({
    ...
    props: {
        ...
        documents: pieces_framework_1.Property.Array({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, baseUrl, _a, loanId, documents, view, accessToken, queryParams, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        auth = context.auth;
                        baseUrl = auth.baseUrl;
                        _a = context.propsValue, loanId = _a.loanId, documents = _a.documents, view = _a.view;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, pieces_common_1.httpClient.sendRequest({
                                ...
                                url: "".concat(baseUrl, "/encompass/v3/loans/").concat(loanId, "/documents?").concat(queryParams.toString()),
                                headers: {

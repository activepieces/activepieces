...
exports.deleteLoan = (0, pieces_framework_1.createAction)({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, baseUrl, loanId, accessToken, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        auth = context.auth;
                        baseUrl = auth.baseUrl;
                        loanId = context.propsValue.loanId;
                        return [4 /*yield*/, (0, helpers_1.getAccessToken)(auth)];
                    case 1:
                        accessToken = _a.sent();
                        return [4 /*yield*/, pieces_common_1.httpClient.sendRequest({
                                method: pieces_common_1.HttpMethod.DELETE,
                                url: "".concat(baseUrl, "/encompass/v3/loans/").concat(loanId),
                                headers: {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                message: "Loan ".concat(loanId, " deleted successfully"),
                            }];
                }
            });
        });

...
exports.listDocuments = (0, pieces_framework_1.createAction)({
    name: 'document_list',
    ...
    props: {
        ...
        includeRemoved: pieces_framework_1.Property.Checkbox({
            displayName: 'Include Removed Documents',
            description: 'Whether to include removed documents in the results',
            required: false,
            defaultValue: false,
        }),
        requireActiveAttachments: pieces_framework_1.Property.Checkbox({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, baseUrl, _a, loanId, view, includeRemoved, requireActiveAttachments, accessToken, queryParams, url, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        auth = context.auth;
                        baseUrl = auth.baseUrl;
                        _a = context.propsValue, loanId = _a.loanId, view = _a.view, includeRemoved = _a.includeRemoved, requireActiveAttachments = _a.requireActiveAttachments;
                        return [4 /*yield*/, (0, helpers_1.getAccessToken)(auth)];
                    case 1:
                        accessToken = _b.sent();
                        ...
                        if (requireActiveAttachments)
                            queryParams.append('requireActiveAttachments', 'true');
                        url = "".concat(baseUrl, "/encompass/v3/loans/").concat(loanId, "/documents").concat(queryParams.toString() ? '?' + queryParams.toString() : '');

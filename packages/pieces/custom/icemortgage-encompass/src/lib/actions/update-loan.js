...
exports.updateLoan = (0, pieces_framework_1.createAction)({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, baseUrl, _a, loanId, loanData, view, templateType, templatePath, ignoreEmptyClosingCostValues, ignoreEmptyLoanProgramValues, accessToken, queryParams, url, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        auth = context.auth;
                        baseUrl = auth.baseUrl;
                        _a = context.propsValue, loanId = _a.loanId, loanData = _a.loanData, view = _a.view, templateType = _a.templateType, templatePath = _a.templatePath, ignoreEmptyClosingCostValues = _a.ignoreEmptyClosingCostValues, ignoreEmptyLoanProgramValues = _a.ignoreEmptyLoanProgramValues;
                    ...
                    case 1:
                        ...
                        url = "".concat(baseUrl, "/encompass/v3/loans/").concat(loanId).concat(queryParams.toString() ? '?' + queryParams.toString() : '');

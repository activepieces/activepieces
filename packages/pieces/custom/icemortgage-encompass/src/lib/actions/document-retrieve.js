...
exports.retrieveDocument = void 0;
...
exports.retrieveDocument = (0, pieces_framework_1.createAction)({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, baseUrl, _a, loanId, documentId, accessToken, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        auth = context.auth;
                        baseUrl = auth.baseUrl;
                        _a = context.propsValue, loanId = _a.loanId, documentId = _a.documentId;
                        return [4 /*yield*/, (0, helpers_1.getAccessToken)(auth)];
                    case 1:
                        accessToken = _b.sent();
                        return [4 /*yield*/, pieces_common_1.httpClient.sendRequest({
                                method: pieces_common_1.HttpMethod.GET,
                                url: "".concat(baseUrl, "/encompass/v3/loans/").concat(loanId, "/documents/").concat(documentId),
                                headers: {

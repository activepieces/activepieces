...
const OAuthProp = z.union([ShortTextProperty, SecretTextProperty, StaticDropdownProperty])
...
const OAuth2ExtraProps = z.object({
    ...
    grantType: z
        .union([z.nativeEnum(OAuth2GrantType), z.literal(BOTH_CLIENT_CREDENTIALS_AND_AUTHORIZATION_CODE)])
        .optional(),
...
export type OAuth2Property<T extends OAuth2Props> = BasePieceAuthSchema<OAuth2PropertyValue<T>> &
    OAuth2ExtraProps &

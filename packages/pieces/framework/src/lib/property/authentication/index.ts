...
export const PieceAuthProperty = z.union([BasicAuthProperty, CustomAuthProperty, OAuth2Property, SecretTextProperty])
...
export type ExtractPieceAuthPropertyTypeForMethods<T extends PieceAuthProperty | PieceAuthProperty[] | undefined> =
    T extends PieceAuthProperty[] ? T[number] : T extends undefined ? undefined : T

...
export const Property = {
    ...
    MarkDown(request: { value: string; variant?: MarkdownVariant }): MarkDownProperty {
        return {
    ...
    >(
        ...
        } as unknown as R extends true ? DropdownProperty<T, true, PieceAuth> : DropdownProperty<T, false, PieceAuth>
    },
    ...
    >(
        ...
        } as unknown as R extends true ? DynamicProperties<true, PieceAuth> : DynamicProperties<false, PieceAuth>
    },

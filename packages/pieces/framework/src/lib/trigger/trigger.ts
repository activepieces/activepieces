...
type OnStartRunner<PieceAuth extends PieceAuthProperty | undefined, TriggerProps extends InputPropertyMap> = (
    ctx: OnStartContext<PieceAuth, TriggerProps>,
...
> = {
    ...
    type: TS
    onEnable: (
        context: TriggerHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
    ) => Promise<void>
    onDisable: (
        context: TriggerHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
    ) => Promise<void>
    run: (
        context: TestOrRunHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
    ) => Promise<unknown[]>
    test?: (
        context: TestOrRunHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
    ) => Promise<unknown[]>
...
> implements TriggerBase
{
    constructor(
        ...
        public readonly onHandshake: (
            ctx: TriggerHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
        ) => Promise<WebhookResponse>,
        ...
        public readonly run: (
            ctx: TestOrRunHookContext<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>, TriggerProps, TS>,
        ) => Promise<unknown[]>,
    ...
    switch (params.type) {
        ...
        case TriggerStrategy.APP_WEBHOOK:
            return new ITrigger(
                ...
                params.test ?? (() => Promise.resolve([params.sampleData])),
                params.sampleData,
                isNil(params.sampleData) && isNil(params.test)

    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: tickets.length === 0 ? 'No tickets available' : 'Select a ticket',
            }
        } catch (error: unknown) {
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: organizations.length === 0 ? 'No organizations available' : 'Select an organization',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: users.length === 0 ? 'No users available' : 'Select a user',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {
...
export const problemTicketIdDropdown = Property.Dropdown({
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            const problemTickets = tickets.filter((ticket) => ticket.type === 'problem')
            ...
            return {
                ...
                placeholder: problemTickets.length === 0 ? 'No problem tickets available' : 'Select a problem ticket',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: customRoles.length === 0 ? 'No custom roles available' : 'Select a custom role',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: brands.length === 0 ? 'No brands available' : 'Select brands for agent access',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {
    ...
    options: async (propsValue) => {
        ...
        try {
            ...
            return {
                ...
                placeholder: groups.length === 0 ? 'No groups available' : 'Select a group',
            }
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : String(error)
            return {

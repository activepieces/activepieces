...
export const newSuspendedTicket = createTrigger({
  ...
  sampleData: {
    id: 5,
    url: 'https://activepieceshelp.zendesk.com/api/v2/suspended_tickets/5.json',
    external_id: null,
    via: {
      channel: 'web',
      source: {
    ...
    raw_subject: 'Raw Suspended Ticket Subject',
    description: 'Suspended ticket description',
    priority: null,
    status: 'suspended',
    recipient: null,

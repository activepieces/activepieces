...
import { brandIdDropdown, groupIdDropdown, organizationIdDropdown, problemTicketIdDropdown } from '../common/props'
    ...
    async run({ propsValue, auth }) {
        ...
        try {
            ...
            if (errorMessage.includes('422')) {
                throw new Error('Validation error. Please check that all required fields are provided and valid.')
            }

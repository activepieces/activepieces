...
export const updateCompany = createAction({
  ...
  props: {
    ...
    groups: Property.Array({
      displayName: 'Groups',
      description: 'The groups to add the company to. Provide group IDs. This will replace existing groups.',
      required: false,
    }),
    addresses: Property.Array({
      displayName: 'Addresses',
      description: 'A list of addresses associated with the company. The first address will be the primary address. This will replace existing addresses.',
      required: false,
    }),
    emails: Property.Array({
      displayName: 'Emails',
      description: 'A list of email addresses associated with the company. The first email will be the primary email. This will replace existing emails.',
      required: false,
    }),
    phones: Property.Array({
      displayName: 'Phones',
      description: 'A list of phone numbers associated with the company. The first phone will be the primary phone. This will replace existing phones.',
      required: false,
    }),
    urls: Property.Array({
      displayName: 'URLs',
      description: 'A list of URLs associated with the company. The first URL will be the primary URL. This will replace existing URLs.',
      required: false,
    }),
  ...
  async run(context) {
    const { companyId, name, description, fundingRaised, lastFundingDate, industry, foundationYear, employeeRange, groups, addresses, emails, phones, urls, customFieldValues } = context.propsValue;

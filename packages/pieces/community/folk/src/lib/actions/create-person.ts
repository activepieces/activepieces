...
export const createPerson = createAction({
  ...
  props: {
    ...
    groups: Property.Array({
      displayName: 'Groups',
      description: 'The groups to add the person to. Provide group IDs',
      required: false,
    }),
    companies: Property.Array({
      displayName: 'Companies',
      description: 'The companies associated with the person. Provide objects with "name" or "id". The first company will be the primary company.',
      required: false,
    }),
    addresses: Property.Array({
      displayName: 'Addresses',
      description: 'A list of addresses associated with the person. The first address will be the primary address',
      required: false,
    }),
    emails: Property.Array({
      displayName: 'Emails',
      description: 'A list of email addresses associated with the person. The first email will be the primary email',
      required: false,
    }),
    phones: Property.Array({
      displayName: 'Phones',
      description: 'A list of phone numbers associated with the person. The first phone will be the primary phone',
      required: false,
    }),
    urls: Property.Array({
      displayName: 'URLs',
      description: 'A list of URLs associated with the person. The first URL will be the primary URL',
      required: false,
    }),

...
import { Client, GraphError, PageCollection } from '@microsoft/microsoft-graph-client'
...
export const findFileAction = createAction({
    ...
    props: {
        ...
        searchFolderId: Property.Dropdown({
            ...
            description:
                'The folder to search within. If not specified, the entire drive will be searched. **Only applies when searching by name.**',
            required: false,

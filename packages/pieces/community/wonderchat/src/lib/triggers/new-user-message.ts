...
const polling: Polling<AppConnectionValueForAuthProperty<typeof wonderchatAuth>, { chatlogId: string }> = {
...
export const newUserMessage = createTrigger({
    ...
    props: {
        chatlogId: Property.ShortText({
            ...
            description: 'The ID of your chat session (can be found under Chatlog Details section, labeled as "ID")',
            required: true,
        }),
    },
    sampleData: {

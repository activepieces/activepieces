...
import { lossReasonDropdown, pipelineDropdown, statusDropdown, userDropdown } from '../common/props'
...
export const createLeadAction = createAction({
    ...
    async run(context) {
        const { name, price, statusId, pipelineId, loss_reason_id, responsible_user_id } = context.propsValue

...
export const createContactAction = createAction({
    ...
    async run(context) {
        const { name, first_name, last_name, email, phone, responsible_user_id } = context.propsValue
        ...
        const result = await makeRequest({ apiToken, subdomain }, HttpMethod.POST, `/contacts`, [contactPayload])

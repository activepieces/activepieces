...
import { createGoogleClient, GmailAuthValue, gmailAuth } from '../auth'
import { convertAttachment, getFirstFiveOrAll, parseStream } from '../common/data'
...
> {
    ...
    if (props.filenameExtension) query.push(`filename:${props.filenameExtension}`)

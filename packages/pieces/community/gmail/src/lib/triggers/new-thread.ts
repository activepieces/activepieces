...
export const gmailNewThreadTrigger = createTrigger({
    auth: gmailAuth,
    name: 'new_thread',
    displayName: 'New Thread (Conversation)',
    description: 'Trigger when a new conversation (thread) begins.',
    props: {

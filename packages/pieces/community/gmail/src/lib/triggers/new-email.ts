import { FilesService, PiecePropValueSchema, TriggerStrategy, createTrigger } from '@activepieces/pieces-framework'
import dayjs from 'dayjs'
import { google } from 'googleapis'
import { OAuth2Client } from 'googleapis-common'
import { gmailAuth } from '../../'
import { GmailRequests, convertAttachment, parseStream } from '../common/data'

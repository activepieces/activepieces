...
export const gmailCreateLabelAction = createAction({
  ...
  aiMetadata: {
    description:
      'Creates a new user label in the connected Gmail account. Use this before applying a label that does not yet exist. Not idempotent: creating a label whose name already exists returns an error.',
    idempotent: false,
  },
  props: {
    name: Property.ShortText({
      displayName: 'Label Name',
      description: 'The display name of the new label.',
      required: true,
    }),
    label_list_visibility: Property.StaticDropdown({
      displayName: 'Label List Visibility',
      description: 'Visibility of the label in the label list in the Gmail UI.',
      required: false,
    ...
    message_list_visibility: Property.StaticDropdown({
      ...
      description:
        'Visibility of messages with this label in the message list in the Gmail UI.',
      required: false,
      defaultValue: 'show',
      options: {
        disabled: false,

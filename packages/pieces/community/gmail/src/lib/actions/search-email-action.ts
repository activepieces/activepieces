...
export const gmailSearchMailAction = createAction({
  ...
  description: 'Find emails using advanced search criteria. At least one search filter (from, to, subject, label, category, date, content, or attachment) is required.',
  props: {

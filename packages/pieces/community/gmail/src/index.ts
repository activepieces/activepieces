...
export const gmail = createPiece({
  ...
  triggers: [gmailNewEmailTrigger, gmailNewLabeledEmailTrigger, gmailNewStarredEmailTrigger, gmailNewConversationTrigger, gmailNewAttachmentTrigger, gmailNewLabelTrigger],
  auth: gmailAuth,
});

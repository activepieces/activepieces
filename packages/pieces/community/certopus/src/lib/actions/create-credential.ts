...
export const createCredential = createAction({
  ...
  props: {
    ...
    category: Property.Dropdown<string>({
      ...
      options: async ({ auth, organisation, event }) => {
        ...
        const client = makeClient(auth as string)
        const res = await client.listCategories(organisation as string, event as string)
        console.log(res)
    ...
    fields: Property.DynamicProperties({
      ...
      props: async ({ auth, organisation, event, category }) => {
        ...
        try {
          ...
          const recipientFields: RecipientField[] = await client.listRecipientFields(
  ...
  async run(context) {
    const { organisation, event, category, publish, generate, email, fields } = context.propsValue

...
import { BASE_URL, priority, projectId, statusId, taskId, userId, workspaceId } from '../common/props'
...
export const updateTask = createAction({
    ...
    async run({ auth, propsValue }) {
        const { name, workspaceId, description, dueDate, duration, statusId, priority, assigneeId } = propsValue

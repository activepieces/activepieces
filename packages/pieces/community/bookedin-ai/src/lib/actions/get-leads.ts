...
export const getLeadsAction = createAction({
  ...
  async run({ auth, propsValue }) {
    // Construct query parameters object, filtering out undefined/empty values
    ...
    const response = await httpClient.sendRequest({
      ...
      url: `${BASE_URL}/leads/`, // Keeping trailing slash to match typical behavior of this API
      headers: getBookedinHeaders(auth),

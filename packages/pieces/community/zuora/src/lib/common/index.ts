...
export async function queryAccounts(auth: AppConnectionValueForAuthProperty<typeof zuoraAuth>) {
...
export async function getAccessToken(auth: AppConnectionValueForAuthProperty<typeof zuoraAuth>): Promise<string> {
    const request: HttpRequest = {

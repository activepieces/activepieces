...
export const updateCampaignSettingsAction = createAction({
    ...
    async run(context) {
        ...
        if (stop_lead_settings !== undefined) body['stop_lead_settings'] = stop_lead_settings
        if (unsubscribe_text !== undefined && unsubscribe_text !== '') body['unsubscribe_text'] = unsubscribe_text
        if (enable_ai_esp_matching !== undefined) body['enable_ai_esp_matching'] = enable_ai_esp_matching
        if (send_as_plain_text !== undefined) body['send_as_plain_text'] = send_as_plain_text

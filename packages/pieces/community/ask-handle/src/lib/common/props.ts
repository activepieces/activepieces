...
export const roomDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await askHandleApiCall(auth.secret_text, HttpMethod.GET, '/rooms/')
...
export const leadDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await askHandleApiCall(auth.secret_text, HttpMethod.GET, '/leads/')

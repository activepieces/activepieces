...
export const createLead = createAction({
    ...
    async run(context) {
        const { nickname, email, phone_number, device, from_page_title, referrer } = context.propsValue
        ...
        return await askHandleApiCall(context.auth.secret_text, HttpMethod.POST, '/leads/', payload)
    },
})

...
export const sendRcsAction = createAction({
    ...
    props: {
        ...
        from: Property.ShortText({
            displayName: 'From',
            description:
                'The unique ID of your RCS agent. If not specified, the first RCS-capable sender will be used.',
            required: false,
        }),
    ...
    async run(context) {
        const { to, text, from, delay, fallback, ttl, label, performance_tracking, foreign_id } = context.propsValue

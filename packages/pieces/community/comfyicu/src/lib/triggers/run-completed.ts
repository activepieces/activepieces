...
const polling: Polling<AppConnectionValueForAuthProperty<typeof comfyIcuAuth>, { workflow_id: string }> = {
...
export const runCompletedTrigger = createTrigger({
    ...
    sampleData: {
                    ...
                    workflow: {
                        ...
                        nodes: [
                            ...
                            },
                            {
                                ...
                                widgets_values: [253353381004563, 'randomize', 20, 8, 'euler', 'normal', 1],
                            },
                            {
                                id: 4,
                                pos: [],
        ...
        output: [
            {
                filename: '/workflows/xyz/output/xyz/ComfyUI_00001_.png',
                url: 'https://r2.comfy.icu/workflows/xyz/output/CNCr5a_lu6g9Nz3gqKC9P/ComfyUI_00001_.png',
                thumbnail_url: 'https://img.comfy.icu/sig/width:300/quality:85/xyz',
            },
        ],
        error: null,
        files: {},

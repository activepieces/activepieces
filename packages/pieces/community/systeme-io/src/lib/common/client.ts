...
export const systemeIoCommon = {
    ...
    async getContact({ contactId, auth }: { contactId: string; auth: string | { apiKey: string } }) {
        return this.apiCall({
            method: HttpMethod.GET,
    ...
    async getTags({ auth }: { auth: string | { apiKey: string } }) {
        return this.apiCall({
            method: HttpMethod.GET,
            url: '/tags',
            auth,
    ...
    async getContactFields({ auth }: { auth: string | { apiKey: string } }) {
        return this.apiCall({
            method: HttpMethod.GET,
            url: '/contact_fields',
            auth,

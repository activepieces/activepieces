...
export const updateContact = createAction({
    ...
    description:
        'Update fields (name, phone, custom fields) of an existing contact using fields from your Systeme.io account',
    props: {
    ...
    async run(context) {
        const { contactId, dynamicContactFields, customFields } = context.propsValue
        ...
        return {
            ...
            dynamicFieldsProcessed: dynamicContactFields
                ? Object.keys(dynamicContactFields).filter(
                      (key) =>

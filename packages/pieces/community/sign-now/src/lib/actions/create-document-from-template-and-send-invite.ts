...
import { getSignNowBearerToken, signNowAuth } from '../common/auth'
...
export const createDocumentFromTemplateAndSendInviteAction = createAction({
    ...
    description: 'Creates a new document from a template and sends a free form invite to a signer.',
    props: {
        ...
        to: Property.ShortText({
            ...
            description:
                "Email address of the signer. A free form invite can be sent to the sender's own email address.",
            required: true,
        }),

...
import { getSignNowBearerToken, SignNowAuthValue } from './auth'
...
export async function unregisterWebhook(auth: SignNowAuthValue, subscriptionId: string): Promise<void> {
    const token = getSignNowBearerToken(auth)

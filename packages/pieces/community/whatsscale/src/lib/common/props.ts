...
export const whatsscaleProps = {
    session: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/sessions')
    ...
    contact: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth, session }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/contacts', undefined, {
    ...
    group: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth, session }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/groups', undefined, {
                    session: session as string,
                })
    ...
    channel: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth, session }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/channels', undefined, {
                    session: session as string,
                })
    ...
    crmContact: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/crm/contacts')
    ...
    crmTag: Property.Dropdown<string, true, typeof whatsscaleAuth>({
        ...
        options: async ({ auth }): Promise<DropdownState<string>> => {
            ...
            try {
                const response = await whatsscaleClient(auth.secret_text, HttpMethod.GET, '/make/crm/tags')

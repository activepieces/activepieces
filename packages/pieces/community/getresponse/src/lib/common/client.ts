...
export async function listGetResponseFromFields(auth: GetResponseAuthValue): Promise<GetResponseFromField[]> {
...
export function flattenGetResponseCampaign(campaign: GetResponseCampaign): GetResponseFlatRecord {
    return {
...
export function flattenGetResponseContact(contact: GetResponseContact): GetResponseFlatRecord {
    return {
        ...
        custom_field_values: formatContactCustomFieldValues(contact.customFieldValues),
...
export function flattenGetResponseNewsletter(newsletter: GetResponseNewsletter): GetResponseFlatRecord {
    return {
...
function formatContactTags(tags: GetResponseContactTag[] | undefined): string | null {
...
export type GetResponseFlatRecord = Record<string, string | number | boolean | null>

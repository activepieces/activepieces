...
import { GetResponseAuthValue, getresponseAuth } from '../common/auth'
import {
...
export const createOrUpdateContactAction = createAction({
    ...
    description: 'Creates a contact or updates the existing contact with the same email in the selected campaign.',
    props: {

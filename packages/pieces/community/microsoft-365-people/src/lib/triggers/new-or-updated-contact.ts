...
const polling: Polling<AppConnectionValueForAuthProperty<typeof microsoft365PeopleAuth>, Record<string, never>> = {
...
export const newOrUpdatedContact = createTrigger({
    ...
    description: 'Triggers when a contact is created or updated in Microsoft 365 People.',
    props: {},
    sampleData: {},

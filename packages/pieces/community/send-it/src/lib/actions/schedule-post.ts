...
import { mediaUrlProperty, platformProperty, scheduledTimeProperty, sendItRequest, textProperty } from '../common'
...
export const schedulePost = createAction({
    ...
    async run(context) {
        ...
        return await sendItRequest(context.auth.secret_text, HttpMethod.POST, '/schedule', {
            platforms,
            content: {
                text,
                mediaUrl,

...
export const extractWebpageContent = createAction({
    ...
    links_summary: Property.StaticDropdown({
      ...
      options: {
        options: [
          ...
          { label: 'Dedup - List unique links at the end', value: 'dedup' },
    ...
    images_summary: Property.StaticDropdown({
      ...
      options: {
        options: [
          ...
          { label: 'Dedup - List unique images at the end', value: 'dedup' },

...
export const webSearchSummarizationAction = createAction({
    ...
    description: 'Perform a web search and retrieve summarized results using the Reader API.',
    props: {
    ...
    async run(context) {
        ...
        const baseSearchUrl = eu_compliance ? JinaAICommon.euReaderSearchUrl : JinaAICommon.readerSearchUrl

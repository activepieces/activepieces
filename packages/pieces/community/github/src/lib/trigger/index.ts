...
import { githubRegisterOrgTrigger } from './register-org-trigger';
...
export const registered = [
  ...
  },
  {
    ...
    description: 'Triggers when a new branch is created in the repository.',
    sampleData: {
      ...
      repository: {
        ...
        forks_url: 'https://api.github.com/repos/octocat/sample-repo/forks',
        keys_url: 'https://api.github.com/repos/octocat/sample-repo/keys{/key_id}',
        collaborators_url: 'https://api.github.com/repos/octocat/sample-repo/collaborators{/collaborator}',
        teams_url: 'https://api.github.com/repos/octocat/sample-repo/teams',
        hooks_url: 'https://api.github.com/repos/octocat/sample-repo/hooks',
        issue_events_url: 'https://api.github.com/repos/octocat/sample-repo/issues/events{/number}',
        events_url: 'https://api.github.com/repos/octocat/sample-repo/events',
        assignees_url: 'https://api.github.com/repos/octocat/sample-repo/assignees{/user}',
        branches_url: 'https://api.github.com/repos/octocat/sample-repo/branches{/branch}',
        tags_url: 'https://api.github.com/repos/octocat/sample-repo/tags',
        blobs_url: 'https://api.github.com/repos/octocat/sample-repo/git/blobs{/sha}',
        git_tags_url: 'https://api.github.com/repos/octocat/sample-repo/git/tags{/sha}',
        git_refs_url: 'https://api.github.com/repos/octocat/sample-repo/git/refs{/sha}',
        trees_url: 'https://api.github.com/repos/octocat/sample-repo/git/trees{/sha}',
        statuses_url: 'https://api.github.com/repos/octocat/sample-repo/statuses/{sha}',
        languages_url: 'https://api.github.com/repos/octocat/sample-repo/languages',
        stargazers_url: 'https://api.github.com/repos/octocat/sample-repo/stargazers',
        contributors_url: 'https://api.github.com/repos/octocat/sample-repo/contributors',
        subscribers_url: 'https://api.github.com/repos/octocat/sample-repo/subscribers',
        subscription_url: 'https://api.github.com/repos/octocat/sample-repo/subscription',
        commits_url: 'https://api.github.com/repos/octocat/sample-repo/commits{/sha}',
        git_commits_url: 'https://api.github.com/repos/octocat/sample-repo/git/commits{/sha}',
        comments_url: 'https://api.github.com/repos/octocat/sample-repo/comments{/number}',
        issue_comment_url: 'https://api.github.com/repos/octocat/sample-repo/issues/comments{/number}',
        contents_url: 'https://api.github.com/repos/octocat/sample-repo/contents/{+path}',
        compare_url: 'https://api.github.com/repos/octocat/sample-repo/compare/{base}...{head}',
        merges_url: 'https://api.github.com/repos/octocat/sample-repo/merges',
        archive_url: 'https://api.github.com/repos/octocat/sample-repo/zipball/{/ref}',
        downloads_url: 'https://api.github.com/repos/octocat/sample-repo/downloads',
        issues_url: 'https://api.github.com/repos/octocat/sample-repo/issues{/number}',
        pulls_url: 'https://api.github.com/repos/octocat/sample-repo/pulls{/number}',
        milestones_url: 'https://api.github.com/repos/octocat/sample-repo/milestones{/number}',
        notifications_url: 'https://api.github.com/repos/octocat/sample-repo/notifications{?since,all,participating}',
        labels_url: 'https://api.github.com/repos/octocat/sample-repo/labels{/name}',
        releases_url: 'https://api.github.com/repos/octocat/sample-repo/releases{/id}',
        deployments_url: 'https://api.github.com/repos/octocat/sample-repo/deployments',
        ...
        svn_url: 'https://svn.github.com/octocat/sample-repo',
  ...
  },
  {
    ...
    description: 'Triggers when a milestone is created in the repository.',
    sampleData: {
      action: 'created',
      milestone: {
      ...
      repository: {
        ...
        archive_url: 'https://api.github.com/repos/octocat/Hello-World/zipball/{/ref}',
  ...
  },
  {
    ...
    description: 'Triggers when a collaborator is added to or removed from the repository.',
    sampleData: {
      action: 'added',
      member: {
        ...
        avatar_url: 'https://avatars.githubusercontent.com/u/12345?v=4',
        gravatar_id: '',
        url: 'https://api.github.com/users/new-collaborator',
        html_url: 'https://github.com/new-collaborator',
        followers_url: 'https://api.github.com/users/new-collaborator/followers',
        following_url: 'https://api.github.com/users/new-collaborator/following{/other_user}',
        gists_url: 'https://api.github.com/users/new-collaborator/gists{/gist_id}',
        starred_url: 'https://api.github.com/users/new-collaborator/starred{/owner}{/repo}',
        subscriptions_url: 'https://api.github.com/users/new-collaborator/subscriptions',
        organizations_url: 'https://api.github.com/users/new-collaborator/orgs',
        repos_url: 'https://api.github.com/users/new-collaborator/repos',
        events_url: 'https://api.github.com/users/new-collaborator/events{/privacy}',
        received_events_url: 'https://api.github.com/users/new-collaborator/received_events',
        type: 'User',
        site_admin: false
      },
      repository: {
  ...
  },
  {
    ...
    description: 'Triggers when a label is created, edited, or deleted in the repository.',
    sampleData: {
      action: 'created',
      label: {
        id: 208045946,
        ...
        name: 'new-label',
        description: 'A newly created label for categorization',
        color: 'f29513',
        default: false
      },
      repository: {
  ...
  },
  {
    ...
    description: 'Triggers when a release is published in the repository.',
    sampleData: {
      action: 'published',
      release: {
...
export const registeredOrg = [
  {
    ...
    description: 'Triggers when a new repository is created in the organization.',
    sampleData: {
      action: 'created',
      repository: {
        id: 123456789,
        ...
        full_name: 'my-org/new-awesome-repo',
        private: false,
        owner: {
          login: 'my-org',
          id: 987654321,
        ...
        html_url: 'https://github.com/my-org/new-awesome-repo',
        description: 'A new awesome repository for our project',
        fork: false,
        url: 'https://api.github.com/repos/my-org/new-awesome-repo',
        forks_url: 'https://api.github.com/repos/my-org/new-awesome-repo/forks',
        keys_url: 'https://api.github.com/repos/my-org/new-awesome-repo/keys{/key_id}',
        collaborators_url: 'https://api.github.com/repos/my-org/new-awesome-repo/collaborators{/collaborator}',
        teams_url: 'https://api.github.com/repos/my-org/new-awesome-repo/teams',
        hooks_url: 'https://api.github.com/repos/my-org/new-awesome-repo/hooks',
        issue_events_url: 'https://api.github.com/repos/my-org/new-awesome-repo/issues/events{/number}',
        events_url: 'https://api.github.com/repos/my-org/new-awesome-repo/events',
        assignees_url: 'https://api.github.com/repos/my-org/new-awesome-repo/assignees{/user}',
        branches_url: 'https://api.github.com/repos/my-org/new-awesome-repo/branches{/branch}',
        tags_url: 'https://api.github.com/repos/my-org/new-awesome-repo/tags',
        blobs_url: 'https://api.github.com/repos/my-org/new-awesome-repo/git/blobs{/sha}',
        git_tags_url: 'https://api.github.com/repos/my-org/new-awesome-repo/git/tags{/sha}',
        git_refs_url: 'https://api.github.com/repos/my-org/new-awesome-repo/git/refs{/sha}',
        trees_url: 'https://api.github.com/repos/my-org/new-awesome-repo/git/trees{/sha}',
        statuses_url: 'https://api.github.com/repos/my-org/new-awesome-repo/statuses/{sha}',
        languages_url: 'https://api.github.com/repos/my-org/new-awesome-repo/languages',
        stargazers_url: 'https://api.github.com/repos/my-org/new-awesome-repo/stargazers',
        contributors_url: 'https://api.github.com/repos/my-org/new-awesome-repo/contributors',
        subscribers_url: 'https://api.github.com/repos/my-org/new-awesome-repo/subscribers',
        subscription_url: 'https://api.github.com/repos/my-org/new-awesome-repo/subscription',
        commits_url: 'https://api.github.com/repos/my-org/new-awesome-repo/commits{/sha}',
        git_commits_url: 'https://api.github.com/repos/my-org/new-awesome-repo/git/commits{/sha}',
        comments_url: 'https://api.github.com/repos/my-org/new-awesome-repo/comments{/number}',
        issue_comment_url: 'https://api.github.com/repos/my-org/new-awesome-repo/issues/comments{/number}',
        contents_url: 'https://api.github.com/repos/my-org/new-awesome-repo/contents/{+path}',
        compare_url: 'https://api.github.com/repos/my-org/new-awesome-repo/compare/{base}...{head}',
        merges_url: 'https://api.github.com/repos/my-org/new-awesome-repo/merges',
        archive_url: 'https://api.github.com/repos/my-org/new-awesome-repo/zipball/{/ref}',
        downloads_url: 'https://api.github.com/repos/my-org/new-awesome-repo/downloads',
        issues_url: 'https://api.github.com/repos/my-org/new-awesome-repo/issues{/number}',
        pulls_url: 'https://api.github.com/repos/my-org/new-awesome-repo/pulls{/number}',
        milestones_url: 'https://api.github.com/repos/my-org/new-awesome-repo/milestones{/number}',
        notifications_url: 'https://api.github.com/repos/my-org/new-awesome-repo/notifications{?since,all,participating}',
        labels_url: 'https://api.github.com/repos/my-org/new-awesome-repo/labels{/name}',
        releases_url: 'https://api.github.com/repos/my-org/new-awesome-repo/releases{/id}',
        deployments_url: 'https://api.github.com/repos/my-org/new-awesome-repo/deployments',
        created_at: '2024-01-15T10:30:00Z',
        updated_at: '2024-01-15T10:30:00Z',
        pushed_at: '2024-01-15T10:30:00Z',
        git_url: 'git:github.com/my-org/new-awesome-repo.git',
        ssh_url: 'git@github.com:my-org/new-awesome-repo.git',
        clone_url: 'https://github.com/my-org/new-awesome-repo.git',
        svn_url: 'https://svn.github.com/my-org/new-awesome-repo',
        homepage: null,
        size: 0,
        stargazers_count: 0,
        watchers_count: 0,
...
export const githubTriggers: Trigger[] = [
  ...
  ...registeredOrg.map((def) => githubRegisterOrgTrigger(def))
];

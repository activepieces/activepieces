import { Trigger } from '@ensemble/pieces-framework';
...
export const registered = [
  {
    ...
    sampleData: {
      ...
      pull_request: {
        ...
        html_url: 'https://github.com/ensemble/ensemble/pull/2',
        diff_url: 'https://github.com/ensemble/ensemble/pull/2.diff',
        patch_url: 'https://github.com/ensemble/ensemble/pull/2.patch',
        issue_url:
      ...
      repository: {
        ...
        html_url: 'https://github.com/ensemble/ensemble',
        ...
        git_url: 'git://github.com/ensemble/ensemble.git',
        ssh_url: 'git@github.com/ensemble/ensemble.git',
        clone_url: 'https://github.com/ensemble/ensemble.git',
        svn_url: 'https://github.com/ensemble/ensemble',
        homepage: null,
        size: 6637,
        stargazers_count: 1,
        watchers_count: 1,
  ...
  },
  {
    ...
    sampleData: {
      ...
      issue: {
        ...
        html_url: 'https://github.com/ensemble/ensemble/issues/1',
        id: 1590311655,

...
export const newReviewRequestTrigger = createTrigger({
    ...
    async onEnable(context) {
        ...
        await context.store.put<WebhookInformation>('github_new_review_request_trigger', {
    ...
    async onDisable(context) {
        const webhook = await context.store.get<WebhookInformation>('github_new_review_request_trigger')

...
export class AITableClient {
    ...
    async createRecord(datasheet_id: string, request: object) {
        return await this.makeRequest(HttpMethod.POST, `/v1/datasheets/${datasheet_id}/records`, undefined, request)
    }
    async updateRecord(datasheet_id: string, request: object) {
        return await this.makeRequest(HttpMethod.PATCH, `/v1/datasheets/${datasheet_id}/records`, undefined, request)
    }

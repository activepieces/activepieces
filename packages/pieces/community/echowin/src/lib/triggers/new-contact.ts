...
const polling: Polling<AppConnectionValueForAuthProperty<typeof echowinAuth>, Record<string, never>> = {
    ...
    items: async ({ auth, lastFetchEpochMS }) => {
        ...
        const response = await makeRequest(auth.secret_text, HttpMethod.GET, `/contacts?${queryParams.toString()}`)

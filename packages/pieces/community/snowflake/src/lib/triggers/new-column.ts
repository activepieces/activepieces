...
const polling: Polling<AppConnectionValueForAuthProperty<typeof snowflakeAuth>, NewColumnProps> = {
...
export const newColumnTrigger = createTrigger({
    ...
    description: 'Triggers when a new column is added to the selected table. Checked by polling every few minutes.',
    props,
    sampleData: {
        column_name: 'EMAIL',

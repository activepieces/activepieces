...
export class FireberryClient {
    ...
    async getObjectsMetadata(): Promise<{
        success: boolean
        data: Array<{ name: string; systemName: string; objectType: string }>
    }> {
        return this.request<{
            success: boolean
            data: Array<{ name: string; systemName: string; objectType: string }>
    ...
    async getObjectFieldsMetadata(object: string): Promise<{
        success: boolean
        data: Array<{ label: string; fieldName: string; systemFieldTypeId: string; systemName: string }>
    }> {
        return this.request<{
            success: boolean
            data: Array<{ label: string; fieldName: string; systemFieldTypeId: string; systemName: string }>
    ...
    async getPicklistValues(
        object: string,
        fieldName: string,
    ): Promise<{ success: boolean; data: { values: Array<{ name: string; value: string }> } }> {

...
import { trueLayerCommon } from './lib/common/common';
...
export const paymentsApiV3Payments = createPiece({
  displayName: 'TrueLayer Payments',
  ...
  categories: [],
  logoUrl: 'https://imagedelivery.net/bHREz764QO9n_1kIQUR2sw/056471cd-2cb7-41df-b9b0-ce54f7384b00/public',

        ...
        options: async ({ auth }) => {
            ...
            try {
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load teams. Please check your authentication.',
                }
            }
        },
    })
...
export const coursesDropdown = (refreshers: string[]) =>
    Property.Dropdown({
        ...
        options: async ({ auth, workspaceId }) => {
            ...
            try {
                const courses = await clickfunnelsApiService.fetchCourses(auth.props, workspaceId as string)
...
export const teamMembershipsDropdown = (refreshers: string[], required = true) =>
    Property.Dropdown({
        auth: clickfunnelsAuth,
        ...
        options: async ({ auth, teamId }) => {
            ...
            try {
                ...
                return {
                    options: [{ label: 'Leave Unassigned', value: null }, ...response.memberships].map((membership) => {
                        if (membership.label) {
                            return {
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load team members. Please check your authentication.',
                }
            }
        },
    })
...
export const workspacesDropdown = (refreshers: string[]) =>
    Property.Dropdown({
        ...
        options: async ({ auth, teamId }) => {
            ...
            try {
                const workspaces = await clickfunnelsApiService.fetchWorkspaces(auth.props, teamId as string)
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load workspaces. Please check your authentication.',
                }
            }
        },
    })
...
export const pipelinesDropdown = (refreshers: string[]) =>
    Property.Dropdown({
        ...
        options: async ({ auth, workspaceId }) => {
            ...
            try {
                const pipelines = await clickfunnelsApiService.fetchPipelines(auth.props, workspaceId as string)
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load pipelines. Please check your authentication.',
                }
            }
        },
    })
        ...
        options: async ({ auth, pipelineId }) => {
            ...
            try {
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load pipeline stages. Please check your authentication.',
                }
            }
        },
    })
...
export const contactsDropdown = (refreshers: string[]) =>
    Property.Dropdown({
        ...
        options: async ({ auth, workspaceId }) => {
            ...
            try {
                const contacts = await clickfunnelsApiService.fetchContacts(auth.props, workspaceId as string)
                ...
                return {
                    options: contacts.map((contact: any) => ({
                        label: (() => {
                            ...
                            return fullName || contact.email_address || contact.phone_number || 'Unknown Contact'
                        })(),
                        value: contact.id,
                    })),
                }
                ...
                return {
                    disabled: true,
                    options: [],
                    placeholder: 'Failed to load contacts. Please check your authentication.',
                }
            }
        },
    })
...
export const appliedTagsDropdown = (refreshers: string[]) =>
    Property.Dropdown({
        ...
        options: async ({ auth, contactId }) => {
            ...
            try {
                const tags = await clickfunnelsApiService.fetchAppliedTags(auth.props, contactId as string)

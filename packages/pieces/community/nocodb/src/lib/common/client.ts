...
export class NocoDBClient {
    ...
    async listBases(workspaceId?: string, version = 3): Promise<ListAPIResponse<BaseResponse>> {
        if (workspaceId && workspaceId !== 'none') {
            // Cloud version
            const endpoint =
                version === 4 ? `/v3/meta/workspaces/${workspaceId}/bases/` : `/v1/workspaces/${workspaceId}/bases/`
    ...
    async getTable(_baseId: string, tableId: string, version = 3): Promise<GetTableResponse> {
    ...
    async getTableV3(baseId: string, tableId: string, _version = 4): Promise<GetTableV3Response> {
    ...
    async createRecord(baseId: string, tableId: string, recordInput: Record<string, unknown>, version = 3) {
        const endpoint =
            version === 4
    ...
    async getRecord(baseId: string, tableId: string, recordId: number, version = 3) {
        const endpoint =
            version === 4
    ...
    async updateRecord(baseId: string, tableId: string, recordInput: Record<string, unknown>, version = 3) {
        const endpoint =
            version === 4
                ? `/v3/data/${baseId}/${tableId}/records`
                : version === 3
    ...
    async deleteRecord(baseId: string, tableId: string, recordId: number, version = 3) {
        const endpoint =
            version === 4
                ? `/v3/data/${baseId}/${tableId}/records/`
                : version === 3
                  ? `/v2/tables/${tableId}/records/`
                  : `/v1/db/data/noco/${tableId}/${recordId}`
        const body = version === 4 ? { id: recordId } : version === 3 ? { Id: recordId } : undefined
    ...
    async listRecords(
        ...
        version = 3,
    ): Promise<ListAPIResponse<Record<string, unknown>> | ListAPIV3Response<Record<string, unknown>>> {
        const endpoint =
            version === 4
                ? `/v3/data/${baseId}/${tableId}/records`
                : version === 3

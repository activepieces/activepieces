...
import { PDFDocument, PDFImage, PageSizes, RotationTypes } from 'pdf-lib'
      ...
      for (let i = 0; i < tags; i++) {
        if (view.getUint16(offset + i * 12, little) == 0x0112) {
          ...
          switch (orientation) {
            ...
            case 5:
              return ImageOrientation.FlipHorizontalRotate90
            case 7:
              return ImageOrientation.FlipVerticalRotate90
            default:
              return ImageOrientation.Unknown
          }
        }

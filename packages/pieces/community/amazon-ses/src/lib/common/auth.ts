...
import { createSES } from './client';

export const amazonSESAuth = PieceAuth.CustomAuth({
  description: `
This piece allows you to send emails using Amazon SES v2.

Amazon SES Settings:
- Regions: https://docs.aws.amazon.com/general/latest/gr/ses.html
- Endpoint: leave blank for AWS, or specify custom endpoint for SES-compatible services
- Make sure your email addresses are verified in SES before sending
`,
  props: {

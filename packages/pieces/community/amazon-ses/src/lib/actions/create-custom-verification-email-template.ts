...
import { CreateCustomVerificationEmailTemplateCommand, SESClient } from '@aws-sdk/client-ses'
...
export const createCustomVerificationEmailTemplate = createAction({
    ...
    props: {
        templateName: Property.ShortText({
            ...
            description: 'Unique template name (letters, numbers, underscores, hyphens only)',
            required: true,
        }),

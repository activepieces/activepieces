...
import { publicIdsDropdown, resourceTypeDropdown } from '../common/props'
...
export const transformResource = createAction({
    ...
    props: {
        ...
        raw_transformation: Property.LongText({
            ...
            description:
                'Advanced: Raw transformation string (e.g., "c_fill,w_300,h_200/e_sepia/r_20"). This will be applied after the above basic transformations.',
            required: false,
        }),
        ...
        generate_url_only: Property.Checkbox({
            ...
            description:
                'If true, only return the transformation URL. If false, also make a request to generate the transformed asset.',
            required: false,
            defaultValue: true,
        }),
    },

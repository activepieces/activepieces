...
export const createUsageReport = createAction({
    ...
    description:
        'Generate a comprehensive report of account usage and quotas including storage, bandwidth, transformations, requests, and add-on usage.',
    props: {
        ...
        include_breakdown: Property.Checkbox({
            ...
            description:
                'Whether to include detailed breakdown of transformation types and add-on usage in the response.',
            required: false,
            defaultValue: true,
        }),
    },
            ...
            const simplified = {
                ...
                summary: {
                    ...
                    bandwidth: {
                        ...
                        usage_gb: response.bandwidth?.usage
                            ? Math.round((response.bandwidth.usage / (1024 * 1024 * 1024)) * 100) / 100
                            : null,
                    },
                    storage: {
                        ...
                        usage_gb: response.storage?.usage
                            ? Math.round((response.storage.usage / (1024 * 1024 * 1024)) * 100) / 100
                            : null,
                    },

...
import { publicIdsDropdown, resourceTypeDropdown, tagsDropdown } from '../common/props'
...
export const deleteResource = createAction({
    ...
    props: {
        ...
        public_ids_manual: Property.LongText({
            ...
            description:
                'Or type comma-separated public IDs manually (up to 100). Example: image1,image2,folder/image3',
            required: false,
        }),

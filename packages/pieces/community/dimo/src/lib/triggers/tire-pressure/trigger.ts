...
import { DimoClient, getNumberExpression, getTirePressurePositionLabel } from '../../common/helpers'
...
export const tirePressureTrigger = createTrigger({
    ...
    async onEnable(context) {
        ...
        const { vehicleTokenIds, tirePosition, operator, pressureKpa, coolDownPeriod, verificationToken } =
            context.propsValue

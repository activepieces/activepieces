...
const getVehicleByDevLicenseAction = createAction({
    ...
    async run(context) {
        const query = IdentityQueries.getVehicleByDevLicense.replace(/<devLicense0x>/g, context.propsValue.devLicense0x)
        return await sendIdentityGraphQLRequest(query, {})
    },
})
...
const getVehicleMMYByOwnerAction = createAction({
    ...
    async run(context) {
        const query = IdentityQueries.getVehicleMMYByOwner.replace(/<ownerAddress>/g, context.propsValue.ownerAddress)
        return await sendIdentityGraphQLRequest(query, {})
    },
})
...
const getRewardsByOwnerAction = createAction({
    ...
    async run(context) {
        const query = IdentityQueries.getRewardsByOwner.replace(/<ownerAddress>/g, context.propsValue.ownerAddress)
        return await sendIdentityGraphQLRequest(query, {})
    },
})
...
const getOwnerVehiclesAction = createAction({
    ...
    async run(context) {
        const query = IdentityQueries.getOwnerVehicles.replace(/<ownerAddress>/g, context.propsValue.ownerAddress)
        return await sendIdentityGraphQLRequest(query, {})
    },
})
...
const getDCNsByOwnerAction = createAction({
    ...
    async run(context) {
        const query = IdentityQueries.getDCNsByOwner.replace(/<ownerAddress>/g, context.propsValue.ownerAddress)
        return await sendIdentityGraphQLRequest(query, {})
    },
})

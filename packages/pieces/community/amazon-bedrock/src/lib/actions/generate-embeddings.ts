...
import { createBedrockRuntimeClient, formatBedrockError, getBedrockModelOptions } from '../common'
...
export const generateEmbeddings = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        try {
            ...
            } else if (responseBody.embeddings && responseBody.embeddings.length > 0) {

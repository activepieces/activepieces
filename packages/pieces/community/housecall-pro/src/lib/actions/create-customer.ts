...
export const createCustomer = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        if (propsValue['notifications_enabled'] !== undefined)
            customerData['notifications_enabled'] = propsValue['notifications_enabled']
        ...
        const response = await makeHousecallProRequest(auth, '/customers', HttpMethod.POST, customerData)

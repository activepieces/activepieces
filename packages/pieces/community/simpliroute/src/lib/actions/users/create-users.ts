...
export const create_users = createAction({
    ...
    props: {
        ...
        is_driver: Property.Checkbox({
            displayName: 'is_driver',
            description: 'Whether the user is a driver.',
            required: true,
            defaultValue: false,
        }),
        is_router_jr: Property.Checkbox({
            displayName: 'is_router_jr',
            description: 'Whether the user is a router junior.',
            required: false,
            defaultValue: false,
        }),
        is_router: Property.Checkbox({
            displayName: 'is_router',
            description: 'Whether the user is a router.',
            required: false,
            defaultValue: false,
        }),
        is_monitor: Property.Checkbox({
            displayName: 'is_monitor',
            description: 'Whether the user is a monitor.',
            required: false,
            defaultValue: false,
        }),
        is_coordinator: Property.Checkbox({
            displayName: 'is_coordinator',
            description: 'Whether the user is a coordinator.',
            required: false,
            defaultValue: false,
        }),
    },

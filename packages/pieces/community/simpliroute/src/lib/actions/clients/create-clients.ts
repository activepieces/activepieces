        ...
        clients: Property.Array({
            ...
            properties: {
                key: Property.ShortText({
                    displayName: 'key',
                    description: 'External identifier or unique key for the client.',
                    required: false,
                }),
                ...
                load: Property.Number({
                    displayName: 'load',
                    description: 'Load associated (unit 1).',
                    required: false,
                }),
                load_2: Property.Number({
                    displayName: 'load_2',
                    description: 'Load associated (unit 2).',
                    required: false,
                }),
                load_3: Property.Number({
                    displayName: 'load_3',
                    description: 'Load associated (unit 3).',
                    required: false,
                }),
                window_start: Property.ShortText({
                    displayName: 'window_start',
                    description: 'Preferred time window start (HH:MM:SS).',
                    required: false,
                }),
                window_end: Property.ShortText({
                    displayName: 'window_end',
                    description: 'Preferred time window end.',
                    required: false,
                }),
                ...
                duration: Property.ShortText({
                    ...
                    description: 'Estimated visit duration (HH:MM:SS).',
                    required: false,
                }),

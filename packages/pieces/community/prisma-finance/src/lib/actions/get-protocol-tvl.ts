...
import { getProtocolData, formatUSD, formatChange } from '../prisma-finance-api';

export const getProtocolTvlAction = createAction({
  name: 'get_protocol_tvl',
  displayName: 'Get Protocol TVL',
  description:
    'Fetches the current Total Value Locked (TVL) for Prisma Finance from DeFiLlama, including 1h, 1d, and 7d changes.',
  props: {},
  async run() {

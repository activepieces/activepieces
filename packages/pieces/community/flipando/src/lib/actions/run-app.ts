...
export const runApp = createAction({
    ...
    props: {
        ...
        inputs_data: Property.LongText({
            ...
            description: 'JSON string of key-value pairs for application input variables.',
            required: false,
        }),
        file: Property.File({
            displayName: 'File',
        ...
        file_description: Property.ShortText({
            ...
            description: 'Description of the file being uploaded. Required when uploading a file.',
            required: false,
        }),
    },
    async run(context) {
        ...
        if (file && !fileDescription) {
            throw new Error('file_description is required when uploading a file.')
        }

...
import { CouchbaseAuthValue, closeCluster, createCouchbaseClient } from './lib/common'
...
export const couchbaseAuth = PieceAuth.CustomAuth({
    ...
    props: {
        connectionString: Property.ShortText({
            ...
            description:
                'Couchbase connection string (e.g., couchbase://localhost or couchbases://cloud.couchbase.com)',
            required: true,
        }),

...
import { Broadcast, CustomField, Form, Purchase, Sequence, Subscriber, Tag, Webhook } from './types'
...
export const fetchBroadcasts = async (auth: string, page: number) => {
  ...
  const response = await httpClient.sendRequest<{ broadcasts: Broadcast[] }>(request)
...
export const fetchCustomFields = async (auth: string): Promise<CustomField[]> => {
...
export const fetchPurchases = async (auth: string, page: number) => {
  ...
  const response = await httpClient.sendRequest<{ purchases: Purchase[] }>(request)
...
export const fetchSequences = async (auth: string) => {
  ...
  const response = await httpClient.sendRequest<{ courses: Sequence[] }>(request)
...
export const fetchSubscriperById = async (auth: string, subscriberId: string) => {
...
export const fetchSubscriberByEmail = async (auth: string, email_address: string) => {
  ...
  const response = await httpClient.sendRequest<{ subscribers: Subscriber[] }>(request)
...
export const fetchSubscribedTags = async (auth: string, subscriberId: string) => {

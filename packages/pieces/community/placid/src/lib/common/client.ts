...
import { PLACID_BASE_URL, PlacidTemplate, PlacidImage, PlacidCreateImageRequest, PlacidCreatePdfRequest, PlacidCreateVideoRequest } from './index';

export class PlacidClient {
  constructor(private apiKey: string) {}

  async getTemplates(): Promise<PlacidTemplate[]> {
    const response = await httpClient.sendRequest<{ data: PlacidTemplate[] }>({

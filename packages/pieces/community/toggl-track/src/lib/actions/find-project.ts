...
export const findProject = createAction({
    ...
    async run(context) {
        const { workspace_id, name, active, billable, only_me, only_templates, page, per_page } = context.propsValue
        ...
        if (only_templates !== undefined) queryParams['only_templates'] = only_templates.toString()

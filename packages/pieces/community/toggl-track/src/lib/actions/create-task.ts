...
export const createTask = createAction({
    ...
    props: {
        ...
        external_reference: Property.ShortText({
            ...
            description: 'External reference to link this task with external systems.',
            required: false,
        }),
    ...
    async run(context) {
        const { workspace_id, project_id, name, estimated_seconds, external_reference, active, user_id } =
            context.propsValue

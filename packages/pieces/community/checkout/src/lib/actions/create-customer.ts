...
export const createCustomerAction = createAction({
    ...
    props: {
        ...
        phone_country_code: Property.ShortText({
            ...
            description:
                'The international country calling code (e.g., +1, +44). Required if phone number is provided.',
            required: false,
        }),
        ...
        metadata: Property.Object({
            ...
            description:
                'Additional information about the customer. Maximum 10 key-value pairs, each up to 100 characters.',
            required: false,
        }),
    ...
    async run(context) {
        ...
        if (phone_country_code || phone_number) {
            if (!phone_country_code || !phone_number) {
                throw new Error(
                    'Both phone country code and phone number are required when providing phone information',
                )
            }

                    ...
                    if (!gatewaySource || !gatewaySource.events) {
                        return {
                            ...
                            options: [
                                ...
                                {
                                    label: 'Payment Authorization Incremented',
                                    value: 'payment_authorization_incremented',
                                },
                                {
                                    label: 'Payment Authorization Increment Declined',
                                    value: 'payment_authorization_increment_declined',
                                },

...
const polling: Polling<AppConnectionValueForAuthProperty<typeof AgentXAuth>, { agentId?: string }> = {
...
export const newConversation = createTrigger({
    ...
    description:
        'Triggers when a new conversation begins with a specific Agent. Only detects conversations created after the trigger is enabled.',

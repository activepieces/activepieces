...
import { AppConnectionValueForAuthProperty, createPiece, PieceAuth, Property } from '@activepieces/pieces-framework'
...
export const dust = createPiece({
    ...
    actions: [
        ...
        createCustomApiCallAction({
            baseUrl: (auth) => (auth ? `${DUST_BASE_URL[auth.props.region ?? 'us']}/${auth.props.workspaceId}` : ''),
            auth: dustAuth,

...
import { CloudConvertClient, cloudconvertAuth, downloadFileSchema } from '../common'
                    ...
                    try {
                        ...
                        while (attempts < maxAttempts) {
                            ...
                            if (exportTaskData.status === 'finished') {
                                ...
                                throw new Error(
                                    `Export task failed: ${exportTaskData.message || 'Unknown error'}. Code: ${exportTaskData.code || 'N/A'}`,
                                )
                            }

...
export const sendContentToUser = createAction({
  name: 'sendContentToUser',
  displayName: 'Send Content to User',
  description: 'Send a follow-up message or coupon after an interaction.',
  props: {
    ...
    media_url: Property.ShortText({
      ...
      description: 'URL of the media to send (image, video, audio, or file). Required for media content types.',
      required: false,
    }),

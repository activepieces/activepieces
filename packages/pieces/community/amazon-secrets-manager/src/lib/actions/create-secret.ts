...
import { CreateSecretCommand, SecretsManagerClient, type Tag } from '@aws-sdk/client-secrets-manager'
...
export const createSecret = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        try {
            ...
            throw new Error(`Failed to create secret: ${error.message ?? 'Unknown error'}`)
        }
    },
})

...
export const importInvoice = createAction({
    ...
    props: {
        ...
        invoiceDate: Property.ShortText({
            ...
            description: 'Date the invoice was issued (format: dd/MM/yy, M/dd/yy, or yyyy-MM-dd)',
            required: true,
        }),
        dueDate: Property.ShortText({
            displayName: 'Due Date',
            description: 'Date the invoice is due (format: dd/MM/yy, M/dd/yy, or yyyy-MM-dd)',
            required: false,
        }),
        paidDate: Property.ShortText({
            displayName: 'Paid Date',
            description: "Date the invoice was paid (format: yyyy-MM-dd HH:mm:ss or yyyy-MM-dd'T'HH:mm:ss)",
            required: false,
        }),
        createdDate: Property.ShortText({
            displayName: 'Created Date',
            description: 'Date the invoice was created (format: dd/MM/yy, M/dd/yy, or yyyy-MM-dd)',
            required: false,
        }),
        updatedDate: Property.ShortText({
            displayName: 'Updated Date',
            description: 'Date the invoice was last updated (format: dd/MM/yy, M/dd/yy, or yyyy-MM-dd)',
            required: false,
        }),
    ...
    async run(context) {
        ...
        if (context.propsValue.totalTaxAmount !== undefined && context.propsValue.totalTaxAmount !== null) {
            body['totalTaxAmount'] = context.propsValue.totalTaxAmount
        }
        if (context.propsValue.openAmount !== undefined && context.propsValue.openAmount !== null) {
        ...
        const response = await makeRequest(context.auth.secret_text, HttpMethod.POST, '/open-api/invoices', body)

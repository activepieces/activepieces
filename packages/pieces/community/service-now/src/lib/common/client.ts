...
export class ServiceNowClient {
    ...
    async getAttachment(attachment_sys_id: string, accept_type = '*/*'): Promise<{ data: Buffer; metadata?: string }> {
    ...
    async subscribeWebhook(
        ...
        throw new NotSupported(
            'Webhook subscriptions require manual configuration in ServiceNow Business Rules or IntegrationHub',
        )
    }

    async unsubscribeWebhook(_subscriptionId: string): Promise<void | NotSupported> {
        throw new NotSupported(
            'Webhook unsubscription requires manual configuration in ServiceNow Business Rules or IntegrationHub',
        )
    }

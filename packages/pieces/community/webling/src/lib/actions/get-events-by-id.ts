...
export const eventsById = createAction({
  ...
  description: 'Gets event data by a list of event IDs and optional calendar ID to filter.',
  props: {
  ...
  async run(configValue) {
    const { eventIds: eventIds, calendarId: calendarId } = configValue.propsValue

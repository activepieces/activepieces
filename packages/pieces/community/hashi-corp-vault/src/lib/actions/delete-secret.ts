...
import { buildSecretUrl, buildVaultHeaders, getVaultToken } from '../common'
...
export const deleteSecret = createAction({
    ...
    async run(context) {
        ...
        const url = buildSecretUrl(vaultAuth.baseUrl, secretEngine, secretPath, vaultAuth.apiVersion, 'delete')

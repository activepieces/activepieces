...
export const subscriptionId = (isRequired = false) =>
    Property.Dropdown({
        auth: beehiivAuth,
...
export const automationId = (displayName: string, desc: string, isRequired = false, isSingleSelect = true) => {
    const fieldType = isSingleSelect
        ? Property.Dropdown<string, boolean, typeof beehiivAuth>
        : Property.MultiSelectDropdown<string, boolean, typeof beehiivAuth>
    return fieldType({
        auth: beehiivAuth,
        displayName,
        description: desc,

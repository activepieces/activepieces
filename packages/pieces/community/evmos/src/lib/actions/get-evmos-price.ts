...
export const getEvmosPrice = createAction({
  name: 'get_evmos_price',
  displayName: 'Get EVMOS Token Price',
  description: 'Fetches the current EVMOS token price and market data from CoinGecko.',
  props: {},
  async run() {

...
export const newFormTrigger = createTrigger({
  ...
  description: 'Triggers when a new form is created in your Wufoo account. Perfect for automating form setup workflows, team notifications, and integration processes.',

...
export const createTimeOffRequest = createAction({
    ...
    async run(ctx) {
        const { workerId, timeOffTypeId, startDate, endDate, comment } = ctx.propsValue
    ...
    <bsvc:Enter_Time_Off_Request bsvc:version="v46.0" xmlns:bsvc="urn:com.workday/bsvc">
      ...
      <bsvc:Enter_Time_Off_Data>
        ...
        return workdaySoapRequest(ctx.auth as OAuth2PropertyValue, 'Absence_Management', operationXml)
    },
})

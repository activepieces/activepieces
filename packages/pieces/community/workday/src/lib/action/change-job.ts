...
export const changeJob = createAction({
    ...
    async run(ctx) {
        const { workerId, effectiveDate, reasonId, jobProfileId, supervisoryOrganizationId, positionId } =
            ctx.propsValue
    ...
    <bsvc:Change_Job_Request bsvc:version="v46.0" xmlns:bsvc="urn:com.workday/bsvc">
      ...
      <bsvc:Change_Job_Data>
        ...
        return workdaySoapRequest(ctx.auth as OAuth2PropertyValue, 'Staffing', operationXml)
    },
})

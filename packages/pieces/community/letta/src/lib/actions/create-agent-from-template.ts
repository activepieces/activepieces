...
import type { AgentCreateParams, AgentCreateResponse } from '../common/types'
...
export const createAgentFromTemplate = createAction({
    ...
    async run(context) {
        ...
        const response: AgentCreateResponse = await client.templates.agents.create(templateVersion, body)

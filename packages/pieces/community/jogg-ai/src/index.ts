...
export const joggAi = createPiece({
  ...
  authors: [],
  actions: [createAiAvatarPhoto, createAvatarVideo, createProductFromUrl, createProductFromProductInfo, updateProductInfo, getGeneratedVideo, uploadMedia, createVideoFromTemplate],

    ...
    import { createProductManually } from "./lib/actions/create-product-manually";
    ...
    export const joggAi = createPiece({
      ...
      authors: [],
      actions: [createAiAvatarPhoto, createAvatarVideo, createProductFromUrl, createProductManually, updateProductInfo, getGeneratedVideo, uploadMedia, createVideoFromTemplate],

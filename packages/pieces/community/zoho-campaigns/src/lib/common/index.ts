...
export const zohoCampaignsCommon = {
    ...
    createCampaign: async ({
        ...
        const { list_details: listDetails, topicId, ...restParams } = campaignParams
    ...
    cloneCampaign: async ({
        ...
        location = 'zoho.com',
        campaigninfo,
    }: CloneCampaignParams & { location?: string }) => {
    ...
    sendCampaign: async ({
        ...
        location = 'zoho.com',
        campaignkey,
    }: SendCampaignParams & { location?: string }) => {
        const response = await httpClient.sendRequest({
            method: HttpMethod.POST,
    ...
    addUpdateContact: async ({
        ...
        const { listkey, contactinfo: contactInfoObj, source, topic_id } = contactParams
        const body = new URLSearchParams({
            ...zohoCampaignsCommon.baseParams,
            listkey,
            ...(source && { source }),
    ...
    removeTag: async ({
        ...
        location = 'zoho.com',
        ...tagParams
    }: RemoveTagParams & { location?: string }) => {
        const response = await httpClient.sendRequest({
            method: HttpMethod.GET,
    ...
    unsubscribeContact: async ({
        ...
        const { contactinfo: contactInfoObj, listkey, topic_id } = unsubscribeParams
        const body = new URLSearchParams({
            ...zohoCampaignsCommon.baseParams,
            listkey,
            ...(topic_id && { topic_id }),
    ...
    listContacts: async ({
        ...
        const strFromIndex = typeof fromindex === 'number' ? String(fromindex) : undefined

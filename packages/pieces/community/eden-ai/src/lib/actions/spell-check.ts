...
export const spellCheckAction = createAction({
    ...
    description:
        'Identify and correct spelling or grammar errors using Eden AI. Supports multiple providers, languages, and models.',
    props: {
        ...
        model: Property.ShortText({
            ...
            description:
                'Specific model to use (e.g., gpt-4o, gpt-4, grok-2-latest, command). Leave empty for default.',
            required: false,
        }),

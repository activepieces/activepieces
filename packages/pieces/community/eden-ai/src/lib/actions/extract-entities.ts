...
export const extractEntitiesAction = createAction({
    ...
    description:
        'Identify entities (names, places) in text using Eden AI. Supports multiple providers, languages, and models.',
    props: {
        ...
        model: Property.ShortText({
            ...
            description:
                'Specific model to use (e.g., gpt-4o, gemini-1.5-flash, grok-2-latest). Leave empty for default.',
            required: false,
        }),

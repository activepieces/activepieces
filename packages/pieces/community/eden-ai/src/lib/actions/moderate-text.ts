...
export const moderateTextAction = createAction({
    ...
    description:
        'Detect explicit or policy-violating text using Eden AI. Supports multiple providers, languages, and models.',
    props: {
        ...
        model: Property.ShortText({
            ...
            description:
                'Specific model to use (e.g., text-moderation-latest, text-moderation-stable). Leave empty for default.',
            required: false,
        }),
    ...
    async run({ auth, propsValue }) {
        ...
        const { provider, text, language, model, fallback_providers, show_original_response } = propsValue

...
export const moderateTextAction = createAction({
  ...
  description: 'Analyze text for inappropriate content using various content moderation providers via Eden AI.',
  props: {
    ...
    providers: Property.Array({
      ...
      description: 'One or more providers (e.g., ["openai", "google"]) or providers with model (e.g., ["openai/text-moderation-stable"])',
      required: true,
    }),

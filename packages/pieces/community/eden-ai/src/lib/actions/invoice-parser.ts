...
export const invoiceParserAction = createAction({
  ...
  description: 'Extract structured data from invoice documents using various OCR providers via Eden AI.',
  props: {
    file: Property.File({
    ...
    file_url: Property.ShortText({
      ...
      description: 'URL of the invoice file to parse (alternative to file upload).',
      required: false,
    }),

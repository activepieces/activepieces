...
export const translateTextAction = createAction({
    ...
    description:
        'Translate text into different languages using Eden AI. Supports multiple providers, languages, and models.',
    props: {
        ...
        source_language: Property.Dropdown({
            ...
            description:
                'The language of the input text. Choose "Auto Detection" to automatically detect the language.',
            required: false,
            refreshers: [],
    ...
    async run({ auth, propsValue }) {
        ...
        const { provider, text, source_language, target_language, model, fallback_providers, show_original_response } =
            propsValue

...
export const extractNamedEntitiesAction = createAction({
  ...
  description: 'Extract named entities from text using various NLP providers via Eden AI.',
  props: {
    ...
    providers: Property.Array({
      ...
      description: 'One or more providers (e.g., ["openai", "google"]) or providers with model (e.g., ["openai/gpt-4"])',
      required: true,
    }),

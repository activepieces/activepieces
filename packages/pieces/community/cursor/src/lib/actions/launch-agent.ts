...
export const launchAgent = createAction({
    ...
    props: {
        ...
        openAsCursorGithubApp: Property.Checkbox({
            ...
            description:
                'Open the pull request as the Cursor GitHub App instead of as the user. Only applies if auto-create PR is enabled.',
            required: false,
            defaultValue: false,
        }),
        skipReviewerRequest: Property.Checkbox({
            ...
            description:
                'Skip adding the user as a reviewer to the pull request. Only applies if auto-create PR is enabled and opened as Cursor GitHub App.',
            required: false,
            defaultValue: false,
        }),
    ...
    async run(context) {
        ...
        return await makeCursorRequest(context.auth, '/v0/agents', HttpMethod.POST, body)
    },
})

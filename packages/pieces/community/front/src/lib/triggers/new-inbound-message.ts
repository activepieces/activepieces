...
const polling: Polling<AppConnectionValueForAuthProperty<typeof frontAuth>, StaticPropsValue<typeof props>> = {
    ...
    items: async ({ auth, propsValue, lastFetchEpochMS }) => {
        ...
        const limit = 15
        const response = await makeRequest(auth, HttpMethod.GET, `/events?${query}&limit=${limit}`)
            ...
            data: [
                {
                    _links: {
                        ...
                        related: {
                            channels: 'https://api.example.com/inboxes/inb_dummy3333/channels',
                            conversations: 'https://api.example.com/inboxes/inb_dummy3333/conversations',
                            teammates: 'https://api.example.com/inboxes/inb_dummy3333/teammates',

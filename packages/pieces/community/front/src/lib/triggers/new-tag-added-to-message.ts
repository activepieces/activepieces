...
const polling: Polling<AppConnectionValueForAuthProperty<typeof frontAuth>, StaticPropsValue<typeof props>> = {
    ...
    items: async ({ auth, propsValue, lastFetchEpochMS }) => {
        ...
        const response = await makeRequest(auth, HttpMethod.GET, `/events?${query}`)
        const events = response._results || []
        const tagEvents: any[] = []

        for (const event of events) {
            if (event.conversation && event.conversation.id === propsValue.conversation_id && event.type === 'tag') {
        ...
        conversation: {
            _links: {
                ...
                related: {
                    ...
                    followers: 'https://api.example.com/conversations/cnv_dummy5678/followers',
                    messages: 'https://api.example.com/conversations/cnv_dummy5678/messages',
                    comments: 'https://api.example.com/conversations/cnv_dummy5678/comments',
                    inboxes: 'https://api.example.com/conversations/cnv_dummy5678/inboxes',
                    last_message: 'https://api.example.com/messages/msg_dummy9012?referer=conversation',
                },
            },
            id: 'cnv_dummy5678',
            subject: 'Re: test',
            ...
            assignee: {
                _links: {
                    ...
                    related: {
                        ...
                        conversations: 'https://api.example.com/teammates/tea_dummy1/conversations',
                    },
                },
                id: 'tea_dummy1',
            ...
            tags: [
                {
                    _links: {
                        ...
                        related: {
                            conversations: 'https://api.example.com/tags/tag_dummy1/conversations',
                ...
                },
                {
                    _links: {
                        ...
                        related: {
                            conversations: 'https://api.example.com/tags/tag_dummy2/conversations',
                ...
                },
                {
                    _links: {
                        ...
                        related: {
                            conversations: 'https://api.example.com/tags/tag_dummy3/conversations',
                            owner: 'https://api.example.com/teams/team_dummy1',
                            parent_tag: null,
                            children: null,
                        },

...
const props = {
    ...
    desired_state: Property.StaticDropdown({
        ...
        description: 'The state to trigger on (e.g., open, archived, deleted, assigned, etc.).',
        required: true,
        options: {
            options: [
...
const polling: Polling<AppConnectionValueForAuthProperty<typeof frontAuth>, StaticPropsValue<typeof props>> = {
    ...
    items: async ({ auth, propsValue, lastFetchEpochMS }) => {
        ...
        const conv = await makeRequest(auth, HttpMethod.GET, `/conversations/${conversation_id}`)
        const stateChangedAt = conv.updated_at ? Math.floor(Number(conv.updated_at) * 1000) : null
...
export const newConversationStateChange = createTrigger({
    ...
    sampleData: {
        _links: {
            ...
            related: {
                events: 'https://example.api.frontapp.com/conversations/cnv_1jm05qco/events',
                followers: 'https://example.api.frontapp.com/conversations/cnv_1jm05qco/followers',
                messages: 'https://example.api.frontapp.com/conversations/cnv_1jm05qco/messages',
                comments: 'https://example.api.frontapp.com/conversations/cnv_1jm05qco/comments',
                inboxes: 'https://example.api.frontapp.com/conversations/cnv_1jm05qco/inboxes',
                last_message: 'https://example.api.frontapp.com/messages/msg_326rt3vs?referer=conversation',
            },
        },
        id: 'cnv_1jm05qco',
        subject: 'Re: test',
        ...
        assignee: {
            _links: {
                ...
                related: {
                    inboxes: 'https://example.api.frontapp.com/teammates/tea_mfoko/inboxes',
                    conversations: 'https://example.api.frontapp.com/teammates/tea_mfoko/conversations',
                },
            },
            id: 'tea_mfoko',
        ...
        tags: [
            {
                _links: {
                    ...
                    related: {
                        conversations: 'https://example.api.frontapp.com/tags/tag_6958vc/conversations',
            ...
            },
            {
                _links: {
                    ...
                    related: {
                        conversations: 'https://example.api.frontapp.com/tags/tag_695n8o/conversations',
            ...
            },
            {
                _links: {
                    ...
                    related: {
                        conversations: 'https://example.api.frontapp.com/tags/tag_695n6w/conversations',
                        owner: 'https://example.api.frontapp.com/teams/tim_8t9ew',
                        parent_tag: null,
                        children: null,
                    },

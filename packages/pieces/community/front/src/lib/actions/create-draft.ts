...
export const createDraft = createAction({
    ...
    description: "Create a draft message in Front (with to, cc, subject, body etc.).",
    props: {
        ...
        signatureId: Property.ShortText({
            ...
            description: "ID of the signature to attach to this draft.",
            required: false,
        }),
    ...
    async run({ auth, propsValue }) {
        return makeRequest(
            ...
            `/channels/${propsValue.channelId}/drafts`,
            {

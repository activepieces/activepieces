...
export const conversationIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/conversations')
...
export const contactIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/contacts?limit=50')
...
export const tagIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/tags?limit=50')
...
export const teammateIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/teammates?limit=50')
...
export const channelIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/channels')
...
export const accountIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/accounts')
...
export const inboxIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/inboxes')
...
export const linkIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth, HttpMethod.GET, '/links')

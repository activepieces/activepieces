...
export const googleTrendsSearch = createAction({
    ...
    description:
        'Discover trending keywords over time to inform content strategy and market research with geographic insights.',

    props: {
        query: Property.ShortText({
            displayName: 'Search Query',
            description:
                'The keyword or topic to analyze trends for (e.g., "artificial intelligence", "cryptocurrency", "climate change")',
            required: true,
        }),
        ...
        async: Property.StaticDropdown({
            displayName: 'Async',
            description:
                'Defines the way you want to submit your search to SerpApi. It can be set to false (default) to open an HTTP connection and keep it open until you got your search results, or true to just submit your search to SerpApi and retrieve them later.',
            required: false,
            defaultValue: 'false',
            options: {
                options: [

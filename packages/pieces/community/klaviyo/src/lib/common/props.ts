...
import { KlaviyoAuthValue, klaviyoAuth } from './auth'
...
export const profileIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        const profiles = await makeRequest(auth as KlaviyoAuthValue, HttpMethod.GET, '/profiles', {})
...
export const profileIdsMultiSelectDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth, list_id }) => {
        ...
        const profiles = await makeRequest(auth as KlaviyoAuthValue, HttpMethod.GET, `/lists/${list_id}/profiles`)
...
export const listIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        const list = await makeRequest(auth as KlaviyoAuthValue, HttpMethod.GET, '/lists', {})

...
export const findSimilarCreator = createAction({
    ...
    async run(context) {
        ...
        if (context.propsValue.is_verified !== undefined && context.propsValue.is_verified !== null) {
        ...
        if (
            ...
            filters.exclude_private_profile = context.propsValue.exclude_private_profile
        }

...
const BAREMETRICS_SCOPES = ['read', 'write'] as const

export const baremetricsAuth = [
    PieceAuth.OAuth2({
        description:
            'Connect your Baremetrics account using OAuth2. Requires approval from Baremetrics support to get Client ID and Client Secret.',
...
export type BaremetricsAuthValue = AppConnectionValueForAuthProperty<typeof baremetricsAuth>

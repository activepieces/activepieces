...
export const createSubscriptionAction = createAction({
    ...
    props: {
        accountCode: accountCodeDropdown(true, 'Select the account that should own the subscription.'),
        planCode: planCodeDropdown(true, 'Select the plan for the new subscription.'),

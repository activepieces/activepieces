...
export const listBookmarks = createAction({
  ...
  description: 'List the statuses you have bookmarked.',
  audience: 'ai',
  aiMetadata: {
    description:
      'Returns one page of statuses bookmarked by the connected account, newest bookmark first, with Link-header cursors for further pages. Read-only and safe to retry.',
    idempotent: true,
  },

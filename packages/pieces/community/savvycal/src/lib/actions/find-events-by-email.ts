...
import { flattenEvent, SavvyCalEvent, savvyCalPaginatedCall } from '../common'
...
export const findEventsByEmailAction = createAction({
    ...
    props: {
        ...
        start_after: Property.DateTime({
            ...
            description:
                'Only search events starting after this date. Use this to limit the search scope and improve performance.',
            required: false,
        }),

...
import { getApiUrl, getAuthHeaders } from '../common/auth'
...
export const fountainListApplicants = createAction({
    ...
    async run(context) {
        ...
        if (context.propsValue['exclude_temporary'] !== undefined)
            queryParams['exclude_temporary'] = context.propsValue['exclude_temporary']
        ...
        if (context.propsValue['include_subaccounts'] !== undefined)
            queryParams['include_subaccounts'] = context.propsValue['include_subaccounts']

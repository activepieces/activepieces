...
export const fountainListOpenings = createAction({
    ...
    async run(context) {
        ...
        if (context.propsValue['is_hiring_funnel'] !== undefined)
            queryParams['is_hiring_funnel'] = context.propsValue['is_hiring_funnel']
        if (context.propsValue['is_sourcing_funnel'] !== undefined)
            queryParams['is_sourcing_funnel'] = context.propsValue['is_sourcing_funnel']

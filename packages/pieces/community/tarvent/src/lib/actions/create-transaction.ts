...
export const createTransaction = createAction({
    ...
    props: {
        groupName: tarventCommon.txGroupName(
            false,
            'Choose an existing group name or use "Custom" to enter a new group name. This name is used for reporting.',
        ),
        ...
        variables: Property.Object({
            ...
            description:
                'NOTE: Variable names (first column) can have Letters, numbers, underscores, and hyphens. Any other characters in the first column only will be removed.',
            required: false,
            defaultValue: '',
        }),
        ...
        content: Property.LongText({
            displayName: 'Content',
            description:
                'To merge in variables, you must use the syntax [[Tx.VariableData.VariableName]] (ex. Variable name is FirstName, merge syntax would be [[Tx.VariableData.FirstName]]) If "Template" is specified, this will be ignored.',
            required: false,
        }),
    ...
    async run(context) {
        ...
        await propsValidation.validateZod(context.propsValue, {
            ...
            replyToName: z
                .string()
                .max(255, 'Reply to name has to be equal to or less than 255 characters.')
                .optional(),
        })

...
export const createContact = createAction({
    ...
    props: {
        ...
        email: Property.ShortText({
            displayName: 'Email',
            description:
                'Enter the contacts email. NOTE: If the audience uses a custom contact identifier and overwrite is enabled, then this will update the FIRST contact that matches the email.',
            required: true,
            defaultValue: '',
        }),
        ...
        groupAction: Property.StaticDropdown({
            ...
            description:
                'Select whether to replace or only add to contact groups. NOTE: Add only will only add the contact to the groups they are not already in. Replace will remove the contact from all existing groups and add them to the selected groups.',
            required: false,
            options: {
                options: [
                    {
        ...
        tagAction: Property.StaticDropdown({
            ...
            description:
                'Select whether to replace or only add to contact tags of an existing contact. NOTE: Add only will only add the tags the contact does not already have. Replace will replace all contact tags with the entered tags.',
            required: false,
            options: {
                options: [
                    {
    ...
    async run(context) {
        ...
        await propsValidation.validateZod(context.propsValue, {
            ...
            streetAddress: z
                .string()
                .max(100, 'Street address has to be equal to or less than 100 characters.')
                .optional(),
            streetAddress2: z
                .string()
                .max(100, 'Street address 2 has to be equal to or less than 100 characters.')
                .optional(),
            addressLocality: z
                .string()
                .max(100, 'City (Locality) has to be equal to or less than 100 characters.')
                .optional(),
            addressRegion: z
                .string()
                .max(100, 'State (Region) has to be equal to or less than 100 characters.')
                .optional(),
            postalCode: z
                .string()
                .max(15, 'Zip code (Postal code) has to be equal to or less than 15 characters.')
                .optional(),

...
export const httpRequestWithOauth2 = createAction({
  auth: auth,
  name: 'http_request_with_oauth2_authorization_code',
  displayName: 'HTTP request with OAuth2 authorization code',
  description: 'Send HTTP request using OAuth2 authorization code',
  props: {

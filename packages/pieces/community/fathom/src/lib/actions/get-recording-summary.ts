...
export const getRecordingSummary = createAction({
    ...
    description:
        'Get the AI-generated summary of a meeting recording. Note: This action requires API Key authentication and is not available when using OAuth2.',
    auth: fathomAuth,
    props: {
        ...
        destination_url: Property.ShortText({
            ...
            description:
                'Optional: URL where Fathom will POST the summary. Leave empty to get data directly in response.',
            required: false,
        }),
    },

...
export const createContact = createAction({
    ...
    async run(context) {
        ...
        if (dialler_source_id !== undefined) body.dialler_source_id = dialler_source_id
        ...
        if (speed_dial_phone !== undefined) body.speed_dial_phone = speed_dial_phone
        if (speed_dial_phone_1 !== undefined) body.speed_dial_phone_1 = speed_dial_phone_1
        if (speed_dial_phone_2 !== undefined) body.speed_dial_phone_2 = speed_dial_phone_2
        ...
        if (speed_dial_mobile !== undefined) body.speed_dial_mobile = speed_dial_mobile
        if (speed_dial_mobile_1 !== undefined) body.speed_dial_mobile_1 = speed_dial_mobile_1
        if (speed_dial_mobile_2 !== undefined) body.speed_dial_mobile_2 = speed_dial_mobile_2
        ...
        return await makeRequest(context.auth.secret_text, HttpMethod.POST, '/contacts', body)
    },
})

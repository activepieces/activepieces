...
export const makeAWebcall = createAction({
    ...
    description: 'Make a webcall from e164 number to other e164 number or extension',
    props: {
    ...
    async run(context) {
        ...
        return await makeRequest(context.auth.secret_text, HttpMethod.POST, '/webcalls', body)
    },
})

...
const polling: Polling<AppConnectionValueForAuthProperty<typeof voipstudioAuth>, Record<string, never>> = {
...
export const callTracking = createTrigger({
    ...
    description: 'Triggers when call associated with Call Tracking campaign visits is finished.',
    props: {},
    sampleData: {
        id: 6743,
        billsec: 431,

...
import { campaignNameProp, listNamesProp, segmentNamesProp, templateNameProp } from '../common/props'
...
export const updateCampaignAction = createAction({
    ...
    props: {
        ...
        from: Property.ShortText({
            displayName: 'From',
            description: 'Sender email with optional name. Leave empty to keep existing.',
            required: false,
        }),
    ...
    async run({ auth, propsValue }) {
        ...
        return elasticEmailRequest({
            ...
            body: {
                ...
                Recipients: {
                    ListNames:
                        propsValue.recipientListNames && propsValue.recipientListNames.length > 0
                            ? propsValue.recipientListNames
                            : (current.Recipients?.ListNames ?? undefined),
                    SegmentNames:
                        propsValue.recipientSegmentNames && propsValue.recipientSegmentNames.length > 0
                ...
                Content: [
                    {
                        ...
                        TemplateName: propsValue.templateName || currentContent.TemplateName,
                    },
                ],

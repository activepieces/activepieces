...
export const sendMessage = createAction({
    ...
    props: {
        ...
        temperature: Property.Number({
            ...
            description: 'Controls randomness (0 = focused, 1 = creative). Default is 0.',
            required: false,
            defaultValue: 0,
        }),
    ...
    async run(context) {
        const { chatbotId, message, ai_model_id, conversation_id, contact_id, language_id, temperature, instructions } =
            context.propsValue
        ...
        const response = await makeRequest(apiKey, HttpMethod.POST, `/chatbots/${chatbotId}/ai/kb/chat`, body)

...
const polling: Polling<AppConnectionValueForAuthProperty<typeof chatlingAuth>, { chatbotId: string }> = {
    ...
    items: async ({ auth, propsValue, lastFetchEpochMS }) => {
        ...
        }>(auth.secret_text, HttpMethod.GET, `/chatbots/${propsValue.chatbotId}/conversations?sort=date_desc`)

...
export const getAlusdPrice = createAction({
  name: 'get_alusd_price',
  displayName: 'Get alUSD Price',
  description: 'Get alUSD synthetic stablecoin price and market data from CoinGecko',
  auth: undefined,
  props: {},
  async run() {
    const data = await getCoinGeckoPrice('alchemix-usd');

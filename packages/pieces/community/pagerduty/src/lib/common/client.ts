...
export const PAGERDUTY_ACCEPT_HEADER = 'application/vnd.pagerduty+json;version=2'

function buildPagerDutyUrl(path: string, query?: Record<string, string | string[] | undefined>) {

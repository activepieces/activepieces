...
export const createAudience = createAction({
    ...
    description: 'Creates a new audience (list) in Mailchimp.',
    props: {
        ...
        country: Property.StaticDropdown({
            ...
            options: {
                options: [
                    ...
                    // A comprehensive list would be too long for this example.
                    // Users can find their country in a full implementation.
                ]
            }
        }),
        ...
        permission_reminder: Property.LongText({
            ...
            description: 'A message explaining how subscribers joined the audience.',
            required: true,
        }),
        ...
        language: Property.ShortText({
            ...
            description: 'The default language for the audience\'s forms (e.g., "en", "es").',
            required: true,
            defaultValue: 'en',
        }),

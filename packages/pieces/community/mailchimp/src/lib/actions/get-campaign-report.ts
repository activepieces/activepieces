...
import { CampaignReportOptions, MailchimpClient } from '../common/types'
        ...
        try {
            ...
            return {
                ...
                summary: {
                    ...
                    bounce_rate: report.bounces
                        ? ((report.bounces.hard_bounces + report.bounces.soft_bounces) / report.emails_sent) * 100
                        : 0,

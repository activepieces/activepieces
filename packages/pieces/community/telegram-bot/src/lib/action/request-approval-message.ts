...
export const telegramRequestApprovalMessageAction = createAction({
    ...
    description: 'Send an approval message to a chat and wait until the message is approved or disapproved',
    props: {
    ...
    async run(context) {
        if (context.executionType === ExecutionType.BEGIN) {
            ...
            const { chat_id, message, parse_mode, approve_button_text, disapprove_button_text } = context.propsValue

...
import { CreateChatbotDto, chatDataAuth } from '../common/types'
...
export const createChatbot = createAction({
    ...
    props: {
        ...
        model: Property.StaticDropdown({
            displayName: 'Model',
            description:
                'Select the chatbot model. Note: sourceText and urlsToScrape are ignored for medical and custom models.',
            required: false,

...
export const updateContactAction = createAction({
    ...
    props: {
        ...
        contactFields: Property.DynamicProperties({
            ...
            props: async ({ auth, contact_id }) => {
                ...
                const contact = await capsuleCrmClient.getContact(auth, contact_id as unknown as number)
    ...
    async run(context) {
        ...
        return await capsuleCrmClient.updateContact(auth, contactId, {
            ...
            addresses: ((propsValue.addresses as DynamicPropsValue)?.['addresses'] as any[])?.map((address) => ({
                ...address,
                _delete: address.delete,
            })),
            websites: ((propsValue.websites as DynamicPropsValue)?.['websites'] as any[])?.map((website) => ({
                ...website,
                _delete: website.delete,
            })),
            emailAddresses: ((propsValue.emailAddresses as DynamicPropsValue)?.['emailAddresses'] as any[])?.map(
                (email) => ({
                    ...email,
                    _delete: email.delete,
                }),
            ),
            phoneNumbers: ((propsValue.phoneNumbers as DynamicPropsValue)?.['phoneNumbers'] as any[])?.map((phone) => ({
                ...phone,

...
export const capsuleCrmClient = {
    async createContact(auth: CapsuleCrmAuthType, params: CreatePartyParams): Promise<Party> {
    ...
    async searchContacts(auth: CapsuleCrmAuthType, searchTerm: string): Promise<Party[]> {
        ...
        const response = await httpClient.sendRequest<{ parties: Party[] }>(request)
        return response.body.parties
    },

    async searchOrganisations(auth: CapsuleCrmAuthType, searchTerm?: string): Promise<Party[]> {
        try {
            ...
            const organisations = response.body.parties.filter((party) => party.type === 'organisation')
    ...
    async updateContact(auth: CapsuleCrmAuthType, partyId: number, params: UpdatePartyParams): Promise<Party> {
        const partyData: { [key: string]: unknown } = {}
        ...
        if (params.emailAddresses) partyData['emailAddresses'] = params.emailAddresses
    ...
    async listMilestones(auth: CapsuleCrmAuthType): Promise<Milestone[]> {
        ...
        const response = await httpClient.sendRequest<{ milestones: Milestone[] }>(request)
        return response.body.milestones
    },

    async searchOpportunities(auth: CapsuleCrmAuthType): Promise<Opportunity[]> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
    ...
    async getOpportunity(auth: CapsuleCrmAuthType, opportunityId: number): Promise<Opportunity> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
        ...
        const response = await httpClient.sendRequest<{ opportunity: Opportunity }>(request)
        return response.body.opportunity
    },

    async createOpportunity(auth: CapsuleCrmAuthType, params: CreateOpportunityParams): Promise<Opportunity> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
            url: `https://api.capsulecrm.com/api/v2/opportunities`,
            authentication: {
    ...
    async listCategories(auth: CapsuleCrmAuthType): Promise<Category[]> {
        ...
        const response = await httpClient.sendRequest<{ categories: Category[] }>(request)
    ...
    async subscribeRestHook(auth: CapsuleCrmAuthType, params: CreateRestHookParams): Promise<RestHook> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
        ...
        const response = await httpClient.sendRequest<{ restHook: RestHook }>(request)
        return response.body.restHook
    },

    async unsubscribeRestHook(auth: CapsuleCrmAuthType, hookId: number): Promise<void> {
        const request: HttpRequest = {
    ...
    async findContact(auth: CapsuleCrmAuthType, term: string): Promise<Party[]> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
    ...
    async filterOpportunities(auth: CapsuleCrmAuthType, filter: Filter): Promise<Opportunity[]> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
    ...
    async filterProjects(auth: CapsuleCrmAuthType, filter: Filter): Promise<Project[]> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
    ...
    async createProject(auth: CapsuleCrmAuthType, params: CreateProjectParams): Promise<Project> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
            url: `https://api.capsulecrm.com/api/v2/kases`,
            authentication: {
    ...
    async createEntry(auth: CapsuleCrmAuthType, params: CreateEntryParams): Promise<Entry> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
    ...
    async createTask(auth: CapsuleCrmAuthType, params: CreateTaskParams): Promise<Task> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
    ...
    async createNote(auth: CapsuleCrmAuthType, params: CreateNoteParams): Promise<Note> {
        ...
        if (params.opportunityId) entryData['opportunity'] = { id: params.opportunityId }
    ...
    async getContact(auth: CapsuleCrmAuthType, contactId: number): Promise<Party | null> {
        try {
            const request: HttpRequest = {
                method: HttpMethod.GET,
    ...
    async findProject(auth: CapsuleCrmAuthType, params: FindProjectParams): Promise<Project[]> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
            url: `https://api.capsulecrm.com/api/v2/kases`,
            authentication: {
    ...
    async getProject(auth: CapsuleCrmAuthType, projectId: number): Promise<Project | null> {
        try {
            const request: HttpRequest = {
                method: HttpMethod.GET,
    ...
    async findOpportunity(auth: CapsuleCrmAuthType, params: FindOpportunityParams): Promise<Opportunity[]> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
    ...
    async subscribeWebhook(auth: CapsuleCrmAuthType, url: string, event: string): Promise<Webhook> {
        const request: HttpRequest = {
            method: HttpMethod.POST,
        ...
        const response = await httpClient.sendRequest<{ webhook: Webhook }>(request)
        return response.body.webhook
    },

    async unsubscribeWebhook(auth: CapsuleCrmAuthType, webhookId: number): Promise<void> {
        const request: HttpRequest = {
            method: HttpMethod.DELETE,

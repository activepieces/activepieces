...
export function accountUidDropdown(options?: { required?: boolean; displayName?: string; description?: string }) {
...
export function personUidDropdown(options?: { required?: boolean; displayName?: string; description?: string }) {
    return Property.Dropdown({
        auth: outsetaAuth,
...
export function dealUidDropdown(options?: { required?: boolean; displayName?: string; description?: string }) {
    return Property.Dropdown({
        auth: outsetaAuth,
...
export function planUidDropdown(options?: { required?: boolean; displayName?: string; description?: string }) {
    return Property.Dropdown({
        auth: outsetaAuth,
...
export function addOnUidDropdown(options?: { required?: boolean }) {
    return Property.Dropdown({
        auth: outsetaAuth,
        displayName: 'Add-On',
        description: 'Select the metered add-on. Manage add-ons in Outseta → Billing → Add-ons.',
        refreshers: [],
        required: options?.required ?? true,
        options: async ({ auth }) => {
            const client = makeClient(auth)

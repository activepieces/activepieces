...
import { QuickbaseApp, QuickbaseField, QuickbaseTable } from './types'
...
export const createDynamicFieldsMapperProp = () =>
...
export const createTableIdProp = () =>
    Property.Dropdown({
        auth: quickbaseAuth,
...
export const createMergeFieldProp = () =>
    Property.Dropdown({
        auth: quickbaseAuth,
...
export const createSortFieldProp = () =>
    Property.Dropdown({
        auth: quickbaseAuth,
...
export const createSortOrderProp = () =>
...
export const createRecordIdProp = () =>
    Property.Dropdown({
        auth: quickbaseAuth,
        ...
        options: async ({ auth, appId, tableId }) => {
            ...
            try {
                ...
                const fields = await client.get<QuickbaseField[]>(`/fields?tableId=${tableId}`)
                const displayField =
                    fields.find((f) => f.fieldType === 'text' && f.label.toLowerCase().includes('name')) ||

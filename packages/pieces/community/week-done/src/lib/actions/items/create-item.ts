...
import { weekdoneApiCall, weekdoneTeamsDropdown, weekdoneTypesDropdown, weekdoneUsersDropdown } from '../../common'
    ...
    props: {
        ...
        type_id: Property.Dropdown({
            ...
            options: async ({ auth, team_id }) => {
                ...
                return weekdoneTypesDropdown(auth as OAuth2PropertyValue, team_id ? Number(team_id) : undefined)
            },
        }),

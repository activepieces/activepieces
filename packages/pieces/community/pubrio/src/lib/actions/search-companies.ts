...
export const searchCompanies = createAction({
	...
	props: {
		...
		advertisement_start_date_from: Property.ShortText({ displayName: 'Advertisement Start Date From', description: 'YYYY-MM-DD', required: false }),
		advertisement_start_date_to: Property.ShortText({ displayName: 'Advertisement Start Date To', description: 'YYYY-MM-DD', required: false }),
		advertisement_end_date_from: Property.ShortText({ displayName: 'Advertisement End Date From', description: 'YYYY-MM-DD', required: false }),
		advertisement_end_date_to: Property.ShortText({ displayName: 'Advertisement End Date To', description: 'YYYY-MM-DD', required: false }),
	...
	async run(context) {
		...
		const adStartFrom = context.propsValue.advertisement_start_date_from;
		const adStartTo = context.propsValue.advertisement_start_date_to;
		if (adStartFrom || adStartTo) body.advertisement_start_dates = [adStartFrom || adStartTo, adStartTo || adStartFrom];
		const adEndFrom = context.propsValue.advertisement_end_date_from;
		const adEndTo = context.propsValue.advertisement_end_date_to;
		if (adEndFrom || adEndTo) body.advertisement_end_dates = [adEndFrom || adEndTo, adEndTo || adEndFrom];

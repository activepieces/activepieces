...
export const batchRedeemContacts = createAction({
	...
	description: 'Reveal email or phone numbers for multiple people at once (uses credits)',
	props: {
		peoples: Property.ShortText({ displayName: 'People Search IDs', required: true, description: 'Comma-separated people search IDs' }),

...
export const createPptFromSummary = createAction({
    ...
    description: 'Creates a presentation from a given summary.',
    props: {
    ...
    async run(context) {
        ...
        const response = await httpClient.sendRequest({
            ...
            url: 'https://api.magicslides.app/public/api/ppt_from_summery', // Note: API endpoint has a typo in "summery"
            headers: {

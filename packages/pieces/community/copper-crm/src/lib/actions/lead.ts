...
//       on_assignee_id: personAssigneeId,
//     // Company Details (mutually exclusive company_id / company_name)
//     //   company_id: company
//     //   company_name: Property.ShortText({
//     //     displayName: 'Company Name',
//     //     description: 'The name of an existing Company to associate, or a new Company to create. Mutually exclusive with "Company ID". Provide "" (empty string) to explicitly *not* create/associate a Company.',
//     //     required: false,
//     //   }),
...
//     //     description: 'The name for the new Opportunity record. If not provided, no Opportunity will be created.',
//     //     required: false,
//     //   }),
//     //   opportunity_pipeline_id: Property.Number({
//     //     displayName: 'Opportunity Pipeline ID',
//     //     description: 'The unique ID of the Pipeline for the new Opportunity. Required if an Opportunity Name is provided.',
//     //     required: false,
//     //   }),
//     //   opportunity_pipeline_stage_id: Property.Number({
//     //     displayName: 'Opportunity Pipeline Stage ID',
//     //     description: 'The unique ID of the Pipeline Stage for the new Opportunity. Defaults to the first stage in the pipeline if Pipeline ID is provided but this is not.',
//     //     required: false,
//     //   }),
//     //   opportunity_monetary_value: Property.Number({
//     //     displayName: 'Opportunity Monetary Value',
//     //     description: 'The expected monetary value of the new Opportunity.',
//     //     required: false,
//     //   }),
//     //   opportunity_assignee_id: Property.Number({
//     //     displayName: 'Opportunity Assignee ID',
//     //     description: 'The unique ID of the User who will be the owner of the new Opportunity.',
//     //     required: false,
//     //   }),
//     },
//     async run(context) {
...
//       // Build the 'person' object for the conversion details
...
//       // Build the 'company' object for the conversion details
//       const company: Record<string, any> = {};
//       if (company_id !== undefined && company_name !== undefined && company_name !== '') {
//           // According to sources [1], id and name are mutually exclusive.
//           // Prioritize company_id if both are provided, or throw an error.
...
//           // Only add company name if it's not undefined.
...
//       // Construct the main 'details' payload

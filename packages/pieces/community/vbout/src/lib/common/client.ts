...
export class VboutClient {
    ...
    async getContactByEmail(email: string, listId?: string) {
        ...
        >(HttpMethod.GET, '/emailmarketing/getcontactbyemail', prepareQuery({ email: email, listid: listId }))
    }
    ...
    async createEmailList(request: EmailListCreateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/emailMarketing/AddList', undefined, request)
    }
    async addContact(request: ContactCreateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/emailMarketing/AddContact', undefined, request)
    }
    async updateContact(request: ContactUpdateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/emailMarketing/EditContact', undefined, request)
    }
    async addTagToContact(request: TagCreateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/emailMarketing/AddTag', undefined, request)
    }
    ...
    async addCampaign(request: CampaignCreateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/emailMarketing/AddCampaign', undefined, request)
    }
    async listSocialMediaChannels() {
        return (
            await this.makeRequest<VboutResponseBody<{ channels: SocialMediaChannelListResponse }>>(
                HttpMethod.GET,
    ...
    async createSocialMediaPost(request: SocialMediaPostCreateRequest) {
        return await this.makeRequest(HttpMethod.POST, '/socialMedia/AddPost', undefined, request)
    }
}

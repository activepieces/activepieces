...
import {
    AlgoliaAuthValue,
    AlgoliaBatchResponse,
    AlgoliaBrowseResponse,
    AlgoliaIndex,
    AlgoliaIndexListResponse,
    AlgoliaRecord,
    AlgoliaTaskStatusResponse,
} from './types'
...
async function waitForTask({
    ...
    throw new Error(
        'The Algolia operation is taking too long. Try again or check your Algolia dashboard for the task status.',
    )
}

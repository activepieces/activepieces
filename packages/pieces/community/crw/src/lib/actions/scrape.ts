...
import { forScreenshotOutputFormat, forSimpleOutputFormat, downloadAndSaveScreenshot, forJsonOutputFormat, CRW_API_BASE_URL } from '../common/common';
...
export const scrape = createAction({
  ...
  props: {
    ...
    useActions: Property.Checkbox({
      ...
      description: 'Enable to perform a sequence of actions on the page before scraping (like clicking buttons, filling forms, etc.). See [fastCRW Actions Documentation](https://fastcrw.com/docs/rest-api) for details on available actions and their parameters.',
      required: false,
      defaultValue: false,
    }),

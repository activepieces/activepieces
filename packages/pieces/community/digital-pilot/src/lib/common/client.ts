...
class DigitalPilotClientImpl implements DigitalPilotClient {
    ...
    async addTargetAccount(tagId: string, listId: string, domain: string): Promise<void> {
    ...
    async removeTargetAccount(tagId: string, listId: string, domain: string): Promise<void> {
        const request: HttpRequest = {
    ...
    async deleteWebhook(tagId: string, webhookURL?: string, webhookID?: string): Promise<void> {

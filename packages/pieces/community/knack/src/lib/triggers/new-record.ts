...
const LAST_RECORD_IDS_KEY = 'knack_new_record_ids';

export const newRecordTrigger = createTrigger({
  auth: knackAuth,
  name: 'new_record',
  displayName: 'New Record',
  description: 'Fires when a new record is created via API or app.',
  type: TriggerStrategy.POLLING,
  props: {
    object: {
      ...objectDropdown,
      description: 'Select the object to monitor for new records.',
    },
  },
  ...
  sampleData: {
    ...
    field_1: "Sample Record Name",
    field_1_raw: "Sample Record Name",

...
export const getCreditBalance = createAction({
    ...
    description: 'View your Enrich Layer API credit balance (0 credits)',
    props: {},
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.CREDIT_BALANCE, {})
    },
})

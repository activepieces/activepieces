...
export const getJobCount = createAction({
    ...
    description: 'Count the number of jobs posted by a company (2 credits)',
    props: {
    ...
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.JOB_COUNT, {

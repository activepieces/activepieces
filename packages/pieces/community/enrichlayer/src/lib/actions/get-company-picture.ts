...
export const getCompanyPicture = createAction({
    ...
    description: 'Get the profile picture URL of a company from cached profiles (0 credits)',
    props: {
    ...
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.COMPANY_PICTURE, {

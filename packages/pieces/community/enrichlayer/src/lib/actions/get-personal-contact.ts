...
export const getPersonalContact = createAction({
    ...
    description: 'Find personal phone numbers from a social media profile (1 credit per number returned)',
    props: {
        ...
        page_size: Property.ShortText({
            ...
            description: 'Maximum numbers returned (0 = no limit, default: 0)',
            required: false,
        }),
    },
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.PERSONAL_CONTACT, {

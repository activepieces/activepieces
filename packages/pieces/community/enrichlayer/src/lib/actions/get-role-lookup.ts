...
export const getRoleLookup = createAction({
    ...
    description: 'Find the person who most closely matches a specified role at a company (3 credits)',
    props: {
    ...
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.ROLE_LOOKUP, {

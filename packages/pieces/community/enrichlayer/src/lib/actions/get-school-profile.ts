...
export const getSchoolProfile = createAction({
    ...
    description: 'Get structured data of a School Profile from a professional network URL (1 credit)',
    props: {
    ...
    async run(context) {
        return await enrichlayerApiCall(context.auth.secret_text as string, ENDPOINTS.SCHOOL_PROFILE, {

...
export const searchAction = createAction({
    ...
    props: {
        ...
        max_num_results: Property.Number({
            ...
            description:
                'Maximum number of results to return (1-20 for standard API keys, up to 100 with special API key).',
            required: false,
            defaultValue: 10,
        }),
        search_type: Property.StaticDropdown({
            ...
            description:
                "Type of search to perform. 'web' searches web content. 'proprietary' uses Valyu's full-text multimodal indices. 'news' returns only news articles.",
            required: false,
            defaultValue: 'all',
            options: {
                options: [

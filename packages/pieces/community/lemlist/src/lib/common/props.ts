...
export const campaignsDropdown = ({ refreshers, required = true }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: lemlistAuth,
        displayName: 'Campaign',
        description: required ? 'Select a campaign' : 'Select a campaign (optional)',
        required,
        refreshers,

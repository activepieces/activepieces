...
export const addLeadToACampaign = createAction({
    ...
    description: 'Adds a lead to a specific campaign with optional enrichment and lead details.',
    props: {
    ...
    async run({ auth, propsValue }) {
        const { campaignId, email, deduplicate, linkedinEnrichment, findEmail, verifyEmail, findPhone, ...leadData } =
            propsValue as any

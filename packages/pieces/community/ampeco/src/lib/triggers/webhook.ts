...
export const webhookTrigger = createTrigger({
        ...
        notifications: Property.StaticMultiSelectDropdown({
            ...
            options: {
                options: [
                    ...
                    {
                        label: 'Charge Point Sync Configuration Notification',
                        value: 'ChargePointSyncConfigurationNotification',
                    },
    ...
    async onEnable(context) {
        const response = (await makeAmpecoApiCall(context.auth, '/public-api/notifications/v2.0', HttpMethod.POST, {
            via: 'webhook',
    ...
    async onDisable(context) {
        ...
        if (webhookId) {
            await makeAmpecoApiCall(context.auth, `/public-api/notifications/v2.0/${webhookId}`, HttpMethod.DELETE)

...
export const sessionsListingAction = createAction({
    ...
    props: {
        ...
        filter__chargePointBootNotificationSerialNumber: Property.ShortText({
            ...
            description:
                'Only list sessions on Charge Points with last boot notification that had this charge_point_serial_number',
            required: false,
        }),
        ...
        filter__paymentType: Property.StaticDropdown({
            ...
            description:
                '`bank_transfer` is used for one-time bank transfers, for saved (tokenized) bank transfers use `tokenized`.',
            required: false,
            options: {
                options: [
        ...
        filter__paymentStatusUpdatedBefore: Property.DateTime({
            ...
            description:
                'Only list sessions with payment status updated before the specified date and time. Please provide the value in ISO 8601 formatted date.',
            required: false,
        }),
        ...
        filter__paymentStatusUpdatedAfter: Property.DateTime({
            ...
            description:
                'Only list sessions with payment status updated after the specified date and time. Please provide the value in ISO 8601 formatted date.',
            required: false,
        }),
        ...
        filter__externalAppData: Property.ShortText({
            ...
            description:
                'Only list records with specific external application data. You can use a dot notation to search for nested properties. For example, `filter[externalAppData.property1.property2]=value`.',
            required: false,
        }),
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the specific resource that was last updated on and after this datetime',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the specific resource that was last updated on and before this datetime',
            required: false,
        }),

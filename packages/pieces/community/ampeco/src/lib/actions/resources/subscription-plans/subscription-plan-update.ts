...
export const subscriptionPlanUpdateAction = createAction({
    ...
    props: {
        ...
        feePerEachPersonalChargePoint: Property.Number({
            ...
            description:
                'Applies separately per each personal charge point owned by the subscriber that requires this Subscription plan.',
            required: false,
        }),
        ...
        status: Property.StaticDropdown({
            displayName: 'Status',
            description:
                'A change from disabled to enabled is only possible for Subscription plans that are not replaced with another plan.',
            required: false,
            options: {
                options: [
        ...
        allowance__homeChargersOnly: Property.StaticDropdown({
            ...
            description:
                'When true the allowance can only be used on the home charge points owned by the user. In that case all other allowance restrictions have no effect.',
            required: false,
            options: {
                options: [
        ...
        allowance__includedCountries: Property.StaticMultiSelectDropdown({
            ...
            description:
                'The allowance can only be used on charge points in countries in this list. When empty the allowance is valid for charge points in all countries, except the ones explicitly listed in the excludedCountries.',
            required: false,
            options: {
                options: [
                    { label: 'AF', value: 'AF' },
        ...
        allowance__includedPartnerChargePoints: Property.Array({
            ...
            description:
                'An array of Partner IDs. The allowance can only be used on charge points of Partners in this list. When empty the allowance is valid for charge points of any Partner, except the ones explicitly listed in the excludedPartnerChargePoints.',
            required: false,
        }),
        ...
        allowance__excludedPartnerChargePoints: Property.Array({
            ...
            description:
                'An array of Partner IDs. The allowance cannot be used on charge points of Partners in this list.',
            required: false,
        }),
        ...
        allowance__combined: Property.Number({
            ...
            description:
                'The amount of kWh included - combined for AC and DC, should be provided if the type is combined.',
            required: false,
        }),
        ...
        visibilityRestrictions__includedPartnerUsers: Property.Array({
            ...
            description:
                'An array of Partner IDs. The Subscription plan is available only to users invited (and accepted) or created by one of the Partners in this list. When empty the plan is available to all users, except the ones of Partners listed in excludedPartnerUsers.',
            required: false,
        }),
        ...
        visibilityRestrictions__excludedPartnerUsers: Property.Array({
            ...
            description:
                'An array of Partner IDs. The Subscription plan is not available to users of the Partners in this list.',
            required: false,
        }),
        ...
        visibilityRestrictions__includedUserGroups: Property.Array({
            ...
            description:
                'An array of User Group IDs. The Subscription plan is available only to users with a User Group that is in this list. When empty the plan is available to all users, except the ones with a User Group listed in excludedUserGroups.',
            required: false,
        }),
        ...
        visibilityRestrictions__excludedUserGroups: Property.Array({
            ...
            description:
                'An array of User Group IDs. The Subscription plan is not available to users with a User Group that is in this list.',
            required: false,
        }),
    },

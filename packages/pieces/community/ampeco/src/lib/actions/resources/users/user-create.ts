...
export const userCreateAction = createAction({
    ...
    props: {
        ...
        options__sessionsAllowed: Property.StaticDropdown({
            ...
            description:
                'Determine the number of sessions a user could start - single or multiple simultaneous sessions, or whether the user could start simultaneous sessions with several Id Tags.',
            required: false,
            options: {
                options: [
                    { label: 'single_session', value: 'single_session' },
                    {
                        label: 'multiple_simultaneous_sessions_per_idtag',
                        value: 'multiple_simultaneous_sessions_per_idtag',
                    },
                    { label: 'simultaneous_use_of_idtags', value: 'simultaneous_use_of_idtags' },
                    {
                        label: 'multiple_simultaneous_sessions_remotely_and_idtags',
                        value: 'multiple_simultaneous_sessions_remotely_and_idtags',
                    },
                ],
            },
        }),

                ...
                const variantMap = {
                    tod: {
                                        ...
                                        items: {
                                            ...
                                            properties: {
                                                startAt: {
                                                    ...
                                                    example: '00:00',
                                                    description:
                                                        "The 24-hour format should be used.</br>\nExample '00:00'\n",
                                                },
                                                endAt: {
                                                    type: 'string',
                                                    format: 'time',
                        ...
                        electricalConfiguration: Property.StaticDropdown({
                            ...
                            description:
                                'Defines the type of electrical configuration of the charge point. The available options are </br> `star` - TN system - Star (Y) (default)</br> `delta` - IT system - Delta (Δ)</br>.',
                            required: false,
                            options: {
                                options: [

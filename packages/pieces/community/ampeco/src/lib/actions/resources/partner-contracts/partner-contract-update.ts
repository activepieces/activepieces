...
export const partnerContractUpdateAction = createAction({
    ...
    props: {
        ...
        endDate: Property.DateTime({
            ...
            description:
                'The contract expires at the last day of the selected month. If nothing is selected, there is no expiration date.',
            required: false,
        }),
        ...
        accessAndPermissions__sessionsRemoteControl: Property.StaticDropdown({
            ...
            description:
                'Allows the partner to start/stop session, unlock connector, trigger message, set a charging profile and get the composite schedule.',
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        revenueSharing__excludeConnectionFee: Property.StaticDropdown({
            ...
            description:
                'If the tariff has a Connection fee, this fee would not be included in the revenue sharing with the Partner and will remain entirely for the Operator.',
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        revenueSharing__deductElectricityCost: Property.StaticDropdown({
            ...
            description:
                'The cost of the electricity would first be deducted from the collected revenue and then the Revenue sharing rules will be applied.',
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        revenueSharing__reimburseForElectricityCost: Property.StaticDropdown({
            ...
            description:
                'If set to true, the Partner would receive not only their share of the revenue but also a reimbursement for the cost of the electricity.',
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        revenueSharing__fixedFeePerSessionAc: Property.Number({
            ...
            description:
                'Additional flat fee that is applied for every billed session and subtracted from the Partner’s share of the revenue for each session on AC Charging Station.',
            required: false,
        }),
        ...
        revenueSharing__fixedFeePerSessionDc: Property.Number({
            ...
            description:
                'Additional flat fee that is applied for every billed session and subtracted from the Partner’s share of the revenue for each session on DC Charging Station.',
            required: false,
        }),
        ...
        revenueSharing__feePerKwhAc: Property.Number({
            ...
            description:
                "Additional flat fee that is applied for every billed kWh and subtracted from the Partner's share of the revenue for each kWh billed on AC Charging Station.",
            required: false,
        }),
        ...
        revenueSharing__feePerKwhDc: Property.Number({
            ...
            description:
                "Additional flat fee that is applied for every billed kWh and subtracted from the Partner's share of the revenue for each kWh billed on DC Charging Station.",
            required: false,
        }),
        ...
        revenueSharing__handlingFee: Property.Number({
            ...
            description:
                'Additional percentage fee to be applied on the total amount paid by the user for the session. This fee is then subtracted from the Partner\'s share of the revenue. This fee is available only if the feature "Additional Platform Fees" is enabled for the system.',
            required: false,
        }),
    ...
    async run(context): Promise<PartnerContractUpdateResponse> {
        try {
            const url = processPathParameters(
                '/public-api/resources/partner-contracts/v1.0/{partnerContract}',
                context.propsValue,
            )

                ...
                const variantMap = {
                                ...
                                const variantMap = {
                                    '1': {
                                        preauthorizeAmount: Property.Number({
                                            ...
                                            description:
                                                'Provide a Pre-authorize amount when the terminal is linked to a single charger.',
                                            required: true,
                                        }),
                                    },
                                    '2': {
                                        transactionTimeout: Property.Number({
                                            ...
                                            description:
                                                'Provide a transaction timeout when the terminal is linked to a Location.',
                                            required: true,
                                        }),
                                    },
                                }
                    ...
                    '5': {
                        terminalId: Property.ShortText({
                            ...
                            description:
                                'This is the Device Number of the relevant Nayax terminal that is set up in the Nayax system. Please be careful to add the correct Device number on the relevant terminal.',
                            required: false,
                        }),

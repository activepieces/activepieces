...
export const getInstallerJobsListAction = createAction({
    ...
    props: {
        ...
        filter__createdAfter: Property.DateTime({
            ...
            description:
                'Lists the installer jobs that have been created after the specified date and time, please provide the value as an ISO 8601 formatted date',
            required: false,
        }),
        ...
        filter__createdBefore: Property.DateTime({
            ...
            description:
                'Lists the installer jobs that have been created before the specified date and time, please provide the value as an ISO 8601 formatted date',
            required: false,
        }),
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'Lists the installer jobs that have been last updated after the specified date and time, please provide the value as an ISO 8601 formatted date',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'Lists the installer jobs that have been last updated before the specified date and time, please provide the value as an ISO 8601 formatted date',
            required: false,
        }),

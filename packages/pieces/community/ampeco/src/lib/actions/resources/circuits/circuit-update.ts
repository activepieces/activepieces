...
export const circuitUpdateAction = createAction({
    ...
    props: {
        ...
        loadBalancingIntegration__id: Property.Number({
            ...
            description:
                'The id of the load balancing integration (can be found in the Ampeco backend). Provide `null` if you want to disable any load balancing integration and revert back to the Ampeco built-in load balancing.',
            required: false,
        }),
                ...
                const variantMap = {
                    '1': {
                        startDate: Property.DateTime({
                            ...
                            description:
                                'DREEV specific. Reporting and accepting charging schedules will commence at this date.',
                            required: false,
                        }),
                    },
                    '2': {
                        installationId: Property.ShortText({
                            ...
                            description:
                                'Zaptec specific. Installation ID inside Zaptec system, used for identifying the corresponding circuit.',
                            required: true,
                        }),
                    },
                }

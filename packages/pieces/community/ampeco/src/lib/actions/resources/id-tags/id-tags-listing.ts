...
export const idTagsListingAction = createAction({
    ...
    props: {
        ...
        filter__partnerId: Property.Number({
            ...
            description:
                'Only list ID tags assigned to the specified Partner ID. Pass null to list ID tags without a Partner assigned.',
            required: false,
        }),
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the id tags that were last updated on and after this datetime',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the id tags that were last updated on and before this datetime',
            required: false,
        }),

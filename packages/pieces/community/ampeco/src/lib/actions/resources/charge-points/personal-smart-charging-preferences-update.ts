                ...
                const variantMap = {
                    '1': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'user_controlled_schedule', value: 'user_controlled_schedule' }],
                            },
                        }),
                        ...
                        startTime: Property.ShortText({
                            ...
                            description:
                                'Start of preferred charging window which will be applied by default when no week day is chosen. Applicable for schedule mode.',
                            required: true,
                        }),
                        ...
                        endTime: Property.ShortText({
                            ...
                            description:
                                'End of preferred charging window which will be applied by default when no week day is chosen. Applicable for schedule mode.',
                            required: true,
                        }),
                    ...
                    '2': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'solar', value: 'solar' }],
                            },
                        }),
                        ...
                        maxCurrentFromGrid: Property.Number({
                            ...
                            description:
                                'The max current that can be taken from grid to ensure a stable charging process.Recommended options to use 0, 6, 8, 10, 12.',
                            required: true,
                        }),
                        ...
                        solarStableTime: Property.Number({
                            ...
                            description:
                                'Shorter time means more precise solar availability detection but also more frequent charging on/off switching.',
                            required: true,
                        }),
                    },
                    '3': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'octopus_agile', value: 'octopus_agile' }],
                            },
                        }),
                        ...
                        applicableTaxId: Property.Number({
                            ...
                            description:
                                'The ID of the applicable tax rate. Used to calculate correctly electricity costs shown to the user.',
                            required: true,
                        }),
                    ...
                    '4': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'octopus_go', value: 'octopus_go' }],
                            },
                        }),
                    ...
                    '5': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'energi_elspot', value: 'energi_elspot' }],
                            },
                        }),
                    ...
                    '6': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'nordpool', value: 'nordpool' }],
                            },
                        }),
                    ...
                    '7': {
                        ...
                        type: Property.StaticDropdown({
                            ...
                            required: true,
                            options: {
                                options: [{ label: 'charger_electricity_rate', value: 'charger_electricity_rate' }],
                            },
                        }),
                        ...
                        solar: Property.StaticDropdown({
                            ...
                            description:
                                'This boolean adds solar mode control for specific brands of chargers that are supported. E.g.: Some chargers support special keys in the charging profile which enables solar charging mode.',
                            required: false,
                            options: {
                                options: [
                                    { label: 'true', value: 'true' },
                        ...
                        startTime: Property.ShortText({
                            displayName: 'Preferences - Start Time',
                            description:
                                'Start of preferred charging window which will be applied by default when no week day is chosen.',
                            required: true,
                        }),
                        ...
                        endTime: Property.ShortText({
                            displayName: 'Preferences - End Time',
                            description:
                                'End of preferred charging window which will be applied by default when no week day is chosen.',
                            required: true,
                        }),
                        ...
                        targetChargeKwh: Property.Number({
                            displayName: 'Preferences - Target Charge - Target Charge Kwh',
                            description:
                                'The desired charge energy which will be achieved with the most optimal price.',
                            required: true,
                        }),
    ...
    async run(context): Promise<PersonalSmartChargingPreferencesUpdateResponse> {
        try {
            const url = processPathParameters(
                '/public-api/resources/charge-points/v2.0/{chargePoint}/personal-smart-charging-preferences',
                context.propsValue,
            )

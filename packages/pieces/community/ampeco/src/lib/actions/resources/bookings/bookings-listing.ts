...
export const bookingsListingAction = createAction({
  ...
  displayName: 'Resources - Bookings - Bookings Listing',
  description: 'Get all bookings. (Endpoint: GET /public-api/resources/bookings/v1.0)',
  props: {
  ...
  async run(context): Promise<BookingsListingResponse> {
    try {
      const url = processPathParameters('/public-api/resources/bookings/v1.0', context.propsValue);

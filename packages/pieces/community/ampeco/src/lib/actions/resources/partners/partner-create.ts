...
export const partnerCreateAction = createAction({
    ...
    props: {
        ...
        options__addUserBalance: Property.StaticDropdown({
            ...
            description:
                "When set to false the API tokens related to this partner would not receive the users' balance in the response.",
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        options__allowToControlTariffGroups: Property.StaticDropdown({
            ...
            description:
                'In addition to `allowToControlTariffs`, the Partner would also be able to manage Tariff Groups - attach and remove Tariffs, change Tariffs order in the Tariff Group.',
            required: false,
            options: {
                options: [
                    { label: 'true', value: 'true' },
        ...
        bankDetails__bankCode: Property.ShortText({
            ...
            description:
                'Bank code assigned by a central bank, a bank supervisory body or a Bankers Association in the country.',
            required: false,
        }),

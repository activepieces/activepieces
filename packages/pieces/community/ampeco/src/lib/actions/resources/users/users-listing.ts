...
export const usersListingAction = createAction({
    ...
    props: {
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the users that were last updated on and after this datetime',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the users that were last updated on and before this datetime',
            required: false,
        }),

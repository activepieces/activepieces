...
export const subscriptionsListingAction = createAction({
    ...
    props: {
        ...
        filter__billedExternally: Property.ShortText({
            ...
            description:
                'Applicable only when the system uses both payment processor and external billing mode simultaneously. Show or hide subscriptions where users have enabled "External billing" (if allowed by the Billing settings).',
            required: false,
        }),

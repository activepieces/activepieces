...
export const authorizationsListingAction = createAction({
    ...
    props: {
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the authorizations that were last updated after this datetime',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the authorizations that were last updated before this datetime',
            required: false,
        }),
        ...
        filter__status: Property.ShortText({
            ...
            description:
                'Lists only authorizations with one of the following statuses: "accepted", "rejected", "pending"',
            required: false,
        }),
        ...
        filter__method: Property.ShortText({
            ...
            description:
                'Lists only authorizations with one of the following methods: "mobile_device", "rfid_tag", "admin_account", "plug_and_charge", "plug_and_charge_iso15118", "roaming", "payment_terminal"',
            required: false,
        }),

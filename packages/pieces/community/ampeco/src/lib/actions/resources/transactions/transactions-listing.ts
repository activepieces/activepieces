...
export const transactionsListingAction = createAction({
    ...
    props: {
        ...
        filter__lastUpdatedAfter: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the transactions that were last updated after this datetime',
            required: false,
        }),
        ...
        filter__lastUpdatedBefore: Property.DateTime({
            ...
            description:
                'ISO 8601 formatted date. Lists only the transactions that were last updated before this datetime',
            required: false,
        }),
        ...
        filter__purchaseType: Property.StaticMultiSelectDropdown({
            ...
            description:
                'Only list transactions with the specified purchase type(s). Determines what the transaction was for based on its associated entity.',
            required: false,
            options: {
                options: [

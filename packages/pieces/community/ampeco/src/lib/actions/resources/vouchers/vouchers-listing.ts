...
export const vouchersListingAction = createAction({
    ...
    props: {
        filter__type: Property.StaticDropdown({
            ...
            description:
                'Lists only vouchers that are with one of these types `voucher`, `manual_top_up`, `top_up_auto`, `auto_top_up`, `top_up_by_operator`, `api_top_up`, `promo_code`, `subscribe_to_plan`.',
            required: false,
            options: {
                options: [
        ...
        filter__createdAt: Property.DateTime({
            ...
            description:
                'Lists only vouchers that are created on a particular date. Please provide the value in the following format `YYYY-MM-DD`.',
            required: false,
        }),
        ...
        filter__redeemedAfter: Property.DateTime({
            ...
            description:
                'Lists only vouchers that are redeemed after the specified date and time. Please provide the value in ISO 8601 formatted date.',
            required: false,
        }),
        ...
        filter__redeemedBefore: Property.DateTime({
            ...
            description:
                'Lists only vouchers that were redeemed before the specified date and time. Please provide the value in ISO 8601 formatted date.',
            required: false,
        }),
        ...
        filter__expireDateAfter: Property.DateTime({
            ...
            description:
                'Lists only vouchers with expiration date after the specified date. Please provide the value in RFC 3339 formatted date `YYYY-MM-DD`.',
            required: false,
        }),
        ...
        filter__expireDateBefore: Property.DateTime({
            ...
            description:
                'Lists only vouchers with expiration date before the specified date. Please provide the value in RFC 3339 formatted date `YYYY-MM-DD`.',
            required: false,
        }),
        ...
        filter__code: Property.ShortText({
            ...
            description:
                'Lists only vouchers with code which contains the specified string. Please provide min 3 chars value.',
            required: false,
        }),

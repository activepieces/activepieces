...
export const createProject = createAction({
    ...
    props: {
        ...
        baseLangIso: Property.ShortText({
            ...
            description: 'Language/locale code of the project base language (e.g., "en", "en-us")',
            required: false,
        }),
    ...
    async run(context) {
        const { projectName, description, projectType, baseLangIso, teamId, isSegmentationEnabled } = context.propsValue
        ...
        const response = await makeRequest(context.auth.secret_text, HttpMethod.POST, '/projects', body)

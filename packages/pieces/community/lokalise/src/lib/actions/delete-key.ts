...
export const deleteKey = createAction({
    ...
    description: 'Delete a key from your Lokalise project (software and marketing projects only)',
    props: {
    ...
    async run(context) {
        ...
        const response = await makeRequest(context.auth.secret_text, HttpMethod.DELETE, path)

...
import { createAction, DynamicPropsValue, InputPropertyMap, PieceAuth, Property } from '@activepieces/pieces-framework'
        ...
        embedderId: Property.Dropdown<string, true, typeof goodmemAuth>({
            ...
            async options({ auth }) {
                ...
                try {
                    ...
                    return {
                        disabled: true,
                        placeholder: 'Failed to load embedders. Check your connection.',
                        options: [],
                    }
                }
            },

...
export const modelIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const models = await makeRequest(auth.secret_text, HttpMethod.GET, '/models', {})
...
export const documentIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const documents = await makeRequest(auth.secret_text, HttpMethod.GET, `/documents`, {})
...
export const scheduleIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const schedules = await makeRequest(auth.secret_text, HttpMethod.GET, `/schedules`, {})

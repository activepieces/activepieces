...
export const baseUrl = 'https://api.moonshot.ai/v1';
...
// 1. Ensure that billing is enabled on your Moonshot platform. \n
// 2. Generate a new API key. \n
// 3. Attempt the process again. \n
// For guidance, visit: https://platform.moonshot.ai/docs/pricing/chat#concepts \n`;

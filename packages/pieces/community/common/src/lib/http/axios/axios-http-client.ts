...
export class AxiosHttpClient extends BaseHttpClient {
  ...
  /**
   * Sanitizes an Axios error by removing sensitive information from headers
   * and request objects before the error is logged or thrown.
   * Uses deep cloning and thorough sanitization to prevent any leaks.
   */

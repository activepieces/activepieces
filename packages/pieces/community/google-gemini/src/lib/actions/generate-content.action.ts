                    ...
                    case 'url-context':
                        props = {
                            mrkdown: Property.MarkDown({
                                ...
                                value: 'To use URL context tool, include one or more URLs directly in the prompt. Gemini will fetch and use the page content as additional context.',
                            }),
                        }
                        break
                    case 'google-search':
                        props = {
                            mrkdown: Property.MarkDown({
                                variant: MarkdownVariant.INFO,
                                value: 'To use Google Search tool, include a clear search query in the prompt. Gemini will use Google Search to retrieve up-to-date web information.',
                            }),
                        }
                        break
                    case 'google-maps':

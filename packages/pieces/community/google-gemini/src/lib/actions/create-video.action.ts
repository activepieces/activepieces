...
export const createVideoAction = createAction({
    ...
    props: {
        ...
        image: Property.File({
            ...
            description: 'Optional image to use as the first frame of the video (image-to-video).',
            required: false,
        }),
        ...
        personGeneration: Property.StaticDropdown({
            ...
            description: 'Controls whether people or faces can appear in the generated video.',
            required: false,
    ...
    async run(context) {
        const { model, prompt, image, lastFrame, aspectRatio, durationSeconds, resolution, personGeneration } =
            context.propsValue
            ...
            ...(image
                ? {
                      image: {
                          ...
                          mimeType: mime.lookup(image.extension || image.filename) || 'image/jpeg',
                      },
                  }
                : {}),
            config: {
                ...
                ...(lastFrame
                    ? {
                          lastFrame: {
                              ...
                              mimeType: mime.lookup(lastFrame.extension || lastFrame.filename) || 'image/jpeg',
                          },
                      }
                    : {}),
            },

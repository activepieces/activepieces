...
import { BexioAccount, BexioCurrency, BexioTax } from './types'

export const bexioCommonProps = {
    account: (options: { displayName: string; description?: string; required: boolean }) => {
    ...
    currency: (options: { displayName: string; description?: string; required: boolean }) => {
        return Property.Dropdown({
            auth: bexioAuth,
            displayName: options.displayName,
            description: options.description,

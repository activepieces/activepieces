...
export const updateFormCoupon = createAction({
    ...
    async run({ auth, propsValue }) {
        const { formId, couponCode, enabled, target, discountType, discountAmount, discountPercentage, expiresAt } =
            propsValue
        ...
        try {
            const response = await paperformCommon.apiCall<PaperformCreateCouponResponse>({

...
export const createCheckout = createAction({
    ...
    props: {
        ...
        customPrice: Property.Number({
            ...
            description:
                'Override the product price in the smallest currency unit (e.g. 999 = $9.99). Only works if custom prices are enabled on the variant.',
            required: false,
        }),
        ...
        expiresAt: Property.ShortText({
            ...
            description:
                'ISO 8601 datetime when this checkout URL expires (e.g. 2024-12-31T23:59:59Z). Leave empty for no expiry.',
            required: false,
        }),

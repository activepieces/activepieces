...
import {
    createStoreDropdownProperty,
    createWebhookTriggerKey,
...
export const subscriptionPaymentRecoveredTrigger = createTrigger({
    ...
    async onDisable(context) {
        const response: { webhookId: string } | null = await context.store?.get(
            createWebhookTriggerKey('subscription_payment_recovered'),
        )

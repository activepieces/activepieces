function getRequiredString({ value, fieldName }: { value: unknown; fieldName: string }): string {
...
function getOptionalPositiveInteger({ value, fieldName }: { value: unknown; fieldName: string }): number | undefined {
...
function getLineItems({ value, fieldName }: { value: unknown; fieldName: string }): Array<{
    price_id: string
    quantity?: number
}> {

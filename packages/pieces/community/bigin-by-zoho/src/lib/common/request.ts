...
export const biginApiService = {
    createWebhook: async (access_token: string, payload: any, api_domain: string) => {
    ...
    deleteWebhook: async (access_token: string, api_domain: string, channel_id: string) => {
    ...
    createCompany: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
            method: HttpMethod.POST,
    ...
    updateCompany: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
    ...
    createContact: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
            method: HttpMethod.POST,
    ...
    updateContact: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
            method: HttpMethod.PUT,
            path: `${api_domain}/bigin/v2${API_ENDPOINTS.CONTACTS}`,
            access_token,
    ...
    fetchTags: async (access_token: string, api_domain: string, module: string) => {
        return fireHttpRequest({
            method: HttpMethod.GET,
    ...
    createPipelineRecord: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
            method: HttpMethod.POST,
    ...
    updatePipelineRecord: async (access_token: string, api_domain: string, body: any) => {
        return fireHttpRequest({
            method: HttpMethod.PUT,
            path: `${api_domain}/bigin/v2${API_ENDPOINTS.PIPELINES}`,
            access_token,
    ...
    fetchLayouts: async (access_token: string, api_domain: string, module_name: string) => {
        return fireHttpRequest({
            method: HttpMethod.GET,
    ...
    fetchModuleFields: async (access_token: string, api_domain: string, module_name: string) => {
        return fireHttpRequest({
            method: HttpMethod.GET,

...
export const gcsCommon = {
    ...
    async makeGCSRequest(method: HttpMethod, path: string, accessToken: string, body?: any): Promise<any> {
    ...
    async makePubSubRequest(method: HttpMethod, path: string, accessToken: string, body?: any): Promise<any> {
    ...
    async makeRequest(method: HttpMethod, path: string, accessToken: string, body?: any): Promise<any> {

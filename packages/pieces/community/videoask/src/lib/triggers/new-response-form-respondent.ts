...
export const newResponseFormRespondent = createTrigger({
     auth: videoaskAuth,
    name: 'newResponseFormRespondent',
    displayName: 'New Response (Respondent)',
    description: 'Triggers when a respondent submits a response to a VideoAsk form',
    props: {

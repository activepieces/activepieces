...
import { allSpacesDropdown, peoplesDropdown, spacesDropdown, threadsDropdown } from '../common/props'
...
export const sendAMessage = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        const { spaceId, text, thread, messageReplyOption, customMessageId, isPrivate, privateMessageViewer } =
            propsValue

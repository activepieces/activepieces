...
import { buildWebSearchConfig, buildWebSearchOptionsProperty, WebSearchOptions } from '../../common/web-search'
    ...
    async run(context) {
        ...
        const model = await createAIModel({
            ...
            ...spreadIfDefined(
                ...
                webSearchEnabled && provider === AIProviderName.OPENAI ? true : undefined,
            ),
        })
        ...
        try {
            ...
            for await (const chunk of stream.fullStream) {
                try {
                    ...
                    try {
                        detailsStr =
                            typeof innerError === 'object' && innerError !== null && 'message' in innerError

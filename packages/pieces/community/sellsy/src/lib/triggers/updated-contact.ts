...
export const updatedContact = createTrigger({
  ...
  description: 'Fires when an existing contact is updated in Sellsy',
  props: {},
  sampleData: {
    id: 12345,
    civility: 'mr',
    ...
    updated: '2024-01-01T12:30:00+00:00'
  },
  ...
  async onEnable(context) {
    ...
    // Based on the webhook events response, the correct event ID for contact updates is "people.updated"
    const contactEventId = 'people.updated';

...
export const newCompany = createTrigger({
    ...
    description: 'Fires when a new company (client/prospect) is created in Sellsy',
    props: {},
    sampleData: {
        id: 12345,
    ...
    async onEnable(context) {
        ...
        // Based on the webhook events response, the correct event ID for client creation is "client.created"
        const companyEventId = 'client.created';

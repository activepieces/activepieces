...
const polling: Polling<AppConnectionValueForAuthProperty<typeof flowParserAuth>, StaticPropsValue<typeof props>> = {
    ...
    items: async ({ auth, propsValue, lastFetchEpochMS }) => {
        ...
        try {
            ...
            const parsedDocuments = statusChanges.filter((doc) => doc.status === 'parsed')

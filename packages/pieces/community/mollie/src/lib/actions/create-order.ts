...
import { MollieOrder, mollieCommon } from '../common'
...
export const mollieCreateOrder = createAction({
    ...
    props: {
        orderNumber: Property.ShortText({
            ...
            description: 'The order number for this order. We recommend each order number to be unique.',
            required: true,
        }),
        ...
        lines: Property.Array({
            ...
            properties: {
                ...
                unitPriceValue: Property.ShortText({
                    ...
                    description: 'The price of a single item including VAT (e.g. "10.00")',
                    required: true,
                }),
                totalAmountCurrency: Property.ShortText({
                    displayName: 'Total Amount Currency',
                    description: 'Currency for total amount (should match order currency)',
                    required: true,
                    defaultValue: 'EUR',
                }),
                ...
                vatRate: Property.ShortText({
                    ...
                    description: 'The VAT rate applied to the line (e.g. "21.00" for 21%)',
                    required: false,
                }),
        ...
        redirectUrl: Property.LongText({
            ...
            description: 'The URL your customer will be redirected to after the payment process',
            required: false,
        }),
        cancelUrl: Property.LongText({
            displayName: 'Cancel URL',
            description: 'The URL your customer will be redirected to when they cancel the payment',
            required: false,
        }),
        ...
        shopperCountryMustMatchBillingCountry: Property.Checkbox({
            ...
            description: 'Restrict payment methods to those from the billing country only',
            required: false,
        }),
    ...
    async run({ auth, propsValue }) {
        ...
        let shippingAddress
        if (propsValue.includeShippingAddress && propsValue.shippingGivenName && propsValue.shippingFamilyName) {
            shippingAddress = {
        ...
        if (propsValue.shopperCountryMustMatchBillingCountry !== undefined) {
            orderData['shopperCountryMustMatchBillingCountry'] = propsValue.shopperCountryMustMatchBillingCountry
        }

  ...
  propertyGroups: [
    {
      ...
      description: 'Set up the payment information',
      icon: 'tag',
      props: ['description', 'amount', 'currency'],
    },
    {
      key: 'redirect',
      display: 'page',
      label: 'Redirect & Webhook',
      description: 'Configure redirect URL',
      icon: 'reply',
      props: ['redirectUrl', 'cancelUrl', 'webhookUrl'],
    },
    {
      key: 'lines',
      display: 'page',
      label: 'Order Lines',
      description: 'Itemise the order (optional)',
      icon: 'inbox',
      props: ['includeLines', 'lines'],
    },
    {
      key: 'addresses',
      display: 'page',

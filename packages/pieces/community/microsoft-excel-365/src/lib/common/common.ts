...
        const response = await httpClient.sendRequest<{ values: (string | number | boolean)[][] }>({
            method: HttpMethod.GET,
...
    },
    getAllRows: async function (workbookId: string, worksheetId: string, accessToken: string): Promise<(string | number | boolean)[][]> {
        const response = await httpClient.sendRequest<{ values: (string | number | boolean)[][] }>({
            method: HttpMethod.GET,
            url: `${excelCommon.baseUrl}/items/${workbookId}/workbook/worksheets/${worksheetId}/usedRange(valuesOnly=true)`,
            authentication: {
...
    
        const response = await httpClient.sendRequest<{ value: { id: string, name: string,folder?: unknown }[] }>({
            url: apiUrl,
            method: HttpMethod.GET,
            authentication: {
                type: AuthenticationType.BEARER_TOKEN,

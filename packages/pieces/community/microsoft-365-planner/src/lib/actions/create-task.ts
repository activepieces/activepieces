    ...
    async run({ auth, propsValue }) {
        const taskParams = {
            ...
            assignments: propsValue.assignments
                ...
                : undefined,
            dueDateTime: propsValue.dueDateTime ? new Date(propsValue.dueDateTime).toISOString() : undefined,
            startDateTime: propsValue.startDateTime ? new Date(propsValue.startDateTime).toISOString() : undefined,
        }

...
export const assistantIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/assistants')
            return {
                disabled: false,
...
export const knowledgeBaseIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/knowledge-bases')
            return {
                disabled: false,
...
export const rulesetIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/rulesets')
            return {
                disabled: false,
...
export const structuresIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/structures')
            return {
                disabled: false,
...
export const toolsIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/tools')
            return {
                disabled: false,
...
export const threadIdsDropdown = Property.MultiSelectDropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, `/threads`)
            return {
                disabled: false,
...
export const assistantRunsDropdown = Property.Dropdown({
    ...
    options: async ({ auth, assistant_id }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, `/assistants/${assistant_id}/runs`)
            return {
                disabled: false,
...
export const structureRunsDropdown = Property.Dropdown({
    ...
    options: async ({ auth, structure_id }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, `/structures/${structure_id}/runs`)
            return {
                disabled: false,

...
import { ImageModel, Tool, TranscriptionModel } from 'ai'
...
export function createAIModel<T extends LanguageModelV2 | ImageModel | TranscriptionModel>({
    providerName,
    modelInstance,
    engineToken,
    baseURL,
...
type CreateAIModelParams<T extends LanguageModelV2 | ImageModel | TranscriptionModel> = {
    providerName: string
    modelInstance: T
    /**

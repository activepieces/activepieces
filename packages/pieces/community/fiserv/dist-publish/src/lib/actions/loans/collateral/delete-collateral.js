...
exports.deleteCollateral = void 0;
...
exports.deleteCollateral = (0, pieces_framework_1.createAction)({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, collateralId, reason, auth, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, collateralId = _a.collateralId, reason = _a.reason;
                        auth = context.auth;
                        requestBody = {
                            CollateralKeys: {
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.PUT, auth, constants_1.ENDPOINTS.COLLATERAL_DELETE, requestBody)];
                    case 1:
                        response = _b.sent();

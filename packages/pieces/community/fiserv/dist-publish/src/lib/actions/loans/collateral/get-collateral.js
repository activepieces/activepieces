...
exports.getCollateral = (0, pieces_framework_1.createAction)({
    name: 'collateral_get',
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, collateralId, loanId, auth, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, collateralId = _a.collateralId, loanId = _a.loanId;
                        auth = context.auth;
                        requestBody = {
                            CollateralKeys: {
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, constants_1.ENDPOINTS.COLLATERAL_GET, requestBody)];
                    case 1:
                        response = _b.sent();

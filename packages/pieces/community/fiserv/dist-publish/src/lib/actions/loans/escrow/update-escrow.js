...
exports.updateEscrow = (0, pieces_framework_1.createAction)({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, escrowId, monthlyPayment, targetBalance, payee, status, auth, requestBody, updateFields, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, escrowId = _a.escrowId, monthlyPayment = _a.monthlyPayment, targetBalance = _a.targetBalance, payee = _a.payee, status = _a.status;
                        auth = context.auth;
                        requestBody = {
                            EscrowKeys: {
                                EscrowId: escrowId,
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.PUT, auth, constants_1.ENDPOINTS.ESCROW_UPDATE, requestBody)];
                    case 1:
                        response = _b.sent();

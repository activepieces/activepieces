...
exports.updateAccount = (0, pieces_framework_1.createAction)({
    name: 'account_update',
    displayName: 'Account - Update',
    description: 'Update account information in Fiserv',
    auth: auth_1.fiservAuth,
    props: {
        accountId: props_1.accountIdProp,
        accountStatus: pieces_framework_1.Property.StaticDropdown({
        ...
        creditLimit: pieces_framework_1.Property.Number({
            displayName: 'Credit Limit',
            description: 'Updated credit limit (for credit accounts)',
            required: false,
        }),
        nickname: pieces_framework_1.Property.ShortText({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, accountId, accountStatus, interestRate, creditLimit, nickname, auth, requestBody, updateFields, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, accountId = _a.accountId, accountStatus = _a.accountStatus, interestRate = _a.interestRate, creditLimit = _a.creditLimit, nickname = _a.nickname;
                        auth = context.auth;
                        requestBody = {
                            AcctKeys: {
                                AcctId: accountId,
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.PUT, auth, constants_1.ENDPOINTS.ACCOUNTS_UPDATE, requestBody)];
                    case 1:
                        response = _b.sent();

...
exports.updateCollateral = void 0;
...
exports.updateCollateral = (0, pieces_framework_1.createAction)({
    ...
    props: {
        collateralId: pieces_framework_1.Property.ShortText({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, collateralId, description, estimatedValue, status, auth, requestBody, updateFields, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, collateralId = _a.collateralId, description = _a.description, estimatedValue = _a.estimatedValue, status = _a.status;
                        auth = context.auth;
                        requestBody = {
                            CollateralKeys: {
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.PUT, auth, constants_1.ENDPOINTS.COLLATERAL_UPDATE, requestBody)];
                    case 1:
                        response = _b.sent();

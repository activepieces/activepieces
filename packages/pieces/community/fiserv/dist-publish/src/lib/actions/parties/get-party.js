...
exports.getParty = (0, pieces_framework_1.createAction)({
    ...
    props: {
        ...
        includeFullDetails: pieces_framework_1.Property.Checkbox({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, searchType, partyId, taxId, maxRecords, includeFullDetails, auth, requestBody, response, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, searchType = _a.searchType, partyId = _a.partyId, taxId = _a.taxId, maxRecords = _a.maxRecords, includeFullDetails = _a.includeFullDetails;
                        auth = context.auth;
                        if (!(searchType === 'partyId')) return [3 /*break*/, 2];
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, constants_1.ENDPOINTS.PARTIES_GET, requestBody)];
                    case 1:
                        response = _b.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, "".concat(constants_1.ENDPOINTS.PARTIES_GET, "/list"), requestBody)];
                    case 3:
                        response = _b.sent();
                        return [2 /*return*/, response.body];
                }

...
exports.getAccount = (0, pieces_framework_1.createAction)({
    ...
    props: {
        ...
        includeBalance: pieces_framework_1.Property.Checkbox({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, accountId, includeBalance, includeTransactions, auth, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, accountId = _a.accountId, includeBalance = _a.includeBalance, includeTransactions = _a.includeTransactions;
                        auth = context.auth;
                        requestBody = {
                            AcctKeys: {
                                AcctId: accountId,
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, constants_1.ENDPOINTS.ACCOUNTS_GET, requestBody)];
                    case 1:
                        response = _b.sent();

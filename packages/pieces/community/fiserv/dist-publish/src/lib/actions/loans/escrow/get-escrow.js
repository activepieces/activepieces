...
exports.getEscrow = (0, pieces_framework_1.createAction)({
    name: 'escrow_get',
    ...
    props: {
        ...
        includeTransactions: pieces_framework_1.Property.Checkbox({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, escrowId, loanId, includeTransactions, auth, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, escrowId = _a.escrowId, loanId = _a.loanId, includeTransactions = _a.includeTransactions;
                        auth = context.auth;
                        requestBody = {
                            EscrowKeys: {
                                EscrowId: escrowId,
                        ...
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, constants_1.ENDPOINTS.ESCROW_GET, requestBody)];
                    case 1:
                        response = _b.sent();

...
exports.addCollateral = (0, pieces_framework_1.createAction)({
    name: 'collateral_add',
    ...
    props: {
        ...
        collateralType: pieces_framework_1.Property.StaticDropdown({
            ...
            options: {
                options: [
                    ...
                    { label: 'Equipment', value: constants_1.CollateralType.EQUIPMENT },
        ...
        estimatedValue: pieces_framework_1.Property.Number({
            displayName: 'Estimated Value',
            description: 'Estimated value of the collateral',
            required: true,
        }),
        propertyAddress: pieces_framework_1.Property.LongText({
            displayName: 'Property Address',
            description: 'Address of the collateral (for real estate)',
            required: false,
        }),
        vinNumber: pieces_framework_1.Property.ShortText({
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, loanId, collateralType, description, estimatedValue, propertyAddress, vinNumber, auth, requestBody, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = context.propsValue, loanId = _a.loanId, collateralType = _a.collateralType, description = _a.description, estimatedValue = _a.estimatedValue, propertyAddress = _a.propertyAddress, vinNumber = _a.vinNumber;
                        auth = context.auth;
                        requestBody = {
                            LoanKeys: {
                                LoanId: loanId,
                        ...
                        if (propertyAddress && collateralType === constants_1.CollateralType.REAL_ESTATE) {
                            requestBody.CollateralInfo.PropertyAddress = propertyAddress;
                        }
                        if (vinNumber && collateralType === constants_1.CollateralType.VEHICLE) {
                            requestBody.CollateralInfo.VINNumber = vinNumber;
                        }
                        return [4 /*yield*/, (0, client_1.callFiservApi)(pieces_common_1.HttpMethod.POST, auth, constants_1.ENDPOINTS.COLLATERAL_ADD, requestBody)];
                    case 1:
                        response = _b.sent();

...
export const searchRegistrationFolder = createAction({
    ...
    props: {
        ...
        completionRate: Property.StaticDropdown({
            ...
            description: "Permet de n'obtenir que les dossiers dont le taux d'assiduité choisi",
            required: false,
            options: {
                options: [
                    { label: '0%', value: '0' },
        ...
        trainingActionId: Property.ShortText({
            ...
            description: "Permet de n'obtenir que les dossiers liés à l'action de formation considérée",
            required: false,
        }),
        trainingId: Property.ShortText({
            displayName: 'ID de la formation',
            description: "Permet de n'obtenir que les dossiers liés à la formation considérée",
            required: false,
        }),
        sessionId: Property.ShortText({
            displayName: 'ID de la session',
            description: "Permet de n'obtenir que les dossiers liés à la session considérée",
            required: false,
        }),
    ...
    async run(context) {
        ...
        const params = {
            ...
            daysSinceLastUpdatedCompletionRate: props.daysSinceLastUpdatedCompletionRate ?? null,

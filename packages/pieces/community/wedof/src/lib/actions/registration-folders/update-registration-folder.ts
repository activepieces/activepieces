    ...
    async run(context) {
        ...
        selectedFields.forEach((fieldName) => {
            switch (fieldName) {
                ...
                case 'completionRate':
                    if (!trainingActionInfo) trainingActionInfo = {}
                    trainingActionInfo['completionRate'] = completionRate !== undefined ? completionRate : null
                    break
                ...
                case 'weeklyDuration':
                    if (!trainingActionInfo) trainingActionInfo = {}
                    trainingActionInfo['weeklyDuration'] = weeklyDuration !== undefined ? weeklyDuration : null
                    break
                case 'notes':

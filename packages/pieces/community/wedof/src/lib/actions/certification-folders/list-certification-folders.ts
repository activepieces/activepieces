...
export const listCertificationFolders = createAction({
  auth: wedofAuth,
  name: 'listCertificationFolders',
  displayName: 'Liste des dossiers de certification',
  description:
    ' Récupérer la liste des dossiers de certification',
  props: {

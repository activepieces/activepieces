...
export const searchCertificationFolder = createAction({
    ...
    props: {
        query: Property.ShortText({
            ...
            description:
                "Permet d'effectuer une recherche libre sur les champs nom du candidat, prénom du candidat, email du candidat, tags, commentaire, id du dossier de certification et phoneNumber",
            required: false,
        }),
        ...
        state: Property.StaticMultiSelectDropdown({
            ...
            description:
                "Permet de n'obtenir que les dossiers dans l'état d'obtention de la certification considéré. Plusieurs états peuvent être sélectionnés.",
            required: false,
            options: {
                options: [
        ...
        registrationFolderState: Property.StaticMultiSelectDropdown({
            ...
            description:
                "Permet de n'obtenir que les dossiers dans l'état considéré. Plusieurs états peuvent être sélectionnés.",
            required: false,
            options: {
                options: [
        ...
        cdcToExport: Property.StaticDropdown({
            ...
            description:
                "Permet de filtrer les dossiers de certification qui devront être inclus dans les prochains exports pour l'accrochage",
            required: false,
            options: {
                options: [
                    { value: true, label: 'Oui' },
        ...
        dataProvider: Property.StaticMultiSelectDropdown({
            ...
            description:
                "Permet de n'obtenir que les dossiers dans le type considéré. Plusieurs types peuvent être sélectionnés.",
            required: false,
            options: {
                options: [
                    { value: 'cpf', label: 'CPF' },
        ...
        siret: Property.Array({
            displayName: 'SIRET',
            description:
                'Permet de n\'obtenir que les dossiers issus de l\'organisme de formation de siret considéré. Utilisez "all" pour récupérer tous les dossiers de tous les organismes.',
            required: false,
            defaultValue: ['all'],
        }),
        tags: Property.Array({
        ...
        cdcFile: Property.ShortText({
            ...
            description:
                "Permet de filtrer les dossiers de certification exportés sur un fichier XML lié à l'accrochage",
            required: false,
        }),
        certificatePrintData: Property.StaticDropdown({
            displayName: "Données d'impression de certificat",
            description:
                "Permet de n'obtenir que les dossiers pour lesquels un parchemin est en cours d'impression ou a été imprimé",
            required: false,
            options: {
                options: [
                    { value: true, label: 'Oui' },
        ...
        skillSets: Property.ShortText({
            ...
            description:
                "Permet de n'obtenir que les dossiers liés à une certification RNCP pour les blocs de compétences considérés",
            required: false,
        }),
        survey: Property.StaticDropdown({
            displayName: "Questionnaire de suivi d'insertion professionnelle",
            description:
                "Permet de n'obtenir que les dossiers pour lesquels un questionnaire doit être répondu ou a été répondu",
            required: false,
            options: {
                options: [
                    {
                        label: 'Questionnaire "Situation professionnelle en début de cursus" est accessible (Enquête créée)',
                        value: 'initialExperienceStartDate',
                    },
                    {
                        label: 'Questionnaire "Situation professionnelle de 6 mois" est accessible',
                        value: 'sixMonthExperienceStartDate',
                    },
                    {
                        label: 'Questionnaire "Situation professionnelle au moins un an" est accessible',
                        value: 'longTermExperienceStartDate',
                    },
                    {
                        label: 'Questionnaire "Situation professionnelle en début de cursus" répondu',
                        value: 'initialExperienceAnsweredDate',
                    },
                    {
                        label: 'Questionnaire "Situation professionnelle de 6 mois" répondu',
                        value: 'sixMonthExperienceAnsweredDate',
                    },
                    {
                        label: 'Questionnaire "Situation professionnelle au moins un an" répondu',
    ...
    async run(context) {
        ...
        const params = {
            ...
            registrationFolderState:
                props.registrationFolderState && props.registrationFolderState.length > 0
                    ? props.registrationFolderState.join(',')
                    : null,
            ...
            since: props.periodForm?.['since']
                ? dayjs(props.periodForm['since']).startOf('day').format('YYYY-MM-DDTHH:mm:ssZ')
                : null,
            until: props.periodForm?.['until']
                ? dayjs(props.periodForm['until']).endOf('day').format('YYYY-MM-DDTHH:mm:ssZ')
                : null,

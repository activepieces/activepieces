        ...
        selectedFields.forEach((fieldName) => {
            switch (fieldName) {
                ...
                case 'pendingActivation':
                    message['pendingActivation'] = pendingActivation !== undefined ? pendingActivation : null
                    break
                case 'pendingRevocation':
                    message['pendingRevocation'] = pendingRevocation !== undefined ? pendingRevocation : null
                    break
                case 'pendingSuspension':
                    message['pendingSuspension'] = pendingSuspension !== undefined ? pendingSuspension : null
                    break
                case 'amountHt':
                ...
                case 'trainingsZone':
                    message['trainingsZone'] =
                        trainingsZone && trainingsZone.length > 0 ? (trainingsZone as string[]) : null
                    break
                case 'skillSets':
                    message['skillSets'] = skillSets && skillSets.length > 0 ? (skillSets as string[]) : null
                    break
            }
        })

...
export const newCertificationFolderCreated = createTrigger({
    ...
    description: "Se déclenche lorsqu'un nouveau dossier de certification est créé",
    ...
    async onEnable(context) {
        ...
        await wedofCommon.handleWebhookSubscription(['certificationFolder.created'], context, name)
    },

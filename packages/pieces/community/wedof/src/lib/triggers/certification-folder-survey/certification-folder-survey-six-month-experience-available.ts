...
export const certificationFolderSurveySixMonthExperienceAvailable = createTrigger({
  ...
  displayName: 'Enquéte "Situation professionnelle de 6 mois" disponible',
  description: "Se déclenche lorsqu'un une enquéte de 6 mois de cursus est disponible",
  ...
  async onEnable(context) {
    ...
    const name =
      'Activepieces - certificationFolderSurveySixMonthExperienceAvailable - ' +

...
function generateSignature(
    ...
    const signatureBaseString = [httpMethod.toUpperCase(), oauthEncode(baseUrl), oauthEncode(paramString)].join('&')

    const signingKey = [oauthEncode(consumerSecret), oauthEncode(tokenSecret)].join('&')

...
import { engineDropdownOptions, languageDropdownOptions, toneofvoiceDropdown } from '../common/props'
...
export const generateProductDescriptions = createAction({
    ...
    description: 'Generate authentic product descriptions that compel, inspire, and influence',
    props: {
        ...
        secondary_keywords: Property.LongText({
            ...
            description: 'Additional keywords to include in the product description, separated by commas',
            required: false,
        }),

...
export const createContact = createAction({
    ...
    props: {
        ...
        processorId: Property.ShortText({
            ...
            description: 'The ID assigned by an external payment processor (e.g., Stripe customer ID)',
            required: false,
        }),
        processor: Property.ShortText({
            displayName: 'Processor',
            description: 'The external platform where the contact was imported from (e.g., stripe)',
            required: false,
        }),
    },
    async run(context) {
        ...
        if (context.propsValue.discount !== undefined && context.propsValue.discount !== null) {

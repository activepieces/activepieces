...
export const uscreen = createPiece({
    displayName: 'Uscreen',
    description:
        'All-in-one video monetization platform for creating, hosting, and selling online courses, memberships, and video content.',
    auth: uscreenAuth,
    ...
    triggers: [paidOrder, newUser, beganToPlayVideo, canceledSubscription, userUpdated],
})

...
export class UscreenClient {
    ...
    async getInvoices(params: {
        ...
        try {
            return await this.makeRequest<{ items: UscreenInvoice[] }>(HttpMethod.GET, '/invoices', undefined, query)
        } catch (e) {
    ...
    async getOffers(): Promise<UscreenProduct[]> {
        try {
            return await this.makeRequest<UscreenProduct[]>(HttpMethod.GET, '/offers')
        } catch (e) {
    ...
    async getPrograms(): Promise<UscreenProduct[]> {
        try {
            return await this.makeRequest<UscreenProduct[]>(HttpMethod.GET, '/programs')
        } catch (e) {
    ...
    async getCustomers() {
        try {
            return await this.makeRequest<{ id: number; email: string }[]>(HttpMethod.GET, '/customers')
        } catch (e) {

import { createAction, DropdownOption, PiecePropValueSchema, Property } from '@activepieces/pieces-framework'
    ...
    props: {
        folderId: Property.Dropdown({
            ...
            options: async ({ auth }) => {
                ...
                do {
                    const response = await client.files.foldersApi.doSearch(undefined, after, undefined, limit)

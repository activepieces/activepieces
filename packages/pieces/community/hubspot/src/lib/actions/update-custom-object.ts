...
import { customObjectDropdown, customObjectDynamicProperties, customObjectPropertiesDropdown } from '../common/props'
...
export const updateCustomObjectAction = createAction({
  ...
  async run(context) {
    ...
    const additionalPropertiesToRetrieve = context.propsValue.additionalPropertiesToRetrieve?.['values']
    ...
    const updatedCustomObject = await client.crm.objects.basicApi.update(customObjectType, customObjectId, {

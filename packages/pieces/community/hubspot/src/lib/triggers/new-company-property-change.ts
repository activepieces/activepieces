...
import { MAX_SEARCH_PAGE_SIZE, MAX_SEARCH_TOTAL_RESULTS, OBJECT_TYPE } from '../common/constants'
...
const polling: Polling<AppConnectionValueForAuthProperty<typeof hubspotAuth>, Props> = {
    ...
    async items({ auth, propsValue, lastFetchEpochMS }) {
        ...
        const updatedCompaniesWithPropertyHistory = batchApiResps.flatMap((resp) => resp.results)

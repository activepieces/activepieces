...
import { DynamicPropsValue, PiecePropValueSchema, TriggerStrategy, createTrigger } from '@activepieces/pieces-framework'
import { hubspotAuth } from '../..'
import { customObjectDropdown, customObjectPropertiesDropdown, standardObjectPropertiesDropdown } from '../common/props'
...
const polling: Polling<PiecePropValueSchema<typeof hubspotAuth>, Props> = {
  ...
  async items({ auth, propsValue, lastFetchEpochMS }) {
    ...
    const updatedCustomObjectsWithPropertyHistory = await client.crm.objects.batchApi.read(customObjectType, {

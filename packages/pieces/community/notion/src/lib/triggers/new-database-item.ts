...
const polling: Polling<AppConnectionValueForAuthProperty<typeof notionAuth>, { database_id: string | undefined }> = {
...
const getResponse = async (authentication: NotionAuthValue, database_id: string, startDate: string | null) => {

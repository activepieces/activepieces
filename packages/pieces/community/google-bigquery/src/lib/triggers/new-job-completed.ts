...
import { BASE_URL, BigQueryAuthValue, bigQueryAuth, getAccessToken, projectIdProp } from '../common'
...
const polling: Polling<AppConnectionValueForAuthProperty<typeof bigQueryAuth>, StaticPropsValue<typeof props>> = {
        ...
        return jobs.map((j) => {
            ...
            return {
                ...
                data: {
                    ...
                    bytes_processed:
                        j.statistics.query?.totalBytesProcessed ?? j.statistics.totalBytesProcessed ?? null,

...
export const newOrUpdatedMessage = createTrigger({
    ...
    description: 'Triggers when an SMS or EMAIL notification is created or its delivery status changes',
    props: {},
    sampleData: {
    ...
    async onEnable(context) {
        ...
        const response = (await makeRequest(api_key, HttpMethod.POST, '/webhooks', body)) as any

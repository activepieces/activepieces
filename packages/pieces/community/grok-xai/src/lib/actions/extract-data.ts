...
export const extractDataFromText = createAction({
    ...
    props: {
        ...
        extractionPrompt: Property.LongText({
            ...
            defaultValue:
                'Extract the following structured data from the provided text. Be accurate and only extract information that is explicitly present. If a field is not found, use null.',
        }),
...
Response Format: You must respond with valid JSON matching the specified schema.`
        ...
        try {
            ...
            const requiredFieldsExtracted = requiredFields.filter(

...
export const amazons3UploadFile = createAction({
    ...
    props: {
        ...
        fileName: Property.ShortText({
            ...
            required: false,
            description:
                'The name to save the file as in S3 (e.g. "report-2024.csv"). If left blank, a unique name is generated automatically.',
        }),
        acl: Property.StaticDropdown({
            displayName: 'Access Control (ACL)',
            description:
                'Who can access this file after upload. Use "Private" for internal files, "Public Read" to make the file publicly accessible via URL.',
            required: false,
            options: {
                options: [
                    {

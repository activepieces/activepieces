...
export const amazonS3Auth = PieceAuth.CustomAuth({
    ...
    props: {
        ...
        secretAccessKey: PieceAuth.SecretText({
            ...
            description:
                'Your AWS secret access key. Only shown once when you create the access key — store it safely.',
            required: true,
        }),
        ...
        endpoint: Property.ShortText({
            ...
            description:
                'Leave blank for Amazon S3. Only set this when using an S3-compatible service like MinIO, DigitalOcean Spaces, or Backblaze B2 (e.g. "https://nyc3.digitaloceanspaces.com").',
            required: false,
        }),

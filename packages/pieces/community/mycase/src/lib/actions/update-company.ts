...
import { companyDropdown, multiCasesDropdown, multiClientDropdown } from '../common/props';
...
export const updateCompany = createAction({
  ...
  props: {
    company_id: companyDropdown({
      description: 'Select the company you want to update.',
      required: true,
    }),
  ...
  async run(context) {
    ...
    return await myCaseApiService.updateCompany({

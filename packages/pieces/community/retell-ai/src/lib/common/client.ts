import { AuthenticationType, HttpMessageBody, HttpMethod, HttpRequest, httpClient } from '@activepieces/pieces-common'
    ...
    try {
        ...
        switch (status) {
            ...
            default: {
                ...
                throw new Error(`Retell AI API Error (Status ${status || 'Unknown'}): ${apiMessage || fallbackMessage}`)
            }
        }
    }
}

...
export const findRowAction = createAction({
    ...
    description: 'Finds a row by matching a field value. Returns the first match.',
    auth: baserowAuth,
    props: {
    ...
    async run(context) {
        ...
        const response = (await client.listRows(table_id!, undefined, 1, undefined, undefined, {

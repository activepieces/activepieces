...
export const updateRowAction = createAction({
  ...
  description:
    'Updates fields in an existing row. Empty or blank values are skipped (leaving those fields unchanged). To explicitly clear a field, use the Clean Row action.',
  auth: baserowAuth,
  props: {

...
export async function getLists(authProp: OAuth2PropertyValue): Promise<TasksList[]> {
...
export async function getTasks(authProp: OAuth2PropertyValue, tasklist: string): Promise<TasksList[]> {
  // docs: https://developers.google.com/tasks/reference/rest/v1/tasklists/list
  const request: HttpRequest = {
    method: HttpMethod.GET,

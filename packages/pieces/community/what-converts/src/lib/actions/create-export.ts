...
export const exportLeadsAction = createAction({
    ...
    description: 'Retrieves all leads from an account, handling pagination automatically.',
    props: {
    ...
    async run(context) {
        ...
        const totalPages = Math.min(initialResponse.total_pages || 1, propsValue.no_of_pages || 1, 100)

...
export const whatConvertsClient = {
    ...
    async getProfiles(auth: WhatConvertsAuth, accountId: number): Promise<Profile[]> {
        const request: HttpRequest = {
            method: HttpMethod.GET,
    ...
    async createLead(auth: WhatConvertsAuth, accountId: number, params: CreateLeadParams) {
        const request: HttpRequest = {
    ...
    async findLeads(auth: WhatConvertsAuth, params: FindLeadParams): Promise<LeadsResponse> {
    ...
    async updateLead(auth: WhatConvertsAuth, leadId: number, params: UpdateLeadParams) {
        const request: HttpRequest = {
            method: HttpMethod.POST,

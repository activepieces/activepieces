import { createCustomApiCallAction, HttpMethod, HttpRequest, httpClient } from '@activepieces/pieces-common'
    ...
    validate: async ({ auth }) => {
        ...
        try {
            const request: HttpRequest = {
                ...
                url: `https://api.trello.com/1/members/me/boards` + `?key=` + username + `&token=` + password,
            }

...
export const alertForQuery = createTrigger({
    ...
    async onEnable(context) {
        ...
        const response = await makeRequest(auth.secret_text, HttpMethod.POST, '/chat/alerts', alertRequestBody)
    ...
    async onDisable(context) {
        ...
        if (alertId) {
            await makeRequest(auth.secret_text, HttpMethod.DELETE, `/chat/alerts/${alertId}`, {})

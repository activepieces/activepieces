...
export const ipLookup = createAction({
    ...
    description:
        'Look up comprehensive information about an IP address including location, ISP, security, and risk factors',
    props: {
        ...
        params: Property.ShortText({
            displayName: 'Modules',
            description:
                'Comma-separated list of modules to include: security, currency, timezone, location (e.g., "security,timezone,currency")',
            required: false,
        }),

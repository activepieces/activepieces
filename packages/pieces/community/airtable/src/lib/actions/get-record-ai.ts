...
export const airtableGetRecordAiAction = createAction({
  ...
  aiMetadata: {
    description:
      'Retrieves a single record and its field values by record ID. Use when you already know the exact record ID; to find records by a field value instead use Search Records or List Records. Read-only and idempotent.',
    idempotent: true,
  },
  props: {

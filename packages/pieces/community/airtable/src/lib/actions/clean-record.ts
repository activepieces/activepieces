...
export const airtableCleanRecordAction = createAction({
    ...
    description: 'Clears fields in a record. Empty values will clear the corresponding fields.',
    props: {
    ...
    async run(context) {
        ...
        const updatedFields: Record<string, unknown> = await airtableCommon.createNewFields(

...
import { customWatermarkTextInput, documentDropdown, watermarkTextDropdown } from '../common/dynamic-dropdowns'
...
export const downloadDocument = createAction({
    ...
    async run({ auth, propsValue, files }) {
        ...
        if (propsValue.watermark_color) {
            ...
            const colorValue =
                propsValue.watermark_color === 'custom' ? propsValue.custom_watermark_color : propsValue.watermark_color
            if (colorValue) {

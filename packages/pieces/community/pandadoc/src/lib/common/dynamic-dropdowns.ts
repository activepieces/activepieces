...
export const documentDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            ...
            }>(auth.secret_text, HttpMethod.GET, '/documents?count=100&order_by=date_created')
...
export const templateFields = Property.DynamicProperties({
    ...
    props: async ({ auth, template_uuid }) => {
        ...
        }>(auth as unknown as string, HttpMethod.GET, `/templates/${template_uuid}/details`)
...
export const documentAttachmentDropdown = Property.Dropdown({
    ...
    options: async ({ auth, document_id }) => {
        ...
        try {
            ...
            >(auth.secret_text, HttpMethod.GET, `/documents/${document_id}/attachments`)

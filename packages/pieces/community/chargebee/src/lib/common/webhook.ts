...
export async function unsubscribeChargebeeWebhook(site: string, apiKey: string, webhookId: string): Promise<void> {
...
export async function fetchRecentEvents(site: string, apiKey: string, eventType: string): Promise<unknown[]> {

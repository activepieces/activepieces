...
import { getChargebeeAuthHeader, getChargebeeBaseUrl } from './lib/common/client'
...
export const chargebee = createPiece({
    ...
    description: 'Subscription billing and revenue operations platform for managing customers and subscriptions.',

...
export const createExpense = createAction({
    ...
    async run(context) {
        ...
        if (expenseCost !== undefined && expenseCost !== null) body.ExpenseCost = expenseCost
        ...
        if (roundedAmount !== undefined && roundedAmount !== null) body.RoundedAmount = roundedAmount
        ...
        const response = await makeRequest(accessToken, HttpMethod.POST, '/create_expense', body)

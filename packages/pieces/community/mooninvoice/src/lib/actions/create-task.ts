...
export const createTask = createAction({
    ...
    async run(context) {
        const { companyId, taskName, projectId, hours, notes, rate, taskType, sacCode, taskTaxJson } =
            context.propsValue
        ...
        const response = await makeRequest(accessToken, HttpMethod.POST, '/add_task', body)

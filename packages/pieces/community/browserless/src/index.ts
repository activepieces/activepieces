...
export const browserless = createPiece({
    ...
    description:
        'Browserless is a headless browser automation tool that allows you to scrape websites, take screenshots, and more.',
    authors: ['owuzo', 'onyedikachi-david'],
    auth: browserlessAuth,
    actions: [captureScreenshot, generatePdf, scrapeUrl, runBqlQuery, getWebsitePerformance],
    triggers: [],
})

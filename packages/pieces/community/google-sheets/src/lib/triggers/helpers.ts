...
export async function getWorkSheetName(auth: GoogleSheetsAuthValue, spreadSheetId: string, sheetId: number) {
...
export async function getWorkSheetGridSize(auth: GoogleSheetsAuthValue, spreadSheetId: string, sheetId: number) {
    const authClient = await createGoogleClient(auth)
...
export async function getWorkSheetValues(auth: GoogleSheetsAuthValue, spreadsheetId: string, range?: string) {
    const authClient = await createGoogleClient(auth)
...
export async function deleteFileNotification(auth: GoogleSheetsAuthValue, channelId: string, resourceId: string) {
    const authClient = await createGoogleClient(auth)

import { HttpError, propsValidation } from '@activepieces/pieces-common'
import { createAction, PiecePropValueSchema, Property, Store, StoreScope } from '@activepieces/pieces-framework'
...
async function getRows(
    ...
    const finalRows = await mapRowsToHeaderNames(row, useHeaderNames, spreadsheetId, sheetId, headerRow, auth)

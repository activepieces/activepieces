...
import { OAuth2PropertyValue, PiecePropValueSchema, Property, createAction } from '@activepieces/pieces-framework'
...
async function moveFile(auth: PiecePropValueSchema<typeof googleSheetsAuth>, fileId: string, folderId: string) {

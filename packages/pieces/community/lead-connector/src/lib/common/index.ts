...
export async function addContact(auth: OAuth2PropertyValue, contact: LeadConnectorContactDto) {
...
export async function getFormSubmissions(auth: OAuth2PropertyValue, formId: string): Promise<any[]> {
  const response = await httpClient.sendRequest({
...
export async function getPipeline(auth: OAuth2PropertyValue, pipelineId: string): Promise<any> {
...
export async function createOpportunity(auth: OAuth2PropertyValue, data: LeadConnectorOpportunityDto) {
...
export async function updateOpportunity(auth: string, opportunity: string, data: LeadConnectorOpportunityDto) {
  const result = await httpClient.sendRequest({
    url: `${baseUrl}/opportunities/${opportunity}`,
    method: HttpMethod.PUT,
    headers: leadConnectorHeaders,
...
export async function updateTask(auth: string, contact: string, task: string, data: Partial<LeadConnectorTaskDto>) {
  const result = await httpClient.sendRequest({
    url: `${baseUrl}/contacts/${contact}/tasks/${task}`,
    method: HttpMethod.PUT,
    headers: leadConnectorHeaders,

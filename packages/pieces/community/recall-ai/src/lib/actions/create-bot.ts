...
export const createBot = createAction({
  ...
  props: {
    ...
    join_at: Property.ShortText({
      displayName: 'Join At',
      description:
        'The time at which the bot will join the call, formatted in ISO 8601 (e.g., 2024-01-15T14:30:00Z)',
      required: false,
    }),
    ...
    zoom: Property.Json({
      displayName: 'Zoom Config',
      description: 'Zoom-specific parameters for the bot',
      required: false,
    }),
    google_meet: Property.Json({
      displayName: 'Google Meet Config',
      description: 'Google Meet-specific parameters for the bot',
      required: false,
    }),

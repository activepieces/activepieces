...
export const updateContact = createAction({
    ...
    async run(context) {
        const { contactId, first_name, last_name, company_name, information } = context.propsValue
        ...
        const response = await makeRequest(context.auth, HttpMethod.POST, `/contacts/${contactId}`, requestBody)

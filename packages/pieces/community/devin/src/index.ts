...
export const devin = createPiece({
  ...
  description:
    'AI-powered engineering assistant for automating development tasks, code generation, and technical conversations.',
  logoUrl: 'https://cdn.activepieces.com/pieces/devin.png',
  auth: devinAuth,
  categories: [PieceCategory.ARTIFICIAL_INTELLIGENCE],
  minimumSupportedRelease: '0.20.0',
  authors: ['ahmad-swanblocks'],
  actions: [createSession, getSessionDetails, sendMessage],
  triggers: [],
})

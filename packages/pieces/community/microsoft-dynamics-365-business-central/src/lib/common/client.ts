...
function getBusinessCentralHost(cloud?: string | null): string {
    return (
        BUSINESS_CENTRAL_HOSTS[cloud ?? 'login.microsoftonline.com'] ??
        BUSINESS_CENTRAL_HOSTS['login.microsoftonline.com']
    )
}
...
export function makeClient(auth: AppConnectionValueForAuthProperty<typeof businessCentralAuth>) {

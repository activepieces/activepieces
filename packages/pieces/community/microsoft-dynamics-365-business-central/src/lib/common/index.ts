...
import { currenciesEntityNumberProps, currenciesEntityProps } from './props/currencies.entity'
...
import { paymentTermsEntityNumberProps, paymentTermsEntityProps } from './props/paymentTerms.entity'
import { projectsEntityProps } from './props/projects.entity'
import { salesInvoiceLinesEntityNumberProps, salesInvoiceLinesEntityProps } from './props/salesInvoiceLines.entity'
import { salesInvoicesEntityProps } from './props/salesInvoices.entity'
import { salesOrderLinesEntityNumberProps, salesOrdersLinesEntityProps } from './props/salesOrderLines.entity'
import { salesOrdersEntityProps } from './props/salesOrders.entity'
import { salesQuoteLinesEntityNumberProps, salesQuoteLinesEntityProps } from './props/salesQuoteLines.entity'
      ...
      for (const prop of entitySchema) {
        switch (prop.type) {
          ...
          case 'dynamic_select':
            {
              const propType =
                prop.type === 'dynamic_select' ? Property.StaticDropdown : Property.StaticMultiSelectDropdown

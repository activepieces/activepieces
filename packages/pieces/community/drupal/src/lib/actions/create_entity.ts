...
import { buildFieldProperties, fetchEntityTypesForEditing } from '../common/drupal-entities'
...
export const drupalCreateEntityAction = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        return await drupal.createEntity(auth, entityInfo.entity_type, entityInfo.bundle, fieldsToCreate)
    },
})

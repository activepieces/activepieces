...
export const searchProduct = createAction({
    ...
    async run(context) {
        ...
        if (context.propsValue.brand_id) params.append('brand_id', context.propsValue.brand_id)
        if (context.propsValue.type) params.append('type', context.propsValue.type)
        if (context.propsValue.price) params.append('price', String(context.propsValue.price))
        if (context.propsValue.weight) params.append('weight', String(context.propsValue.weight))

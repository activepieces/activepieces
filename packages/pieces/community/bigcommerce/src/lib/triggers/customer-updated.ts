...
export const customerUpdated = createTrigger({
  ...
  description: 'Triggers when a customer is updated via BigCommerce webhook',
  ...
  async onEnable(context) {
    ...
    try {
      // Create webhook for customer updated events
      ...
      throw handleBigCommerceError(error, 'Failed to create webhook for customer updated events');
    }
  },

import { HttpMethod, httpClient, pollingHelper } from '@activepieces/pieces-common'
import { createAction, Property } from '@activepieces/pieces-framework'
import { firecrawlAuth } from '../auth'
import { FIRECRAWL_API_BASE_URL, forJsonOutputFormat, polling } from '../common/common'

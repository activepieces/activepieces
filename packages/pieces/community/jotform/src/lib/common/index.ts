...
export const jotformCommon = {
    ...
    subscribeWebhook: async (
        ...
        const request: HttpRequest = {
            ...
            url: `${jotformCommon.baseUrl(authentication.props.region)}/form/${formId}/webhooks`,
            headers: {
    ...
    unsubscribeWebhook: async (
        ...
        const request: HttpRequest = {
            ...
            url: `${jotformCommon.baseUrl(authentication.props.region)}/form/${formId}/webhooks/${webhookId}`,
            headers: {
                APIKEY: authentication.props.apiKey,
            },
        }

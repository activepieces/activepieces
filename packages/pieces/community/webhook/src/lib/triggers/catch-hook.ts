import { DynamicPropsValue, Property, TriggerStrategy, createTrigger } from '@activepieces/pieces-framework'
import { MarkdownVariant, assertNotNullOrUndefined } from '@activepieces/shared'

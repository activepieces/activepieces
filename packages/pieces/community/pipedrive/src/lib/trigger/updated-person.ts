...
import { pipedriveApiCall, pipedriveCommon, pipedrivePaginatedApiCall, pipedriveTransformCustomFields } from '../common'
...
export const updatedPerson = createTrigger({
  ...
  async run(context) {
    ...
    const updatedPersonProperties = pipedriveTransformCustomFields(customFieldsResponse, personResponse.data)

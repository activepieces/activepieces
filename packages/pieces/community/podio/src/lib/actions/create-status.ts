...
import { dynamicOrgProperty, dynamicSpaceProperty, getAccessToken, podioApiCall } from '../common'
...
export const createStatusAction = createAction({
    ...
    props: {
        ...
        question: Property.Object({
            ...
            description:
                'Create a poll with your status. Format: {"text": "Question?", "options": ["Option 1", "Option 2"]}',
            required: false,
        }),
    ...
    async run(context) {
        ...
        const { spaceId, value, fileIds, embedId, embedUrl, question, alertInvite } = context.propsValue

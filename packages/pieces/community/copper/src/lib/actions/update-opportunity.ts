...
import { opportunityDropdown, pipelinesDropdown, primaryContactsDropdown } from '../common/props'
...
export const updateOpportunity = createAction({
    ...
    props: {
        ...
        updateFields: Property.DynamicProperties({
            ...
            props: async ({ auth, opportunityId }: any): Promise<InputPropertyMap> => {
    ...
    async run(context) {
        ...
        return await CopperApiService.updateOpportunity(context.auth, opportunity.id, {

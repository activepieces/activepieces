...
export const updatedProjectTrigger = createTrigger({
  auth: copperAuth,
  name: 'copper_updated_project',
  ...
  sampleData: {
    ...
    details: 'Complete redesign of company website - UPDATED',
    status: 'Open',
    date_created: '2023-01-01T00:00:00Z',
    date_modified: '2023-01-01T15:00:00Z',
  },
  async test(context) {

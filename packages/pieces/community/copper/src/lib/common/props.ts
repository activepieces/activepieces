...
export const companyDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: CopperAuth,
        displayName: 'Company',
...
export const multiCompanyDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
...
export const usersDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: CopperAuth,
...
export const multiUsersDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.MultiSelectDropdown({
        auth: CopperAuth,
        displayName: 'Assignee',
...
export const opportunityDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: CopperAuth,
...
export const pipelinesDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: CopperAuth,
...
export const projectsDropdown = ({ refreshers, required = false }: { refreshers: string[]; required?: boolean }) =>
    Property.Dropdown({
        auth: CopperAuth,
        displayName: 'Project',
    ...
    Property.Dropdown({
        ...
        async options({ auth }) {
            ...
            try {
                ...
                const items = entity && response[entity] ? response[entity] : [...response.user, ...response.system]
...
export const MultiContactTypesDropdown = ({ required = false }: { required?: boolean }) =>
    Property.MultiSelectDropdown({
        auth: CopperAuth,
...
export const MultiLeadStatusDropdown = ({ required = false }: { required?: boolean }) =>
    Property.MultiSelectDropdown({
        auth: CopperAuth,
...
export const MultiCustomerSourceDropdown = ({ required = false }: { required?: boolean }) =>
    Property.MultiSelectDropdown({
        auth: CopperAuth,
...
export const MultiLossReasonsDropdown = ({ required = false }: { required?: boolean }) =>
    Property.MultiSelectDropdown({
        auth: CopperAuth,

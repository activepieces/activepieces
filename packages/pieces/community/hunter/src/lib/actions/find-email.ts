...
import { companyProp, domainProp, firstNameProp, fullNameProp, lastNameProp, maxDurationProp } from '../common/props'
...
export const findEmailAction = createAction({
    ...
    async run(context) {
        const { domain, company, first_name, last_name, full_name, max_duration } = context.propsValue as {
            domain?: string
            company?: string
            first_name?: string
            last_name?: string

...
export const emailFilterProp = filterProp('Email', 'Filter by email (use "*" for any, "~" for empty, or substring).')
export const firstNameFilterProp = filterProp('First Name', 'Filter by first name.')
export const lastNameFilterProp = filterProp('Last Name', 'Filter by last name.')
export const positionFilterProp = filterProp('Position', 'Filter by position.')
export const companyFilterProp = filterProp('Company', 'Filter by company.')
export const industryFilterProp = filterProp('Industry', 'Filter by industry.')
export const websiteFilterProp = filterProp('Website', 'Filter by website.')
export const countryCodeFilterProp = filterProp('Country Code', 'Filter by ISO 3166‑1 alpha‑2 country code.')
export const companySizeFilterProp = filterProp('Company Size', 'Filter by company size.')
export const sourceFilterProp = filterProp('Source', 'Filter by source.')
export const twitterFilterProp = filterProp('Twitter Handle', 'Filter by Twitter handle.')
export const linkedinUrlFilterProp = filterProp('LinkedIn URL', 'Filter by LinkedIn URL.')
export const phoneNumberFilterProp = filterProp('Phone Number', 'Filter by phone number.')
...
export const dateFilterProp = filterProp('Activity/Contact Date', 'Use "*" for any value or "~" for unset.')

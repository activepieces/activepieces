...
export const createDocument = createAction({
    ...
    props: {
        ...
        path: Property.ShortText({
            ...
            description:
                'The relative path including document name (e.g., folder1/folder2/document_name). Folders will be created automatically.',
            required: true,
        }),
    ...
    async run(context) {
        ...
        if (
            context.propsValue.document_type === 'firm' &&
            context.propsValue.staff &&
            Array.isArray(context.propsValue.staff)
        ) {

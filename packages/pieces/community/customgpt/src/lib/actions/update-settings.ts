...
export const updateSettings = createAction({
    ...
    props: {
        ...
        default_prompt: Property.ShortText({
            ...
            description: 'Default prompt text shown to users (e.g., "Ask Me Anything ...")',
            required: false,
        }),
        ...
        chatbot_msg_lang: Property.ShortText({
            ...
            description: 'Language code for chatbot messages (e.g., "en", "es", "ur")',
            required: false,
        }),
        chatbot_color: Property.ShortText({
            displayName: 'Chatbot Color',
            description: 'Primary color for chatbot UI (hex color code, e.g., "#0e57cc")',
            required: false,
        }),
    ...
    async run({ auth, propsValue }) {
        ...
        if (propsValue.chatbot_toolbar_color !== undefined) {
            formData.append('chatbot_toolbar_color', propsValue.chatbot_toolbar_color)
        }
        ...
        if (propsValue.citations_answer_source_label_msg !== undefined) {
            formData.append('citations_answer_source_label_msg', propsValue.citations_answer_source_label_msg)
        }
        if (propsValue.citations_sources_label_msg !== undefined) {
            formData.append('citations_sources_label_msg', propsValue.citations_sources_label_msg)
        }
        ...
        if (propsValue.is_loading_indicator_enabled !== undefined) {
            formData.append('is_loading_indicator_enabled', String(propsValue.is_loading_indicator_enabled))
        }
        ...
        if (propsValue.is_selling_enabled !== undefined) {
            formData.append('is_selling_enabled', String(propsValue.is_selling_enabled))
        }

...
export const search = createAction({
    ...
    description:
        'Search the web for relevant content based on a natural language query. Perfect for grounding LLM responses with factual data.',
    props: {
        ...
        structuredOutputSchema: Property.LongText({
            ...
            description:
                'JSON schema (as a string) for the desired response format. Required only when Output Type is "structured".',
            required: false,
        }),

...
export const createCustomer = createAction({
    ...
    props: {
        ...
        categories: Property.Array({
            ...
            description: 'Array of category objects to determine how customer is related to specific categories',
            required: false,
            properties: {
                name: Property.ShortText({
        ...
        loyalty_points: Property.Number({
            ...
            description: '[DEPRECATED - use grant-points endpoint instead] Number of loyalty points customer will have',
            required: false,
        }),
    },
    async run(context) {
        const { identifier, name, email, birthdate, categories, metadata, referrer_code, loyalty_points } =
            context.propsValue
        ...
        const response = await makeRequest(context.auth.secret_text, HttpMethod.POST, `/customers`, body)

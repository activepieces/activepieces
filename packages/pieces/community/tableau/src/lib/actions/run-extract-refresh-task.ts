...
import { buildTableauUrl, getAuthToken, getTableauHeaders, listExtractRefreshTasks } from '../common'
...
export const runExtractRefreshTask = createAction({
    ...
    async run({ auth, propsValue }) {
        ...
        const runTaskUrl = buildTableauUrl(
            tableauAuth.serverUrl,
            apiVersion,
            siteId,
            `tasks/extractRefreshes/${taskId}/runNow`,
        )

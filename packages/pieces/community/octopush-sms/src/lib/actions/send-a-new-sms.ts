...
export const sendANewSms = createAction({
    ...
    props: {
        phone_number: Property.ShortText({
            ...
            description: 'Recipient phone number in international format (e.g., +33612345678)',
            required: true,
        }),
        ...
        send_at: Property.ShortText({
            displayName: 'Send At',
            description: 'Schedule sending time in ISO8601 format (e.g., 2024-12-25T10:30:00+01:00) - optional',
            required: false,
        }),
    ...
    async run(context) {
        const { phone_number, first_name, last_name, message, sender, purpose, send_at, with_replies } =
            context.propsValue

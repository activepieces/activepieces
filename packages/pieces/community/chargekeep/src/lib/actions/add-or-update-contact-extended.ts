...
export const addOrUpdateContactExtended = createAction({
   ...
   props: {
      ...
      overrideLists: Property.Dropdown({
      ...
      ignoreInvalidValues: Property.Dropdown({
      ...
      sendWelcomeEmail: Property.Dropdown({
      ...
      isActiveMilitaryDuty: Property.Dropdown({
      ...
      preferredToD: Property.Dropdown({
      ...
      organizationType: Property.Dropdown({
      ...
      sub1_paymentPeriodType: Property.Dropdown({
      ...
      sub2_paymentPeriodType: Property.Dropdown({
         displayName: "Product Payment Period Type",
         description:
            "The chosen Period Type has to be set for the Product on Sperse side",
         required: false,
      ...
      sub3_paymentPeriodType: Property.Dropdown({
         displayName: "Product Payment Period Type",
         description:
            "The chosen Period Type has to be set for the Product on Sperse side",
         required: false,

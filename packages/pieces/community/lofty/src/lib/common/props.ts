...
export const leadIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, '/leads')
...
export const transactionIdDropdown = Property.Dropdown({
    ...
    options: async ({ auth, leadId }) => {
        ...
        try {
            const response = await makeRequest(auth.secret_text, HttpMethod.GET, `/leads/${leadId}/transactions`)

...
const polling: Polling<AppConnectionValueForAuthProperty<typeof twilioAuth>, Record<string, unknown>> = {
    ...
    async items({ auth, lastFetchEpochMS }) {
        ...
        let currentUri: string | null = `/2010-04-01/Accounts/${account_sid}/Recordings.json?PageSize=${
            isTest ? 10 : 1000
        }`
...
export const twilioNewRecording = createTrigger({
    ...
    sampleData: {
        ...
        media_url:
            'http://api.twilio.com/2010-04-01/Accounts/ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/Recordings/REaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
    },

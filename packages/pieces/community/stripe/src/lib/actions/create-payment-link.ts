...
export const stripeCreatePaymentLink = createAction({
    ...
    async run(context) {
        ...
        const params: Stripe.PaymentLinkCreateParams = {
            ...
            billing_address_collection: props.billing_address_collection as 'auto' | 'required' | undefined,
        ...
        if (props.after_completion_type) {
            ...
            if (props.after_completion_type === 'redirect' && props.after_completion_redirect_url) {

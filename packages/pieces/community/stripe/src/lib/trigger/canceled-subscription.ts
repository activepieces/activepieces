...
export const stripeCanceledSubscription = createTrigger({
    ...
    async onEnable(context) {
        ...
        await context.store.put<StripeWebhookInformation>('_canceled_subscription_trigger', {
            webhookId: webhook.id,
        })
    },

    async onDisable(context) {
        const webhookInfo = await context.store.get<StripeWebhookInformation>('_canceled_subscription_trigger')

...
export const stripeInvoicePaymentFailed = createTrigger({
    ...
    async onEnable(context) {
        ...
        await context.store.put<StripeWebhookInformation>('_invoice_payment_failed_trigger', {
            webhookId: webhook.id,
        })
    },

    async onDisable(context) {
        const webhookInfo = await context.store.get<StripeWebhookInformation>('_invoice_payment_failed_trigger')

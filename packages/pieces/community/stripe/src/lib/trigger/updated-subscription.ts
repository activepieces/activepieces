...
export const stripeUpdatedSubscription = createTrigger({
    ...
    async onEnable(context) {
        ...
        await context.store.put<StripeWebhookInformation>('_updated_subscription_trigger', {
            webhookId: webhook.id,
        })
    },

    async onDisable(context) {
        const webhookInfo = await context.store.get<StripeWebhookInformation>('_updated_subscription_trigger')

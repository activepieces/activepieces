...
export const tenzoAuth = [
    PieceAuth.OAuth2({
        description:
            'Connect your Tenzo account using OAuth2. Supports both Authorization Code and Client Credentials flows.',
...
export type TenzoAuthValue = AppConnectionValueForAuthProperty<typeof tenzoAuth>

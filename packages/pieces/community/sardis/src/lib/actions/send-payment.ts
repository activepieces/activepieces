...
export const sendPaymentAction = createAction({
    ...
    props: {
        ...
        to: Property.ShortText({
            ...
            description: 'Recipient address or merchant identifier (e.g. "0xabc...", "openai.com")',
            required: true,
        }),
    ...
    async run(context) {
        ...
        return sardisApiCall(context.auth.secret_text, HttpMethod.POST, `/api/v2/wallets/${walletId}/transfer`, {
            destination: to,

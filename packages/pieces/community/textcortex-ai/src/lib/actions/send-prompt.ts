...
import { AI_MODELS, API_ENDPOINTS, FORMALITY_LEVELS, LANGUAGES } from '../common/common'
...
export const sendPrompt = createAction({
    ...
    props: {
        text: Property.LongText({
            ...
            description:
                'Enter the beginning of your text and AI will complete it (e.g., "The benefits of renewable energy are")',
            required: true,
        }),

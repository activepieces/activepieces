...
export class TeableClient {
     ...
     */
    async getRecord(tableId: string, recordId: string, query?: QueryParams) {
        return await this.makeRequest<{
            id: string
     ...
     */
    async listRecords(tableId: string, query?: QueryParams) {
        return await this.makeRequest<{
            records: {
                id: string
                fields: Record<string, unknown>
    ...
    async createRecord(tableId: string, request: object) {
        return await this.makeRequest(HttpMethod.POST, `/table/${tableId}/record`, undefined, request)
    }
    ...
    async deleteRecord(tableId: string, recordId: string) {
        return await this.makeRequest(HttpMethod.DELETE, `/table/${tableId}/record/${recordId}`)
    }
    ...
    async updateRecord(tableId: string, recordId: string, request: object) {
        return await this.makeRequest(HttpMethod.PATCH, `/table/${tableId}/record/${recordId}`, undefined, request)
    }

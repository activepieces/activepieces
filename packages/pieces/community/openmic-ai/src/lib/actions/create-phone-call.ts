...
export const createPhoneCall = createAction({
    ...
    props: {
        ...
        toNumber: Property.ShortText({
            ...
            description: 'The number you want to call in E.164 format (e.g., +0987654321)',
            required: true,
        }),
    ...
    async run(context) {
        ...
        const response = await makeRequest(context.auth, HttpMethod.POST, '/create-phone-call', body)

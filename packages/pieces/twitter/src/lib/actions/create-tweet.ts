import { ApFile, Property, Validators, createAction } from "@activepieces/pieces-framework";
...
export const createTweet = createAction({
    ...
    props: {
        ...
        image_1: Property.File({
            displayName: "Media (1)",
            description: "An image, video or GIF url or base64 to attach to the tweet",
            required: false,
        }),

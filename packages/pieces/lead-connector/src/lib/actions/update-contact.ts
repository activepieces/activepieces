...
import { Country, getCountries, getTags, getTimezones, LeadConnectorContactDto, updateContact } from '../common';
...
export const updateContactAction = createAction({
    ...
    async run({ auth, propsValue }) {
        const { id, firstName, lastName, email, phone, companyName, website, tags, source, country, city, state, address, postalCode, timezone } = propsValue;

...
import { addContact, Country, getCountries, getTags, getTimezones, LeadConnectorContactDto } from '../common';
...
export const createContact = createAction({
    ...
    async run({ auth, propsValue }) {
        const { firstName, lastName, email, phone, companyName, website, tags, source, country, city, state, address, postalCode, timezone } = propsValue;

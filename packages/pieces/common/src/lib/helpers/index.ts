...
import { HttpError, HttpHeaders, HttpMethod, HttpRequest, httpClient, QueryParams } from '../http'
...
type BaseUrlGetter<PieceAuth extends PieceAuthProperty | PieceAuthProperty[] | undefined> = (
    auth?: AppConnectionValueForAuthProperty<ExtractPieceAuthPropertyTypeForMethods<PieceAuth>>,
) => string

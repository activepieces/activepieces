...
import { extractTextActionOutputSchema } from '../output-schemas';
...
export const extractText = createAction({
  ...
  description: 'Extract the text layer from a PDF file or URL.',
  ...
  outputSchema: extractTextActionOutputSchema,
  props: {
    file: Property.File({

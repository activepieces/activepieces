import { createTrigger, DynamicPropsValue, PieceAuth, Property, TriggerStrategy } from '@activepieces/pieces-framework'
                    ...
                    case AuthType.HMAC:
                        fields = {
                            ...
                            hmacSecret: Property.ShortText({
                                displayName: 'Secret',
                                description: 'The shared secret used for HMAC signature verification',
                                required: true,
                            }),

...
describe('verifyHmacAuth', () => {
    ...
    function computeSignature(body: string, secretKey: string, algo: string, encoding: 'hex' | 'base64'): string {
    ...
    describe('with hex encoding', () => {
        ...
        test('should return true for valid signature', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'x-signature', secret, algorithm, encoding, '')
        ...
        test('should return false when signature is computed with wrong secret', () => {
            const body = JSON.stringify({ event: 'test', data: 'payload' })
            const wrongSignature = computeSignature(body, 'wrong-secret', algorithm, encoding)
        ...
        test('should return false when body has been tampered with', () => {
            ...
            const signature = computeSignature(originalBody, secret, algorithm, encoding)
            const headers = { 'x-signature': signature }
            const tamperedBody = JSON.stringify({ event: 'test', data: 'modified' })

            const result = verifyHmacAuth(headers, tamperedBody, 'x-signature', secret, algorithm, encoding, '')
    ...
    describe('with signature prefix', () => {
        ...
        test('should strip prefix before verification (GitHub style sha256=)', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'x-hub-signature-256', secret, algorithm, encoding, 'sha256=')
        ...
        test('should work with sha1= prefix', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'x-hub-signature', secret, sha1Algorithm, encoding, 'sha1=')
    ...
    describe('with different algorithms', () => {
        ...
        test('should work with SHA-1 algorithm', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'x-signature', secret, sha1Algorithm, encoding, '')
        ...
        test('should work with SHA-512 algorithm', () => {
            ...
            const body = JSON.stringify({ data: 'test' })
            const signature = computeSignature(body, secret, sha512Algorithm, encoding)
            const headers = { 'x-signature': signature }

            const result = verifyHmacAuth(headers, body, 'x-signature', secret, sha512Algorithm, encoding, '')
        ...
        test('should fail when algorithm mismatches', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'x-signature', secret, 'sha512', encoding, '')
    ...
    describe('with different body types', () => {
        ...
        test('should handle Buffer body', () => {
            ...
            const signature = computeSignature(bodyString, secret, algorithm, encoding)
            const headers = { 'x-signature': signature }
        ...
        test('should handle object body by JSON stringifying', () => {
            ...
            const signature = computeSignature(expectedBodyString, secret, algorithm, encoding)
            const headers = { 'x-signature': signature }

            const result = verifyHmacAuth(headers, bodyObject, 'x-signature', secret, algorithm, encoding, '')
        ...
        test('should handle undefined body as empty string', () => {
            ...
            const result = verifyHmacAuth(headers, undefined, 'x-signature', secret, algorithm, encoding, '')
        ...
        test('should handle null body as empty string', () => {
            ...
            const result = verifyHmacAuth(headers, null, 'x-signature', secret, algorithm, encoding, '')
    ...
    describe('header name case sensitivity', () => {
        ...
        test('should find header with all caps conversion', () => {
            ...
            const result = verifyHmacAuth(headers, body, 'X-Hub-Signature-256', secret, algorithm, encoding, '')

...
export enum WebsocketClientEvent {
    ...
    TEST_MANUAL_TRIGGER_RUN_STARTED = 'TEST_MANUAL_TRIGGER_RUN_STARTED',
...
export enum WebsocketServerEvent {
    ...
    MANUAL_TRIGGER_RUN_FINISHED = 'MANUAL_TRIGGER_RUN_FINISHED',
    MANUAL_TRIGGER_RUN_PROGRESS = 'MANUAL_TRIGGER_RUN_PROGRESS',
}

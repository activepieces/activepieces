...
export const StatusOption = Type.Object({
  ...
  variant: Type.Union([
    Type.Literal(STATUS_VARIANT.POSITIVE),
    Type.Literal(STATUS_VARIANT.NEGATIVE),
    Type.Literal(STATUS_VARIANT.NEUTRAL),
  ]),
...
export const TodoWithAssignee = Type.Composite([
  Todo,
  Type.Object({

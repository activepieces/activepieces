...
export type MemoryIssueParams = BaseErrorParams<
  ErrorCode.MEMORY_ISSUE,
  {
    message?: string
  }
>
...
export type AITokenLimitExceededParams = BaseErrorParams<
...
export type CopilotFailedErrorParams = BaseErrorParams<
  ErrorCode.COPILOT_FAILED,
  {
    message: string
  }
>
...
export type MCPNotFoundErrorParams = BaseErrorParams<

    ...
    return flowStructureUtil.transferFlow(flowVersion, (parentStep) => {
        ...
        return {
            ...
            settings: {
                ...
                branches: insertAt(routerAction.settings.branches, request.branchIndex, flowStructureUtil.createBranch({branchName: request.branchName, conditions: request.conditions, prompt: request.prompt})),
            },

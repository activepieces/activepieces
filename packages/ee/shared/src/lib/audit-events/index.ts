...
export const ConnectionEvent = Type.Object({
    ...
    data: Type.Object({
        connection: Type.Pick(AppConnectionWithoutSensitiveData, ['name', 'pieceName', 'status', 'type', 'id', 'created', 'updated']),
...
export const SignUpEvent = Type.Object({
    ...
    data: Type.Object({
        source: Type.Union([Type.Literal('credentials'), Type.Literal('sso'), Type.Literal('managed')]),
        user: Type.Optional(UserMeta)
    }),
})
...
export const SigningKeyEvent = Type.Object({
    ...
    data: Type.Object({
        signingKey: Type.Pick(SigningKey, ['id', 'created', 'updated', 'displayName']),
    }),
})

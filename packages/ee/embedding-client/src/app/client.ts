import { ActivepiecesClientEvent, ActivepiecesClientEventName, ActivepiecesClientRouteChanged, ActivepiecesVendorEventName, ActivepiecesVendorInit, ActivepiecesVendorRouteChanged } from '@activepieces/ee-client-embedding-shared';
